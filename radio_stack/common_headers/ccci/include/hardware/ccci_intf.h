...
typedef enum {
    ...
    USR_FACTORY_SIM_IOCTL =
            USR_RILD_IOCTL, /* ioctl only path for SIM test in factory mode (flight mode) */
    USR_FACTORY_IDLE_IOCTL =
            USR_RILD_IOCTL, /* ioctl only path for IDLE test in factory mode (flight mode) */
    ...
    /* all CCB user should be put toghether, and should same sequence with enum SMEM_USER_ID in
       kernel.*/
    CCB_START_INDEX,
    ...
    USR_CCCI_WIFI_PROXY,
    USR_CCCI_MAX,
} CCCI_USER; /* *_IOCTL path is only for ioctl commands, other pathes are capable of both data and
                ioctl */
...
enum { MD_STATE_INVALID = 0, MD_STATE_BOOTING = 1, MD_STATE_READY = 2, MD_STATE_EXCEPTION = 3 };
...
static const struct ccci_node ccci_node_list[] = {
        /*ccci_user_id */ /*md1_ccci_name */ /*md1_dual_ccci_name */       /*md1_eccci_name */
        /*md2_dual_ccci_name */ /*md3_ccci_name */ /*md5_eemcs_dev_name */ /*md5_edsda_dev_name */
        {USR_MUXD_DATA,
         {"/dev/ttyC0", "/dev/ttyC0", "/dev/ttyC0", "/dev/ccci2_tty0", INVALID_NAME,
          "/dev/eemcs_mux", "/dev/emd_cfifo1"}},
        {USR_MUXR_IOCTL,
         {"/dev/ccci_uem_tx", "/dev/ccci_ioctl0", "/dev/ccci_ioctl0", "/dev/ccci2_ioctl0",
          INVALID_NAME, "/dev/eemcs_muxrp", "/dev/emd_ctl1"}},
        {USR_RILD_IOCTL,
         {INVALID_NAME, "/dev/ccci_ioctl1", "/dev/ccci_ioctl1", "/dev/ccci2_ioctl1",
          "/dev/ccci3_ioctl1", "/dev/eemcs_ril", "/dev/emd_ctl2"}},
        {USR_TERS_IOCTL,
         {INVALID_NAME, "/dev/ccci_ioctl2", "/dev/ccci_ioctl2", "/dev/ccci2_ioctl2", INVALID_NAME,
          "/dev/eemcs_ioctl", INVALID_NAME}},
        {USR_AUDIO_TX,
         {"/dev/ccci_pcm_tx", "/dev/ccci_pcm_tx", "/dev/ccci_aud", "/dev/ccci2_aud",
          "/dev/ccci3_aud", "/dev/eemcs_aud", INVALID_NAME}},
        {USR_AUDIO_RX,
         {"/dev/ccci_pcm_rx", "/dev/ccci_pcm_rx", "/dev/ccci_aud", "/dev/ccci2_aud",
          "/dev/ccci3_aud", "/dev/eemcs_aud", INVALID_NAME}},
        {USR_META_DATA,
         {"/dev/ttyC1", "/dev/ttyC1", "/dev/ttyC1", "/dev/ccci2_tty1", "/dev/ccci3_tty1",
          "/dev/eemcs_md_log", INVALID_NAME}},
        {USR_META_IOCTL,
         {INVALID_NAME, "/dev/ccci_ioctl4", "/dev/ccci_ioctl4", "/dev/ccci2_ioctl4", INVALID_NAME,
          INVALID_NAME, "/dev/emd_ctl3"}},
        {USR_MDLOG_TX,
         {"/dev/ccci_md_log_tx", "/dev/ccci_md_log_tx", "/dev/ttyC1", "/dev/ccci2_tty1",
          "/dev/ccci3_tty1", "/dev/eemcs_md_log", INVALID_NAME}},
        {USR_MDLOG_RX,
         {"/dev/ccci_md_log_rx", "/dev/ccci_md_log_rx", "/dev/ttyC1", "/dev/ccci2_tty1",
          "/dev/ccci3_tty1", "/dev/eemcs_md_log", INVALID_NAME}},
        {USR_MDLOG_IOCTL,
         {"/dev/ccci_uem_rx", "/dev/ccci_ioctl0", "/dev/ttyC1", "/dev/ccci2_tty1",
          "/dev/ccci3_tty1", "/dev/eemcs_md_log", "/dev/emd_ctl4"}},
        {USR_MDLOG_CTRL,
         {INVALID_NAME, INVALID_NAME, "/dev/ccci_md_log_ctrl", "/dev/ccci2_md_log_ctrl",
          "/dev/ccci3_md_log_ctrl", "/dev/eemcs_md_log_ctrl", "/dev/emd_ctl4"}},
        {USR_MDLOG_MONITOR,
         {INVALID_NAME, INVALID_NAME, "/dev/ccci_mdl_monitor", INVALID_NAME, INVALID_NAME,
          INVALID_NAME, INVALID_NAME}},
        {USR_AGPS_UART,
         {"/dev/ttyC2", "/dev/ttyC2", "/dev/ttyC2", "/dev/ccci2_tty2", "/dev/ccci3_tty2",
          "/dev/eemcs_ipc_uart", INVALID_NAME}},
        {USR_AGPS_IPC,
         {"/dev/ccci_ipc_1220_0", "/dev/ccci_ipc_1220_0", "/dev/ccci_ipc_1220_0",
          "/dev/ccci2_ipc_0", INVALID_NAME, "/dev/eemcs_ipc_0", INVALID_NAME}},
        {USR_GPS_IPC,
         {INVALID_NAME, "/dev/ccci_ipc_2", "/dev/ccci_ipc_2", "/dev/ccci2_ipc_2", INVALID_NAME,
          "/dev/eemcs_ipc_2", INVALID_NAME}},
        ...
        {USR_RESERVED_FOR_NET_8,
         {INVALID_NAME, INVALID_NAME, INVALID_NAME, INVALID_NAME, INVALID_NAME, INVALID_NAME,
          INVALID_NAME}},
        {USR_NET_9, {"ccmni9", "ccmni9", "ccmni9", "cc2mni9", "cc3mni9", "ccemni9", INVALID_NAME}},
        {USR_NET_10,
         {"ccmni10", "ccmni10", "ccmni10", "cc2mni10", "cc3mni10", "ccemni10", INVALID_NAME}},
        {USR_NET_11,
         {"ccmni11", "ccmni11", "ccmni11", "cc2mni11", "cc3mni11", "ccemni11", INVALID_NAME}},
        {USR_NET_12,
         {"ccmni12", "ccmni12", "ccmni12", "cc2mni12", "cc3mni12", "ccemni12", INVALID_NAME}},
        {USR_NET_13,
         {"ccmni13", "ccmni13", "ccmni13", "cc2mni13", "cc3mni13", "ccemni13", INVALID_NAME}},
        {USR_NET_14,
         {"ccmni14", "ccmni14", "ccmni14", "cc2mni14", "cc3mni14", "ccemni14", INVALID_NAME}},
        {USR_NET_15,
         {"ccmni15", "ccmni15", "ccmni15", "cc2mni15", "cc3mni15", "ccemni15", INVALID_NAME}},
        {USR_NET_16,
         {"ccmni16", "ccmni16", "ccmni16", "cc2mni16", "cc3mni16", "ccemni16", INVALID_NAME}},
        {USR_NET_17,
         {"ccmni17", "ccmni17", "ccmni17", "cc2mni17", "cc3mni17", "ccemni17", INVALID_NAME}},
        {USR_NET_18,
         {"ccmni18", "ccmni18", "ccmni18", "cc2mni18", "cc3mni18", "ccemni18", INVALID_NAME}},
        {USR_NET_19,
         {"ccmni19", "ccmni19", "ccmni19", "cc2mni19", "cc3mni19", "ccemni19", INVALID_NAME}},
        {USR_NET_20,
         {"ccmni20", "ccmni20", "ccmni20", "cc2mni20", "cc3mni20", "ccemni20", INVALID_NAME}},
        {USR_IMS_AUDIO,
         {INVALID_NAME, INVALID_NAME, "/dev/ccci_imsa", "/dev/ccci2_imsa", INVALID_NAME,
          "/dev/eemcs_imsa", INVALID_NAME}},
        {USR_IMS_VEDIO,
         {INVALID_NAME, INVALID_NAME, "/dev/ccci_imsv", "/dev/ccci2_imsa", INVALID_NAME,
          "/dev/eemcs_imsv", INVALID_NAME}},
        {USR_IMS_CTRL,
         {INVALID_NAME, INVALID_NAME, "/dev/ccci_imsc", "/dev/ccci2_imsa", INVALID_NAME,
          "/dev/eemcs_imsc", INVALID_NAME}},
        {USR_IMS_DCTRL,
         {INVALID_NAME, INVALID_NAME, "/dev/ccci_imsdc", "/dev/ccci2_imsa", INVALID_NAME,
          "/dev/eemcs_imsdc", INVALID_NAME}},
        {USR_ICUSB_DATA,
         {INVALID_NAME, "/dev/ttyC3", "/dev/ttyC3", "/dev/ccci2_tty3", INVALID_NAME, INVALID_NAME,
          INVALID_NAME}},
        {USR_ICUSB_IOCTL,
         {INVALID_NAME, "/dev/ccci_ioctl3", "/dev/ccci_ioctl3", "/dev/ccci2_ioctl3", INVALID_NAME,
          INVALID_NAME, INVALID_NAME}},
        {USR_CCCI_FS,
         {"/dev/ccci_fs", "/dev/ccci_fs", "/dev/ccci_fs", "/dev/ccci2_fs", "/dev/ccci3_fs",
          "/dev/eemcs_fs", INVALID_NAME}},
        {USR_CCCI_CTRL,
         {"/dev/ccci_uem_rx", "/dev/ccci_monitor", "/dev/ccci_monitor", "/dev/ccci2_monitor",
          "/dev/ccci3_monitor", "/dev/eemcs_ctrl", "/dev/emd_ctl0"}},
        {USR_MISC_TA_IPC,
         {INVALID_NAME, INVALID_NAME, "/dev/ccci_ipc_4", "/dev/ccci2_ipc_4", INVALID_NAME,
          INVALID_NAME, INVALID_NAME}},
        {USR_CCCI_RPC,
         {"/dev/ccci_rpc", "/dev/ccci_rpc", "/dev/ccci_rpc", "/dev/ccci2_rpc", INVALID_NAME,
          "/dev/eemcs_rpc", INVALID_NAME}},
        {USR_C2K_FLS,
         {INVALID_NAME, INVALID_NAME, INVALID_NAME, INVALID_NAME, "/dev/ccci3_fls", INVALID_NAME,
          INVALID_NAME}},
        {USR_C2K_AT,
         {INVALID_NAME, INVALID_NAME, INVALID_NAME, INVALID_NAME, "/dev/ccci3_at", INVALID_NAME,
          INVALID_NAME}},
        {USR_C2K_AT2,
         {INVALID_NAME, INVALID_NAME, INVALID_NAME, INVALID_NAME, "/dev/ccci3_at2", INVALID_NAME,
          INVALID_NAME}},
        {USR_C2K_AT3,
         {INVALID_NAME, INVALID_NAME, INVALID_NAME, INVALID_NAME, "/dev/ccci3_at3", INVALID_NAME,
          INVALID_NAME}},
        {USR_C2K_AT4,
         {INVALID_NAME, INVALID_NAME, INVALID_NAME, INVALID_NAME, "/dev/ccci3_at4", INVALID_NAME,
          INVALID_NAME}},
        {USR_C2K_AT5,
         {INVALID_NAME, INVALID_NAME, INVALID_NAME, INVALID_NAME, "/dev/ccci3_at5", INVALID_NAME,
          INVALID_NAME}},
        {USR_C2K_AT6,
         {INVALID_NAME, INVALID_NAME, INVALID_NAME, INVALID_NAME, "/dev/ccci3_at6", INVALID_NAME,
          INVALID_NAME}},
        {USR_C2K_AT7,
         {INVALID_NAME, INVALID_NAME, INVALID_NAME, INVALID_NAME, "/dev/ccci3_at7", INVALID_NAME,
          INVALID_NAME}},
        {USR_C2K_AT8,
         {INVALID_NAME, INVALID_NAME, INVALID_NAME, INVALID_NAME, "/dev/ccci3_at8", INVALID_NAME,
          INVALID_NAME}},
        {USR_C2K_AGPS,
         {INVALID_NAME, INVALID_NAME, "/dev/ccci_c2k_agps", INVALID_NAME, INVALID_NAME,
          INVALID_NAME, INVALID_NAME}},
        {USR_SMEM_CCB_DHL,
         {INVALID_NAME, INVALID_NAME, "/dev/ccci_ccb_dhl", INVALID_NAME, INVALID_NAME, INVALID_NAME,
          INVALID_NAME}},
        {USR_SMEM_CCB_MD_MONITOR,
         {INVALID_NAME, INVALID_NAME, "/dev/ccci_ccb_md_monitor", INVALID_NAME, INVALID_NAME,
          INVALID_NAME, INVALID_NAME}},
        {USR_SMEM_CCB_META,
         {INVALID_NAME, INVALID_NAME, "/dev/ccci_ccb_meta", INVALID_NAME, INVALID_NAME,
          INVALID_NAME, INVALID_NAME}},
        {USR_SMEM_RAW_DHL,
         {INVALID_NAME, INVALID_NAME, "/dev/ccci_raw_dhl", INVALID_NAME, INVALID_NAME, INVALID_NAME,
          INVALID_NAME}},
        {USR_SMEM_RAW_MDM,
         {INVALID_NAME, INVALID_NAME, "/dev/ccci_raw_mdm", INVALID_NAME, INVALID_NAME, INVALID_NAME,
          INVALID_NAME}},
        {USR_SMEM_RAW_NETD,
         {INVALID_NAME, INVALID_NAME, "/dev/ccci_raw_netd", INVALID_NAME, INVALID_NAME,
          INVALID_NAME, INVALID_NAME}},
        {USR_SMEM_RAW_USB,
         {INVALID_NAME, INVALID_NAME, "/dev/ccci_raw_usb", INVALID_NAME, INVALID_NAME, INVALID_NAME,
          INVALID_NAME}},
        {USR_IMS_EM,
         {INVALID_NAME, INVALID_NAME, "/dev/ccci_imsem", INVALID_NAME, INVALID_NAME, INVALID_NAME,
          INVALID_NAME}},
        {USR_SMEM_RAW_AUDIO,
         {INVALID_NAME, INVALID_NAME, "/dev/ccci_raw_audio", INVALID_NAME, "/dev/ccci3_raw_audio",
          INVALID_NAME, INVALID_NAME}},
        {USR_LWA_PROXY,
         {INVALID_NAME, INVALID_NAME, "/dev/ccci_ipc_9", INVALID_NAME, INVALID_NAME, INVALID_NAME,
          INVALID_NAME}},
        {USR_IMSM,
         {INVALID_NAME, INVALID_NAME, "/dev/ccci_imsm", INVALID_NAME, INVALID_NAME, INVALID_NAME,
          INVALID_NAME}},
        {USR_WOA,
         {INVALID_NAME, INVALID_NAME, "/dev/ccci_woa", INVALID_NAME, INVALID_NAME, INVALID_NAME,
          INVALID_NAME}},
        {USR_CCCI_WIFI_PROXY,
         {INVALID_NAME, INVALID_NAME, "/dev/ccci_wifi_proxy", INVALID_NAME, INVALID_NAME,
          INVALID_NAME, INVALID_NAME}},
};
...
static inline char* ccci_get_node_name(CCCI_USER usr_id, CCCI_MD md_id) {
    ...
    if (name && strcmp(name, INVALID_NAME) == 0) name = NULL;
    return name;
}
