...
#else
#define sread(x, y, z)                                                            \
    (ssize_t) recv((RECV_TYPE_ARG1)(x), (RECV_TYPE_ARG2)(y), (RECV_TYPE_ARG3)(z), \
                   (RECV_TYPE_ARG4)(0))
#endif
#else /* HAVE_RECV */
#ifndef sread
...
#else
#define swrite(x, y, z)                                                           \
    (ssize_t) send((SEND_TYPE_ARG1)(x), (SEND_TYPE_ARG2)(y), (SEND_TYPE_ARG3)(z), \
...
#define sreadfrom(s, b, bl, f, fl)                                                                \
    (ssize_t)                                                                                     \
            recvfrom((RECVFROM_TYPE_ARG1)(s), (RECVFROM_TYPE_ARG2*)(b), (RECVFROM_TYPE_ARG3)(bl), \
                     (RECVFROM_TYPE_ARG4)(0), (RECVFROM_TYPE_ARG5*)(f), (RECVFROM_TYPE_ARG6*)(fl))
#endif
#else /* HAVE_RECVFROM */
#ifndef sreadfrom
  /* */
