...
win_platform ares__getplatform(void) {
    ...
    if (!GetVersionEx((void*)&OsvEx)) {
        ...
        if (!GetVersionEx((void*)&OsvEx)) return WIN_UNKNOWN;
    }
...
static struct pvt_servent IANAports[] = {
        ...
        {"cplscrambler-lmg", {NULL}, 1086, "tcp"},
        {"cplscrambler-lmg", {NULL}, 1086, "udp"},
        ...
        {"zmion-lm", {NULL}, 1425, "tcp"},
        {"zmion-lm", {NULL}, 1425, "udp"},
        {"sais", {NULL}, 1426, "tcp"},
        {"sais", {NULL}, 1426, "udp"},
        ...
        {"dmenali-server", {NULL}, 3444, "tcp"},
        {"dmenali-server", {NULL}, 3444, "udp"},
        {"monp", {NULL}, 3445, "tcp"},
        {"monp", {NULL}, 3445, "udp"},
