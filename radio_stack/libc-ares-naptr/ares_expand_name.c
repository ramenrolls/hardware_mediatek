...
int ares_expand_name(const unsigned char* encoded, const unsigned char* abuf, int alen, char** s,
                     long* enclen) {
    int len, indir = 0;
    char* q;
    ...
    if (nlen.sig < 0) return ARES_EBADNAME;
