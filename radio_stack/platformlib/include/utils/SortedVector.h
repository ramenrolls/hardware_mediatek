...
template <typename T>
struct trait_trivial_move<SortedVector<T> > {
    enum { value = true };
};
...
inline SortedVector<TYPE>::SortedVector()
    : SortedVectorImpl(sizeof(TYPE), ((traits<TYPE>::has_trivial_ctor ? HAS_TRIVIAL_CTOR : 0) |
                                      (traits<TYPE>::has_trivial_dtor ? HAS_TRIVIAL_DTOR : 0) |
                                      (traits<TYPE>::has_trivial_copy ? HAS_TRIVIAL_COPY : 0))) {}

template <class TYPE>
inline SortedVector<TYPE>::SortedVector(const SortedVector<TYPE>& rhs) : SortedVectorImpl(rhs) {}
...
template <class TYPE>
inline const SortedVector<TYPE>& SortedVector<TYPE>::operator=(
