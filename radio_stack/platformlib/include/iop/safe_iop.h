...
#define OPAQUE_SAFE_IOP_PREFIX_MACRO_smin(_a) ((typeof(_a))(-__sio(m)(smax)(_a)-1))
...
#define OPAQUE_SAFE_IOP_PREFIX_MACRO_type_enforce(__A, __B)                                        \
    ((((__sio(m)(smin)(__A) <= ((typeof(__A))0)) && (__sio(m)(smin)(__B) <= ((typeof(__B))0))) ||  \
      (((__sio(m)(smin)(__A) > ((typeof(__A))0))) && (__sio(m)(smin)(__B) > ((typeof(__B))0)))) && \
...
#else
#define OPAQUE_SAFE_IOP_PREFIX_MACRO_assert(x) \
    ({                                         \
        assert(x);                             \
        1;                                     \
    })
...
#define safe_add(_ptr, __a, __b)                                                           \
    ({                                                                                     \
        ...
        if (__sio(m)(assert)(__sio(m)(type_enforce)(__sio(var)(_a), __sio(var)(_b)))) {    \
            if (__sio(m)(smin)(__sio(var)(_a)) <= ((typeof(__sio(var)(_a)))0)) {           \
                __sio(var)(ok) = safe_sadd(__sio(var)(p), __sio(var)(_a), __sio(var)(_b)); \
            } else {                                                                       \
                __sio(var)(ok) = safe_uadd(__sio(var)(p), __sio(var)(_a), __sio(var)(_b)); \
            }                                                                              \
        }                                                                                  \
        __sio(var)(ok);                                                                    \
    })
    ...
    ({                                                                                     \
        ...
        if (__sio(m)(assert)(__sio(m)(type_enforce)(__sio(var)(_a), __sio(var)(_b)))) {    \
            if (__sio(m)(umax)(__sio(var)(_a)) <= ((typeof(__sio(var)(_a)))0)) {           \
                __sio(var)(ok) = safe_ssub(__sio(var)(p), __sio(var)(_a), __sio(var)(_b)); \
            } else {                                                                       \
                __sio(var)(ok) = safe_usub(__sio(var)(p), __sio(var)(_a), __sio(var)(_b)); \
            }                                                                              \
        }                                                                                  \
        __sio(var)(ok);                                                                    \
    })
...
#define safe_mul(_ptr, __a, __b)                                                           \
    ({                                                                                     \
        ...
        if (__sio(m)(assert)(__sio(m)(type_enforce)(__sio(var)(_a), __sio(var)(_b)))) {    \
            if (__sio(m)(umax)(__sio(var)(_a)) <= ((typeof(__sio(var)(_a)))0)) {           \
                __sio(var)(ok) = safe_smul(__sio(var)(p), __sio(var)(_a), __sio(var)(_b)); \
            } else {                                                                       \
                __sio(var)(ok) = safe_umul(__sio(var)(p), __sio(var)(_a), __sio(var)(_b)); \
            }                                                                              \
        }                                                                                  \
        __sio(var)(ok);                                                                    \
    })
...
#define safe_div(_ptr, __a, __b)                                                           \
    ({                                                                                     \
        ...
        if (__sio(m)(assert)(__sio(m)(type_enforce)(__sio(var)(_a), __sio(var)(_b)))) {    \
            if (__sio(m)(umax)(__sio(var)(_a)) <= ((typeof(__sio(var)(_a)))0)) {           \
                __sio(var)(ok) = safe_sdiv(__sio(var)(p), __sio(var)(_a), __sio(var)(_b)); \
            } else {                                                                       \
                __sio(var)(ok) = safe_udiv(__sio(var)(p), __sio(var)(_a), __sio(var)(_b)); \
            }                                                                              \
        }                                                                                  \
        __sio(var)(ok);                                                                    \
    })
...
#define safe_mod(_ptr, __a, __b)                                                           \
    ({                                                                                     \
        ...
        if (__sio(m)(assert)(__sio(m)(type_enforce)(__sio(var)(_a), __sio(var)(_b)))) {    \
            if (__sio(m)(umax)(__sio(var)(_a)) <= ((typeof(__sio(var)(_a)))0)) {           \
                __sio(var)(ok) = safe_smod(__sio(var)(p), __sio(var)(_a), __sio(var)(_b)); \
            } else {                                                                       \
                __sio(var)(ok) = safe_umod(__sio(var)(p), __sio(var)(_a), __sio(var)(_b)); \
            }                                                                              \
        }                                                                                  \
        __sio(var)(ok);                                                                    \
    })
...
#define safe_mod5(_ptr, _A, _B, _C, _D, _E)                               \
    ({                                                                    \
        typeof(_A) __sio(var)(a) = (_A);                                  \
        typeof(_B) __sio(var)(b) = (_B);                                  \
        typeof(_C) __sio(var)(c) = (_C), typeof(_D) __sio(var)(d) = (_D); \
        typeof(_E) __sio(var)(e) = (_E);                                  \
        typeof(_A) __sio(var)(r) = 0;                                     \
        (safe_mod(&(__sio(var)(r)), __sio(var)(a), __sio(var)(b)) &&      \
         safe_mod(&(__sio(var)(r)), __sio(var)(r), __sio(var)(c)) &&      \
...
#define safe_sdiv(_ptr, _a, _b)                                                        \
    ({                                                                                 \
        int __sio(var)(ok) = 0;                                                        \
        if ((_b) != 0 && (((_a) != __sio(m)(smin)(_a)) || ((_b) != (typeof(_b))-1))) { \
            if ((_ptr)) {                                                              \
                *((typeof(_a)*)(_ptr)) = (_a) / (_b);                                  \
            }                                                                          \
            __sio(var)(ok) = 1;                                                        \
