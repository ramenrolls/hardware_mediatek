...
extern int ifc_del_address(const char* name, const char* address, int prefixlen);
...
extern int ifc_configure(const char* ifname, in_addr_t address, uint32_t prefixLength,
