 ...
 */
static inline SchedPolicy _policy(SchedPolicy p) { return p == SP_DEFAULT ? SP_SYSTEM_DEFAULT : p; }
...
int set_sched_policy(int tid UNUSED, SchedPolicy policy UNUSED) { return 0; }
