...
class RilSapSocket : public RilSocket {
  ...
  public:
     ...
     */
    static void initSapSocket(const char* socketName, const RIL_RadioFunctions* uimFuncs);
  ...
  private:
     ...
     */
    RilSapSocket(const char* socketName, RIL_SOCKET_ID socketId,
     ...
     * @param Response payload length.
     */
    static void sOnRequestComplete(RIL_Token t, RIL_Errno e, void* response, size_t responselen);
     ...
     * @param Socket id.
     */
    static void sOnUnsolicitedResponse(int unsolResponse, const void* data, size_t datalen,
