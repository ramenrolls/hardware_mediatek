...
StatusDefaultValueEntry s_default_value_table[] = {
        ...
        RFX_STATUS_DEFAULT_VALUE_ENTRY(RFX_STATUS_KEY_UICC_RESET_APPLICATION,
                                       RfxVariant(String8(""))),
        ...
        RFX_STATUS_DEFAULT_VALUE_ENTRY(RFX_STATUS_KEY_SERVICE_STATE,
                                       RfxVariant(RfxNwServiceState())),
        ...
        RFX_STATUS_DEFAULT_VALUE_ENTRY(RFX_STATUS_KEY_SIM_STATE,
                                       RfxVariant(RFX_SIM_STATE_NOT_READY)),
        ...
        RFX_STATUS_DEFAULT_VALUE_ENTRY(RFX_STATUS_KEY_CARRIER_AUTO_APPROVE_INCOMING,
                                       RfxVariant(String8("true"))),
        RFX_STATUS_DEFAULT_VALUE_ENTRY(RFX_STATUS_KEY_EMERGENCY_MODE_IN_FLIGHT_MODE,
                                       RfxVariant(false)),
        ...
        RFX_STATUS_DEFAULT_VALUE_ENTRY(RFX_STATUS_KEY_WORLD_MODE_BLOCKED_CHANGING_STATE,
                                       RfxVariant(0)),
        ...
        RFX_STATUS_DEFAULT_VALUE_ENTRY(RFX_STATUS_KEY_IMS_CC_FAKE_MODE,
                                       RfxVariant(false)), /* GWSD */
        ...
        RFX_STATUS_DEFAULT_VALUE_ENTRY(RFX_STATUS_KEY_PREFERRED_NW_TYPE,
                                       RfxVariant(RfxVariant(-1))),
        ...
        RFX_STATUS_DEFAULT_VALUE_ENTRY(RFX_STATUS_KEY_OPERATOR_INCLUDE_LIMITED,
                                       RfxVariant(String8(""))),
        ...
        RFX_STATUS_DEFAULT_VALUE_ENTRY(RFX_STATUS_KEY_CAPABILITY_SWITCH_STATE,
                                       RfxVariant(CAPABILITY_SWITCH_STATE_IDLE)),
        RFX_STATUS_DEFAULT_VALUE_ENTRY(RFX_STATUS_KEY_CAPABILITY_SWITCH_WAIT_MODULE, RfxVariant(0)),
        RFX_STATUS_DEFAULT_VALUE_ENTRY(RFX_STATUS_KEY_SIM_SWITCH_RADIO_UNAVAIL_TIME,
                                       RfxVariant(int64_t(0))),
        ...
        RFX_STATUS_DEFAULT_VALUE_ENTRY(RFX_STATUS_KEY_CAPABILITY_SWITCH_URC_CHANNEL,
                                       RfxVariant(false)),
        ...
        RFX_STATUS_DEFAULT_VALUE_ENTRY(RFX_STATUS_KEY_DSBP_ENHANCEMENT_STATE,
                                       RfxVariant(DSBP_ENHANCEMENT_END)),
        RFX_STATUS_DEFAULT_VALUE_ENTRY(RFX_STATUS_KEY_CAPABILITY_SWITCH_KEEP_EBOOT,
                                       RfxVariant(false)),
        ...
        RFX_STATUS_DEFAULT_VALUE_ENTRY(RFX_STATUS_KEY_IMS_CALL_LIST,
                                       RfxVariant(Vector<RfxImsCallInfo*>())),
        RFX_STATUS_DEFAULT_VALUE_ENTRY(RFX_STATUS_KEY_RESTORE_IMS_CONFERENCE_PARTICIPANT,
                                       RfxVariant(String8("true"))),
        RFX_STATUS_DEFAULT_VALUE_ENTRY(
                RFX_STATUS_KEY_OPERATE_IMS_CONFERENCE_PARTICIPANTS_BY_USER_ENTITY,
                RfxVariant(String8("true"))),
        RFX_STATUS_DEFAULT_VALUE_ENTRY(RFX_STATUS_KEY_IMS_SPECIFIC_CONFERENCE_MODE,
        ...
        RFX_STATUS_DEFAULT_VALUE_ENTRY(RFX_STATUS_KEY_HIGH_PRIORITY_CLIR_PREFIX_SUPPORTED,
                                       RfxVariant(String8("false"))),
        RFX_STATUS_DEFAULT_VALUE_ENTRY(RFX_STATUS_KEY_CONFIG_DEVICE_VOLTE_AVAILABLE,
                                       RfxVariant(String8("0"))),
        RFX_STATUS_DEFAULT_VALUE_ENTRY(RFX_STATUS_KEY_CONFIG_DEVICE_VT_AVAILABLE,
                                       RfxVariant(String8("0"))),
        RFX_STATUS_DEFAULT_VALUE_ENTRY(RFX_STATUS_KEY_CONFIG_DEVICE_WFC_AVAILABLE,
                                       RfxVariant(String8("0"))),
        RFX_STATUS_DEFAULT_VALUE_ENTRY(RFX_STATUS_KEY_CONFIG_DEVICE_VONR_AVAILABLE,
                                       RfxVariant(String8("0"))),
        RFX_STATUS_DEFAULT_VALUE_ENTRY(RFX_STATUS_KEY_CONFIG_DEVICE_VINR_AVAILABLE,
                                       RfxVariant(String8("0"))),
        RFX_STATUS_DEFAULT_VALUE_ENTRY(RFX_STATUS_KEY_CARRIER_ALLOW_TURN_OFF_IMS,
                                       RfxVariant(String8("1"))),
        ...
        RFX_STATUS_DEFAULT_VALUE_ENTRY(RFX_STATUS_KEY_CUSTOMIZED_USER_AGENT_FORMAT,
                                       RfxVariant(String8("0"))),
        RFX_STATUS_DEFAULT_VALUE_ENTRY(RFX_STATUS_KEY_SML_SLOT_LOCK_POLICY, RfxVariant(0)),
        RFX_STATUS_DEFAULT_VALUE_ENTRY(RFX_STATUS_KEY_SML_SLOT_LOCK_POLICY_LOCK_STATE,
                                       RfxVariant(1)),
        RFX_STATUS_DEFAULT_VALUE_ENTRY(RFX_STATUS_KEY_SML_SLOT_LOCK_POLICY_SERVICE_CAPABILITY,
                                       RfxVariant(0)),
        RFX_STATUS_DEFAULT_VALUE_ENTRY(RFX_STATUS_KEY_SML_SLOT_LOCK_POLICY_VALID_CARD,
                                       RfxVariant(0)),
        RFX_STATUS_DEFAULT_VALUE_ENTRY(RFX_STATUS_KEY_IMS_PDN_ACT_AID,
                                       RfxVariant(RFX_NO_ONGOING_IMS_PDN_AID)),
        RFX_STATUS_DEFAULT_VALUE_ENTRY(RFX_STATUS_KEY_IMS_PDN_DEACT_AID,
                                       RfxVariant(RFX_NO_ONGOING_IMS_PDN_AID)),
        RFX_STATUS_DEFAULT_VALUE_ENTRY(RFX_STATUS_KEY_EIMS_PDN_ACT_AID,
                                       RfxVariant(RFX_NO_ONGOING_IMS_PDN_AID)),
        RFX_STATUS_DEFAULT_VALUE_ENTRY(RFX_STATUS_KEY_EIMS_PDN_DEACT_AID,
                                       RfxVariant(RFX_NO_ONGOING_IMS_PDN_AID)),
        RFX_STATUS_DEFAULT_VALUE_ENTRY(RFX_STATUS_KEY_SML_SLOT_LOCK_CONFIG_CHECKED,
                                       RfxVariant(false)),
        RFX_STATUS_DEFAULT_VALUE_ENTRY(RFX_STATUS_KEY_SML_SLOT_LOCK_MD_SUPPORTED,
                                       RfxVariant(false)),
        ...
        RFX_STATUS_DEFAULT_VALUE_ENTRY(RFX_STATUS_KEY_IMS_INCOMING_CALL_RULE,
                                       RfxVariant(String8("0"))),
        RFX_STATUS_DEFAULT_VALUE_ENTRY(RFX_STATUS_KEY_CARRIER_IGNORE_CLIR_WHEN_ECC,
                                       RfxVariant(String8("1"))),
        ...
        RFX_STATUS_DEFAULT_VALUE_ENTRY(RFX_STATUS_KEY_IMS_REG_IND_ERROR_MSG,
                                       RfxVariant(String8(""))),
        RFX_STATUS_DEFAULT_VALUE_ENTRY(RFX_STATUS_KEY_IMS_PDN_STATE,
                                       RfxVariant(IMS_OR_EIMS_PDN_INIT)),
        RFX_STATUS_DEFAULT_VALUE_ENTRY(RFX_STATUS_KEY_EIMS_PDN_STATE,
                                       RfxVariant(IMS_OR_EIMS_PDN_INIT)),
