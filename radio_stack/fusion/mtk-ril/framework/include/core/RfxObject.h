...
#define RFX_DECLARE_CLASS(_class_name)                                                    \
  ...
  public:                                                                                 \
    ...
    static RfxClassInfo* getClassInfoInstance() { return get##_class_name##ClassInfo(); } \
                                                                                          \
  protected:                                                                              \
...
#define RFX_IMPLEMENT_CLASS(_register_name, _class_name, _parent_class_name)                    \
    ...
    RfxClassInfo* _class_name::get##_class_name##ClassInfo() {                                  \
        return (RfxClassInfo*)&s_class_info;                                                    \
                                                                                                ...
                                                                                                \
    RfxClassInfo* _class_name::onGetClassInfo() const { return get##_class_name##ClassInfo(); } \
                                                                                                \
    RfxClassInfo* get##_class_name##ClassInfo() {                                               \
        return (RfxClassInfo*)&_class_name::s_class_info;                                       \
    }                                                                                           \
                                                                                                \
    const rfx_class_info_struct _class_name::s_class_info = {                                   \
            _register_name, &_parent_class_name::s_class_info, &_class_name::createInstance};
...
#define RFX_IMPLEMENT_VIRTUAL_CLASS(_register_name, _class_name, _parent_class_name)            \
    ...
    RfxClassInfo* _class_name::onGetClassInfo() const { return get##_class_name##ClassInfo(); } \
                                                                                                \
    const rfx_class_info_struct _class_name::s_class_info = {                                   \
            _register_name, &_parent_class_name::s_class_info, NULL};
...
#define RFX_OBJ_DYNAMIC_CAST(_ptr, _class_name)                                                    \
    ((_ptr) ? ((_ptr)->isKindOf(RFX_OBJ_CLASS_INFO(_class_name)) ? static_cast<_class_name*>(_ptr) \
                                                                 : NULL)                           \
            : NULL)
    ...
    void _class_name::closeInstance() {                            \
        if (s_instance != NULL) {                                  \
            ...
            s_instance = NULL;                                     \
                                                                   ...
                                                                   \
    unsigned char _class_name::s_instance_buf[sizeof(_class_name)] \
...
#endif
{
  ...
  public:
    ...
    RfxObject* getParent() const { return m_parent_obj; }
  ...
  private:
    // Internal Used.
    void setParent(RfxObject* objParent  // [IN] New object to be set as parent
    );
    ...
    // Internal Used.
    void addChild(RfxObject* childObj  // [IN] The child object to be added
    );

    // Internal Used.
    void removeChild(RfxObject* childObj  // [IN] The child object to be removed
    );

    // Framework methods
  public:
    RfxObject* getSelf() { return this; }
    ...
    RfxClassInfo* getClassInfo() const { return onGetClassInfo(); }
    ...
    // Internal used.
    bool isValid() const { return m_guard == RFX_OBJ_CREATED_GUARD_PATTERN; }
  ...
  protected:
    ...
    void onAddChild(RfxObject* child_obj  // [IN] The child object to be added
    );

    // Called on removing a child object.
    //
    // SEE ALSO: setParent, removeFromParent, removeChild,
    void onRemoveChild(RfxObject* child_obj  // [IN] The child object to be removed
    );
...
inline RfxObject* RfxObject::getFirstChildObj() const { return m_first_child_obj; }

inline RfxObject* RfxObject::getLastChildObj() const { return m_last_child_obj; }

inline RfxObject* RfxObject::getNextObj() const { return m_next_obj; }

inline RfxObject* RfxObject::getPrevObj() const { return m_prev_obj; }

inline void RfxObject::removeChild(RfxObject* child_obj) {
