...
// Internal used.
typedef void (*RfxEmitEntryFuncPtr)(RfxObject* obj, RfxSlotObjMemFuncPtr callback, void* arguments);
...
#define RFX_REG_POSTEMIT(_class, _arg, _cb_obj, _cb_func)                            \
    do {                                                                             \
        RfxAsyncSignalUtil* async_signal = RFX_OBJ_GET_INSTANCE(RfxAsyncSignalUtil); \
        async_signal->regPostEmit(                                                   \
                this, (RfxEmitEntryFuncPtr)&_class::emitEntry, _arg, _cb_obj,        \
...
class RfxSlot {
  ...
  public:
    ...
    // Copy constructor
    RfxSlot(const RfxSlot& other) : m_obj_ptr(other.m_obj_ptr), m_callback(other.m_callback) {}

    // Method
  public:
    // Whether target object is valid.
    bool isValid() const { return (m_obj_ptr.promote().get() != NULL); }
  ...
  public:
    ...
    bool operator==(const RfxSlot& other) { return equalTo(other); }
...
class RfxSlotList {
    ...
    class SlotListEntry {
      public:
        ...
        SlotListEntry(RfxObject* obj, RfxSlotObjMemFuncPtr memFunc)
            : m_magic_number(RFX_SLOT_LIVE_MAGIC_NUMBER), m_slot(obj, memFunc), m_next(NULL) {}
        ~SlotListEntry() { m_magic_number = RFX_SLOT_DEAD_MAGIC_NUMBER; }
  ...
  public:
    ...
    // Cioy constructor
    RfxSlotList(const RfxSlotList& other) : m_list_head(NULL) { assignWithList(other); }
  ...
  public:
    ...
    //          it will return NULL.
    SlotListEntry* getHead() const { return m_list_head; }
    ...
    //          it will return NULL.
    SlotListEntry* findEntry(RfxObject* obj, RfxSlotObjMemFuncPtr memFunc) const;

    // Add the slot into the head ot slot list
    void pushSlot(RfxObject* obj, RfxSlotObjMemFuncPtr memFunc);

    // Append the slot into the tail ot slot list
    void appendSlot(RfxObject* obj, RfxSlotObjMemFuncPtr memFunc);

    // Remove the given slot from the slot list
    void removeSlot(RfxObject* obj, RfxSlotObjMemFuncPtr memFunc);
...
// Internal used. RfxAsyncSignalUtil is a singleton class which helps to process asyncronous
// signals.
class RfxAsyncSignalUtil : public RfxObject {
  ...
  public:
    ...
    // Method
  public:
    void regPostEmit(const RfxBaseSignal* baseSignal, RfxEmitEntryFuncPtr emit_funcptr,
                     RfxSignalArg* arguments, RfxObject* callback_obj,
...
class RfxBaseSignal {
  ...
  public:
    ...
    static void emitSlots(const RfxSlotList* slot_list, RfxEmitEntryFuncPtr emit_funcptr,
                          void* arguments, RfxObject* object = NULL);
...
class RfxSignal0 : public RfxBaseSignal {
  ...
  public:
    ...
    void connect(RfxCallback0 cb) { baseConnect(cb.m_obj_ptr.promote().get(), cb.m_callback); }
...
class RfxSignal2 : public RfxBaseSignal {
  ...
  public:
    ...
    template <class _func_type>
    void postEmit(
            _arg1_type arg1, _arg2_type arg2,
            RfxObject* obj,  // [IN] after emiting the signal, callback to which object
            _func_type func  // [IN] after emiting the signal, callback to which member function
    ) const {
        Argument* arg;
...
class RfxSignal3 : public RfxBaseSignal {
  ...
  public:
    ...
    template <class _func_type>
    void postEmit(
            _arg1_type arg1, _arg2_type arg2, _arg3_type arg3,
            RfxObject* obj,  // [IN] after emiting the signal, callback to which object
            _func_type func  // [IN] after emiting the signal, callback to which member function
    ) const {
        Argument* arg;
...
class RfxSignal4 : public RfxBaseSignal {
  ...
  public:
    ...
    template <class _func_type>
    void postEmit(
            _arg1_type arg1, _arg2_type arg2, _arg3_type arg3, _arg4_type arg4,
            RfxObject* obj,  // [IN] after emiting the signal, callback to which object
            _func_type func  // [IN] after emiting the signal, callback to which member function
    ) const {
        Argument* arg;
...
template <class _MemFunc>
void rfxPostInvoke0(RfxObject* obj,  // [IN] the callback object
                    _MemFunc func    // [IN] the callback object member function
) {
    typedef RfxPostInvoke0 PostInvoke;
    PostInvoke* invoke;
    invoke = new PostInvoke(obj, func);
    rfxPostInvoke(RFX_OBJ_GET_INSTANCE(RfxAsyncSignalUtil), &RfxAsyncSignalUtil::callback0, invoke);
}

// Post invoke a member function with 1 arguments
template <class _MemFunc, class _Arg1>
void rfxPostInvoke1(RfxObject* obj,  // [IN] the callback object
                    _MemFunc func,   // [IN] the callback object member function
    ...
    rfxPostInvoke(RFX_OBJ_GET_INSTANCE(RfxAsyncSignalUtil), &RfxAsyncSignalUtil::callback1<_Arg1>,
                  invoke);
}

// Post invoke a member function with 2 arguments
template <class _MemFunc, class _Arg1, class _Arg2>
void rfxPostInvoke2(RfxObject* obj,  // [IN] the callback object
                    _MemFunc func,   // [IN] the callback object member function
                    _Arg1 arg1,      // [IN] the 1'st argument
    ...
    rfxPostInvoke(RFX_OBJ_GET_INSTANCE(RfxAsyncSignalUtil),
                  &RfxAsyncSignalUtil::callback2<_Arg1, _Arg2>, invoke);
}

// Post invoke a member function with 3 arguments
template <class _MemFunc, class _Arg1, class _Arg2, class _Arg3>
void rfxPostInvoke3(RfxObject* obj,  // [IN] the callback object
                    _MemFunc func,   // [IN] the callback object member function
                    _Arg1 arg1,      // [IN] the 1'st argument
                    _Arg2 arg2,      // [IN] the 2'nd argument
...
void rfxPostInvoke4(RfxObject* obj,  // [IN] the callback object
    ...
    rfxPostInvoke(RFX_OBJ_GET_INSTANCE(RfxAsyncSignalUtil),
                  &RfxAsyncSignalUtil::callback4<_Arg1, _Arg2, _Arg3, _Arg4>, invoke);
}
