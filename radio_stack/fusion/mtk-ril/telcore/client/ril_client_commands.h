...
{RIL_REQUEST_GET_SIM_STATUS, dispatchVoid, responseSimStatus},
        ...
        {RIL_REQUEST_QUERY_CALL_WAITING, dispatchInts,
         responseInts}, /* Solve [ALPS00284553] Change to 1, mtk04070, 20120516 */
        ...
        {RIL_REQUEST_GET_CELL_INFO_LIST, dispatchVoid,
         responseCellInfoList},  // ALPS01286560: getallcellinfo might be pending by PLMN list such
                                 // long time request and case SWT .
        {RIL_REQUEST_SET_UNSOL_CELL_INFO_LIST_RATE, dispatchInts, responseVoid},
        {RIL_REQUEST_SET_INITIAL_ATTACH_APN, dispatchSetInitialAttachApn,
         responseVoid},  // GSM CH should go with RIL_REQUEST_RADIO_POWER, C2K CH dont care
        ...
        // MTK request
        {RIL_REQUEST_RESUME_REGISTRATION, dispatchInts,
         responseVoid},  // [C2K][IR] Support SVLTE IR feature
        ...
        {RIL_REQUEST_ABORT_QUERY_AVAILABLE_NETWORKS, dispatchVoid,
         responseVoid},  // for PLMN List abort
        ...
        {RIL_REQUEST_QUERY_CALL_FORWARD_IN_TIME_SLOT, dispatchCallForwardEx,
         responseCallForwardsEx},
        ...
        {RIL_REQUEST_SET_SYSTEM_SELECTION_CHANNELS, dispatchSetSystemSelectionChannels,
         responseVoid},
        {RIL_REQUEST_SET_SIGNAL_STRENGTH_REPORTING_CRITERIA,
         dispatchSetSignalStrengthReportingCriteria, responseVoid},
