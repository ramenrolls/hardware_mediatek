 ...
 */
int RtcImsConferenceCallMessageHandler::getMaxUserCount() const { return mMaxUserCount; }
 ...
 */
void RtcImsConferenceCallMessageHandler::setCallId(const int& callId) { mCallId = callId; }
 ...
 * @return call id
 */
int RtcImsConferenceCallMessageHandler::getCallId() const { return mCallId; }
 ...
 */
int RtcImsConferenceCallMessageHandler::getUserCount() const { return mUserCount; }
 ...
 */
string RtcImsConferenceCallMessageHandler::getHostInfo() const { return mHostInfo; }
 ...
 */
int RtcImsConferenceCallMessageHandler::getVersion() const { return mVersion; }
 ...
 */
int RtcImsConferenceCallMessageHandler::getCEPState() const { return mCEPState; }
...
ConferenceCallUser::ConferenceCallUser()
    : mEndPoint(""), mEntity(""), mDisplayText(""), mStatus(""), mUserAddr(""), mIndex(0) {}
