...
RmcAgpsURCHandler::~RmcAgpsURCHandler() { logV(AGPS_TAG, "[RmcAgpsURCHandler]destory"); }
...
void RmcAgpsURCHandler::handleAgpsUrc(int isConnect) {
    ...
    sp<RfxMclMessage> urc = RfxMclMessage::obtainUrc(RFX_MSG_URC_VIA_GPS_EVENT, m_slot_id,
                                                     RfxIntsData((void*)&val, sizeof(int)));
