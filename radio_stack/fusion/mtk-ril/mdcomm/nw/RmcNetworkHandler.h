...
typedef enum { RAT_GROUP_UNKNOWN, RAT_GROUP_2G, RAT_GROUP_3G, RAT_GROUP_4G } RIL_RAT_GROUP;
...
class RmcNetworkHandler : public RfxBaseHandler {
  public:
    ...
    int getEonsNamesFromNumericCode(char* code, unsigned int lac, char* longname, char* shortname,
                                    int max_length);
    int getOperatorNamesFromNumericCode(char* code, char* longname, char* shortname,
                                        int max_length);
    int getOperatorNamesFromNumericCode(char* code, unsigned int lac, char* longname,
                                        char* shortname, int max_length);
    int getOperatorNamesFromNumericCodeByDisplay(char* code, unsigned int lac, char* longname,
                                                 char* shortname, int max_length, int display);
