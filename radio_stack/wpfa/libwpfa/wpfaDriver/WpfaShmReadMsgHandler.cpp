 ...
 *****************************************************************************/
void WpfaShmReadMsgHandler::ShmReadMsgHandler::handleMessage(const Message& message) {
    WPFA_UNUSED(message);
...
int WpfaShmReadMsgHandler::sendPktToKernel(unsigned char* data, int len) { return -1; }
