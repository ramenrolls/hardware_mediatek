...
extern int xfrm_policy_process_delete_exist(struct rtnl_handle_xfrm* rth, struct nlmsghdr* n,
                                            pid_t volte_pid);
extern int xfrm_state_process_delete_exist(struct rtnl_handle_xfrm* rth, struct nlmsghdr* n,
                                           pid_t volte_pid);
