...
inline static const char* asString(OMX_AUDIO_CODINGEXTTYPE i, const char* def = "??") {
    switch (i) {
        ...
        case OMX_AUDIO_CodingAndroidOPUS:
            return "AndroidOPUS";
        default:
            return asString((OMX_AUDIO_CODINGTYPE)i, def);
    }
}
...
inline static const char* asString(OMX_ERRORTYPE i, const char* def = "??") {
    switch (i) {
        ...
        case OMX_ErrorInvalidComponent:
            return "InvalidComponent";  // unused
        case OMX_ErrorBadParameter:
            return "BadParameter";
        case OMX_ErrorNotImplemented:
            return "NotImplemented";
        case OMX_ErrorUnderflow:
            return "Underflow";  // unused
        case OMX_ErrorOverflow:
            return "Overflow";  // unused
        case OMX_ErrorHardware:
            return "Hardware";  // unused
        case OMX_ErrorInvalidState:
            return "InvalidState";
        case OMX_ErrorStreamCorrupt:
            return "StreamCorrupt";
        case OMX_ErrorPortsNotCompatible:
            return "PortsNotCompatible";  // unused
        case OMX_ErrorResourcesLost:
            return "ResourcesLost";
        case OMX_ErrorNoMore:
            return "NoMore";
        case OMX_ErrorVersionMismatch:
            return "VersionMismatch";  // unused
        case OMX_ErrorNotReady:
            return "NotReady";  // unused
        case OMX_ErrorTimeout:
            return "Timeout";  // unused
        case OMX_ErrorSameState:
            return "SameState";  // unused
        case OMX_ErrorResourcesPreempted:
            return "ResourcesPreempted";  // unused
        ...
        case OMX_ErrorPortUnpopulated:
            return "PortUnpopulated";  // unused
        case OMX_ErrorComponentSuspended:
            return "ComponentSuspended";  // unused
        case OMX_ErrorDynamicResourcesUnavailable:
            return "DynamicResourcesUnavailable";  // unused
        case OMX_ErrorMbErrorsInFrame:
            return "MbErrorsInFrame";  // unused
        case OMX_ErrorFormatNotDetected:
            return "FormatNotDetected";  // unused
        case OMX_ErrorContentPipeOpenFailed:
            return "ContentPipeOpenFailed";  // unused
        case OMX_ErrorContentPipeCreationFailed:
            return "ContentPipeCreationFailed";  // unused
        case OMX_ErrorSeperateTablesUsed:
            return "SeperateTablesUsed";  // unused
        case OMX_ErrorTunnelingUnsupported:
            return "TunnelingUnsupported";  // unused
        default:
            return def;
    }
}
...
inline static const char* asString(OMX_INDEXTYPE i, const char* def = "??") {
    switch (i) {
            ...
            //      case OMX_IndexParamNumAvailableStreams:             return
            //      "ParamNumAvailableStreams"; case OMX_IndexParamActiveStream: return
            //      "ParamActiveStream"; case OMX_IndexParamSuspensionPolicy:                return
            //      "ParamSuspensionPolicy"; case OMX_IndexParamComponentSuspended: return
            //      "ParamComponentSuspended"; case OMX_IndexConfigCapturing: return
            //      "ConfigCapturing"; case OMX_IndexConfigCaptureMode:                    return
            //      "ConfigCaptureMode"; case OMX_IndexAutoPauseAfterCapture:                return
            //      "AutoPauseAfterCapture"; case OMX_IndexParamContentURI: return
            //      "ParamContentURI"; case OMX_IndexParamCustomContentPipe:               return
            //      "ParamCustomContentPipe"; case OMX_IndexParamDisableResourceConcealment:
            //          return "ParamDisableResourceConcealment";
            //      case OMX_IndexConfigMetadataItemCount:              return
            //      "ConfigMetadataItemCount"; case OMX_IndexConfigContainerNodeCount: return
            //      "ConfigContainerNodeCount"; case OMX_IndexConfigMetadataItem: return
            //      "ConfigMetadataItem"; case OMX_IndexConfigCounterNodeID:                  return
            //      "ConfigCounterNodeID"; case OMX_IndexParamMetadataFilterType: return
            //      "ParamMetadataFilterType"; case OMX_IndexParamMetadataKeyFilter: return
            //      "ParamMetadataKeyFilter"; case OMX_IndexConfigPriorityMgmt: return
            //      "ConfigPriorityMgmt";
        case OMX_IndexParamStandardComponentRole:
            return "ParamStandardComponentRole";
        case OMX_IndexParamPortDefinition:
            return "ParamPortDefinition";
            //      case OMX_IndexParamCompBufferSupplier:              return
        ...
        case OMX_IndexParamAudioAmr:
            ...
            //      case OMX_IndexParamAudioMidiLoadUserSound:          return
            //      "ParamAudioMidiLoadUserSound"; case OMX_IndexParamAudioG726: return
            //      "ParamAudioG726"; case OMX_IndexParamAudioGsm_EFR:                    return
            //      "ParamAudioGsm_EFR"; case OMX_IndexParamAudioGsm_HR:                     return
            //      "ParamAudioGsm_HR"; case OMX_IndexParamAudioPdc_FR:                     return
            //      "ParamAudioPdc_FR"; case OMX_IndexParamAudioPdc_EFR:                    return
            //      "ParamAudioPdc_EFR"; case OMX_IndexParamAudioPdc_HR:                     return
            //      "ParamAudioPdc_HR"; case OMX_IndexParamAudioTdma_FR:                    return
            //      "ParamAudioTdma_FR"; case OMX_IndexParamAudioTdma_EFR:                   return
            //      "ParamAudioTdma_EFR"; case OMX_IndexParamAudioQcelp8:                     return
            //      "ParamAudioQcelp8"; case OMX_IndexParamAudioQcelp13:                    return
            //      "ParamAudioQcelp13"; case OMX_IndexParamAudioEvrc:                       return
            //      "ParamAudioEvrc"; case OMX_IndexParamAudioSmv:                        return
            //      "ParamAudioSmv";
        case OMX_IndexParamAudioVorbis:
            return "ParamAudioVorbis";
        case OMX_IndexParamAudioFlac:
            return "ParamAudioFlac";
            //      case OMX_IndexConfigAudioMidiImmediateEvent:        return
            //      "ConfigAudioMidiImmediateEvent"; case OMX_IndexConfigAudioMidiControl: return
            //      "ConfigAudioMidiControl"; case OMX_IndexConfigAudioMidiSoundBankProgram:
            //          return "ConfigAudioMidiSoundBankProgram";
            //      case OMX_IndexConfigAudioMidiStatus:                return
            //      "ConfigAudioMidiStatus"; case OMX_IndexConfigAudioMidiMetaEvent: return
            //      "ConfigAudioMidiMetaEvent"; case OMX_IndexConfigAudioMidiMetaEventData: return
            //      "ConfigAudioMidiMetaEventData"; case OMX_IndexConfigAudioVolume: return
            //      "ConfigAudioVolume"; case OMX_IndexConfigAudioBalance:                   return
            //      "ConfigAudioBalance"; case OMX_IndexConfigAudioChannelMute:               return
            //      "ConfigAudioChannelMute"; case OMX_IndexConfigAudioMute: return
            //      "ConfigAudioMute"; case OMX_IndexConfigAudioLoudness:                  return
            //      "ConfigAudioLoudness"; case OMX_IndexConfigAudioEchoCancelation: return
            //      "ConfigAudioEchoCancelation"; case OMX_IndexConfigAudioNoiseReduction: return
            //      "ConfigAudioNoiseReduction"; case OMX_IndexConfigAudioBass: return
            //      "ConfigAudioBass"; case OMX_IndexConfigAudioTreble:                    return
            //      "ConfigAudioTreble"; case OMX_IndexConfigAudioStereoWidening:            return
            //      "ConfigAudioStereoWidening"; case OMX_IndexConfigAudioChorus: return
            //      "ConfigAudioChorus"; case OMX_IndexConfigAudioEqualizer:                 return
            //      "ConfigAudioEqualizer"; case OMX_IndexConfigAudioReverberation: return
            //      "ConfigAudioReverberation"; case OMX_IndexConfigAudioChannelVolume: return
            //      "ConfigAudioChannelVolume"; case OMX_IndexParamImagePortFormat: return
            //      "ParamImagePortFormat"; case OMX_IndexParamFlashControl: return
            //      "ParamFlashControl"; case OMX_IndexConfigFocusControl:                   return
            //      "ConfigFocusControl"; case OMX_IndexParamQFactor:                         return
            //      "ParamQFactor"; case OMX_IndexParamQuantizationTable:               return
            //      "ParamQuantizationTable"; case OMX_IndexParamHuffmanTable: return
            //      "ParamHuffmanTable"; case OMX_IndexConfigFlashControl:                   return
            //      "ConfigFlashControl";
        case OMX_IndexParamVideoPortFormat:
            return "ParamVideoPortFormat";
            //      case OMX_IndexParamVideoQuantization:               return
            //      "ParamVideoQuantization"; case OMX_IndexParamVideoFastUpdate: return
            //      "ParamVideoFastUpdate";
        case OMX_IndexParamVideoBitrate:
            return "ParamVideoBitrate";
            //      case OMX_IndexParamVideoMotionVector:               return
        ...
        case OMX_IndexConfigVideoBitrate:
            ...
            //      case OMX_IndexConfigVideoFramerate:                 return
            //      "ConfigVideoFramerate";
        case OMX_IndexConfigVideoIntraVOPRefresh:
            return "ConfigVideoIntraVOPRefresh";
            //      case OMX_IndexConfigVideoIntraMBRefresh:            return
            //      "ConfigVideoIntraMBRefresh"; case OMX_IndexConfigVideoMBErrorReporting: return
            //      "ConfigVideoMBErrorReporting"; case OMX_IndexParamVideoMacroblocksPerFrame:
            //      return "ParamVideoMacroblocksPerFrame"; case
            //      OMX_IndexConfigVideoMacroBlockErrorMap:        return
            //      "ConfigVideoMacroBlockErrorMap"; case OMX_IndexParamVideoSliceFMO: return
            //      "ParamVideoSliceFMO"; case OMX_IndexConfigVideoAVCIntraPeriod:            return
            //      "ConfigVideoAVCIntraPeriod"; case OMX_IndexConfigVideoNalSize: return
            //      "ConfigVideoNalSize"; case OMX_IndexParamCommonDeblocking:                return
            //      "ParamCommonDeblocking"; case OMX_IndexParamCommonSensorMode: return
            //      "ParamCommonSensorMode"; case OMX_IndexParamCommonInterleave: return
            //      "ParamCommonInterleave"; case OMX_IndexConfigCommonColorFormatConversion:
            //          return "ConfigCommonColorFormatConversion";
        case OMX_IndexConfigCommonScale:
            return "ConfigCommonScale";
            //      case OMX_IndexConfigCommonImageFilter:              return
            //      "ConfigCommonImageFilter"; case OMX_IndexConfigCommonColorEnhancement: return
            //      "ConfigCommonColorEnhancement"; case OMX_IndexConfigCommonColorKey: return
            //      "ConfigCommonColorKey"; case OMX_IndexConfigCommonColorBlend: return
            //      "ConfigCommonColorBlend"; case OMX_IndexConfigCommonFrameStabilisation: return
            //      "ConfigCommonFrameStabilisation"; case OMX_IndexConfigCommonRotate: return
            //      "ConfigCommonRotate"; case OMX_IndexConfigCommonMirror:                   return
            //      "ConfigCommonMirror"; case OMX_IndexConfigCommonOutputPosition:           return
            //      "ConfigCommonOutputPosition";
        case OMX_IndexConfigCommonInputCrop:
            return "ConfigCommonInputCrop";
        case OMX_IndexConfigCommonOutputCrop:
            return "ConfigCommonOutputCrop";
            //      case OMX_IndexConfigCommonDigitalZoom:              return
            //      "ConfigCommonDigitalZoom"; case OMX_IndexConfigCommonOpticalZoom: return
            //      "ConfigCommonOpticalZoom"; case OMX_IndexConfigCommonWhiteBalance: return
            //      "ConfigCommonWhiteBalance"; case OMX_IndexConfigCommonExposure: return
            //      "ConfigCommonExposure"; case OMX_IndexConfigCommonContrast: return
            //      "ConfigCommonContrast"; case OMX_IndexConfigCommonBrightness: return
            //      "ConfigCommonBrightness"; case OMX_IndexConfigCommonBacklight: return
            //      "ConfigCommonBacklight"; case OMX_IndexConfigCommonGamma: return
            //      "ConfigCommonGamma"; case OMX_IndexConfigCommonSaturation:               return
            //      "ConfigCommonSaturation"; case OMX_IndexConfigCommonLightness: return
            //      "ConfigCommonLightness"; case OMX_IndexConfigCommonExclusionRect: return
            //      "ConfigCommonExclusionRect"; case OMX_IndexConfigCommonDithering: return
            //      "ConfigCommonDithering"; case OMX_IndexConfigCommonPlaneBlend: return
            //      "ConfigCommonPlaneBlend"; case OMX_IndexConfigCommonExposureValue: return
            //      "ConfigCommonExposureValue"; case OMX_IndexConfigCommonOutputSize: return
            //      "ConfigCommonOutputSize"; case OMX_IndexParamCommonExtraQuantData: return
            //      "ParamCommonExtraQuantData"; case OMX_IndexConfigCommonFocusRegion: return
            //      "ConfigCommonFocusRegion"; case OMX_IndexConfigCommonFocusStatus: return
            //      "ConfigCommonFocusStatus"; case OMX_IndexConfigCommonTransitionEffect: return
            //      "ConfigCommonTransitionEffect"; case OMX_IndexParamOtherPortFormat: return
            //      "ParamOtherPortFormat"; case OMX_IndexConfigOtherPower: return
            //      "ConfigOtherPower"; case OMX_IndexConfigOtherStats:                     return
            //      "ConfigOtherStats"; case OMX_IndexConfigTimeScale:                      return
            //      "ConfigTimeScale"; case OMX_IndexConfigTimeClockState:                 return
            //      "ConfigTimeClockState"; case OMX_IndexConfigTimeActiveRefClock: return
            //      "ConfigTimeActiveRefClock"; case OMX_IndexConfigTimeCurrentMediaTime: return
            //      "ConfigTimeCurrentMediaTime"; case OMX_IndexConfigTimeCurrentWallTime: return
            //      "ConfigTimeCurrentWallTime"; case OMX_IndexConfigTimeCurrentAudioReference:
            ...
            //      case OMX_IndexConfigTimeMediaTimeRequest:           return
            //      "ConfigTimeMediaTimeRequest"; case OMX_IndexConfigTimeClientStartTime: return
            //      "ConfigTimeClientStartTime"; case OMX_IndexConfigTimePosition: return
            //      "ConfigTimePosition"; case OMX_IndexConfigTimeSeekMode:                   return
            //      "ConfigTimeSeekMode";
        default:
            return def;
    }
...
inline static const char* asString(OMX_INDEXEXTTYPE i, const char* def = "??") {
    switch (i) {
        ...
        case OMX_IndexParamAudioAndroidAc3:
            return "ParamAudioAndroidAc3";
        case OMX_IndexParamAudioAndroidOpus:
            return "ParamAudioAndroidOpus";
        case OMX_IndexParamAudioAndroidAacPresentation:
            return "ParamAudioAndroidAacPresentation";
            //      case OMX_IndexParamNalStreamFormatSupported:    return
            //      "ParamNalStreamFormatSupported"; case OMX_IndexParamNalStreamFormat: return
            //      "ParamNalStreamFormat"; case OMX_IndexParamNalStreamFormatSelect:       return
            //      "ParamNalStreamFormatSelect";
        case OMX_IndexParamVideoVp8:
            return "ParamVideoVp8";
            //      case OMX_IndexConfigVideoVp8ReferenceFrame:     return
            //      "ConfigVideoVp8ReferenceFrame"; case OMX_IndexConfigVideoVp8ReferenceFrameType:
            //      return "ConfigVideoVp8ReferenceFrameType";
        case OMX_IndexParamVideoAndroidVp8Encoder:
            return "ParamVideoAndroidVp8Encoder";
        case OMX_IndexParamVideoHevc:
            return "ParamVideoHevc";
            //      case OMX_IndexParamSliceSegments:               return "ParamSliceSegments";
        case OMX_IndexConfigAndroidIntraRefresh:
            return "ConfigAndroidIntraRefresh";
        case OMX_IndexConfigAutoFramerateConversion:
            return "ConfigAutoFramerateConversion";
        case OMX_IndexConfigPriority:
            return "ConfigPriority";
        case OMX_IndexConfigOperatingRate:
            return "ConfigOperatingRate";
        case OMX_IndexParamConsumerUsageBits:
            return "ParamConsumerUsageBits";
        default:
            return asString((OMX_INDEXTYPE)i, def);
    }
}
...
inline static const char* asString(OMX_VIDEO_VP8PROFILETYPE i, const char* def = "!!") {
    switch (i) {
        case OMX_VIDEO_VP8ProfileMain:
            return "Main";
        case OMX_VIDEO_VP8ProfileUnknown:
...
inline static const char* asString(OMX_VIDEO_ANDROID_VPXTEMPORALLAYERPATTERNTYPE i,
                                   const char* def = "??") {
    switch (i) {
        case OMX_VIDEO_VPXTemporalLayerPatternNone:
            return "VPXTemporalLayerPatternNone";
        case OMX_VIDEO_VPXTemporalLayerPatternWebRTC:
            return "VPXTemporalLayerPatternWebRTC";
        default:
            return def;
    }
}
...
inline static const char* asString(OMX_VIDEO_HEVCPROFILETYPE i, const char* def = "!!") {
    switch (i) {
        case OMX_VIDEO_HEVCProfileUnknown:
            return "Unknown";  // unused
...
inline static const char* asString(OMX_VIDEO_HEVCLEVELTYPE i, const char* def = "!!") {
    switch (i) {
        case OMX_VIDEO_HEVCLevelUnknown:
            return "LevelUnknown";  // unused
