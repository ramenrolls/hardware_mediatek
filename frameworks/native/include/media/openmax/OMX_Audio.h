...
typedef enum OMX_AUDIO_CODINGTYPE {
    ...
    OMX_AUDIO_CodingTDMAEFR,    /**< Any variant of TDMA Enhanced Fullrate encoded data
                                   (TIA/EIA-136-410) */
...
typedef struct OMX_AUDIO_PARAM_PORTFORMATTYPE {
    ...
    OMX_AUDIO_CODINGTYPE
    eEncoding; /**< Type of data expected for this port (e.g. PCM, AMR, MP3, etc) */
...
typedef struct OMX_AUDIO_PARAM_PCMMODETYPE {
    ...
    OMX_AUDIO_CHANNELTYPE eChannelMapping[OMX_AUDIO_MAXCHANNELS]; /**< Slot i contains channel
...
typedef enum OMX_AUDIO_AACPROFILETYPE {
    ...
    OMX_AUDIO_AACObjectHE_PS = 29, /**< AAC High Efficiency with Parametric Stereo coding (HE-AAC
                                      v2, object type PS) */
    OMX_AUDIO_AACObjectELD =
            39, /** AAC Enhanced Low Delay. NOTE: Pending Khronos standardization **/
    OMX_AUDIO_AACObjectXHE =
            42, /** extended High Efficiency AAC. NOTE: Pending Khronos standardization */
...
#define OMX_AUDIO_AACToolNone \
    0x00000000 /**< no AAC tools allowed (encoder config) or active (decoder info output) */
...
#define OMX_AUDIO_AACToolPNS \
    0x00000008 /**< PNS: MPEG-4 Perceptual Noise substitution tool allowed or active */
#define OMX_AUDIO_AACToolLTP \
    0x00000010 /**< LTP: MPEG-4 Long Term Prediction tool allowed or active */
#define OMX_AUDIO_AACToolVendor \
    0x00010000 /**< NOT A KHRONOS VALUE, offset for vendor-specific additions */
...
typedef struct OMX_AUDIO_PARAM_APETYPE {
    ...
    OMX_U32 SampleRate; /**< Sampling rate of the source data.  Use 0 for variable or unknown
                           sampling rate. */
    OMX_S16 fileversion;
...
typedef enum OMX_AUDIO_MIDISOUNDBANKTYPE {
    ...
    OMX_AUDIO_MIDISoundBankMobileDLSPlusOptions, /**< Mobile DLS, using the specification-defined
...
typedef struct OMX_AUDIO_CONFIG_MIDICONTROLTYPE {
    ...
    OMX_U32 nTrack0031MuteMask;   /**< 32 bit mask for track mute status. Note: This is for tracks
                                     0-31 */
    OMX_U32 nTrack3263MuteMask;   /**< 32 bit mask for track mute status. Note: This is for tracks
                                     32-63 */
    OMX_U32 nTrack0031SoloMask;   /**< 32 bit mask for track solo status. Note: This is for tracks
                                     0-31 */
    OMX_U32 nTrack3263SoloMask;   /**< 32 bit mask for track solo status. Note: This is for tracks
                                     32-63 */
