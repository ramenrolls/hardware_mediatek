...
bool startDrmDialogService(String16 drm_cid, String16 rightsIssuer, String16 drmMethod,
                           int rightsStatus, String16 filePath) {
    ALOGD("startDrmDialogService: drm_cid = %s, rightsIssuer = %s, drmMethod = %s, rightsStatus = "
          "%d, path=%s",
