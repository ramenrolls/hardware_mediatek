...
Cta5File* Cta5FileFactory::createCta5File(int fd, String8 key) {
    if (Cta5File::isCta5MultimediaFile(fd) == true) {
        ...
        // check mime type
        if (0 == strcmp("video/mp4", mime.string()) || 0 == strcmp("video/3gpp", mime.string()) ||
...
Cta5File* Cta5FileFactory::createCta5File(String8 mimeType, uint64_t datatLen, String8 key) {
