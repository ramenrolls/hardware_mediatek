...
typedef enum _video_profile {
    ...
    VIDEO_PROFILE_HIGH444_PREDICTIVE =
            (1 << 12),  ///< H264 high 444 predictive profile in Amendment 2
    ...
    VIDEO_PROFILE_SCALABLE_HIGH_INTRA =
            (1 << 15),                        ///< H264 scalable high intra profile in Amendment 3
...
typedef struct h264_codec_fmtp {
    /*@ profile-level-id */
    uint32_t profile_level_id;  ///< H.264 profile level id. construct by 3 parts: profile_idc,
                                ///< profile_iop, level
