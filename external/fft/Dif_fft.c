...
short Wn_r_256[128] = {
        ...
        6393,   5602,   4808,   4011,   3212,   2411,   1608,   804,    0,      -804,   -1608,
        -2411,  -3212,  -4011,  -4808,  -5602,  -6393,  -7180,  -7962,  -8740,  -9512,  -10279,
        -11039, -11793, -12540, -13279, -14010, -14733, -15447, -16151, -16846, -17531, -18205,
        -18868, -19520, -20160, -20788, -21403, -22006, -22595, -23170, -23732, -24279, -24812,
        -25330, -25833, -26320, -26791, -27246, -27684, -28106, -28511, -28899, -29269, -29622,
        -29957, -30274, -30572, -30853, -31114, -31357, -31581, -31786, -31972, -32138, -32286,
        -32413, -32522, -32610, -32679, -32729, -32758, -32768};

short Wn_i_256[128] = {
        -804,   -1608,  -2411,  -3212,  -4011,  -4808,  -5602,  -6393,  -7180,  -7962,  -8740,
        -9512,  -10279, -11039, -11793, -12540, -13279, -14010, -14733, -15447, -16151, -16846,
        -17531, -18205, -18868, -19520, -20160, -20788, -21403, -22006, -22595, -23170, -23732,
        -24279, -24812, -25330, -25833, -26320, -26791, -27246, -27684, -28106, -28511, -28899,
        -29269, -29622, -29957, -30274, -30572, -30853, -31114, -31357, -31581, -31786, -31972,
        -32138, -32286, -32413, -32522, -32610, -32679, -32729, -32758, -32768, -32758, -32729,
        ...
        -13279, -12540, -11793, -11039, -10279, -9512,  -8740,  -7962,  -7180,  -6393,  -5602,
    ...
    for (i = 1; i <= Nu; i++)  // the butterfly part
    {
        ...
        for (j = 1; j <= LE1; j++) {
            for (k = j; k <= N; k += LE) {
                ...
                x[ip].real = temp.real * Wn.real -
                             temp.image * Wn.image;  // lower part has to multiply with Wn(k)
...
void DIF_FFT_Fix16(Complex_Fixed C_z[], unsigned int Nu,
                   short* Shift_of_C_z)  // fixed point version, Nu has to be 8
{
    int iii;
    short i, j, k, ip, I;
...
void DIF_FFT_Fix32(Complex_Fixed_32 C_z[], unsigned int Nu,
                   short* Shift_of_C_z)  // 32 bit fixed point version, Nu has to be 8
{
    int i, j, ip, I, cnt1;
    ...
    *Shift_of_C_z += denorm;
    ...
    //{
    // C_z[i].real>>=(16-min_Qr);	// imitate 16bit storage, for any C_z, give it only 16bit
    // dynamic range C_z[i].real<<=(16-min_Qr);	// imitate 16bit storage C_z[i].image>>=(16-min_Qr);
    // // imitate 16bit storage C_z[i].image<<=(16-min_Qr);	// imitate 16bit storage
