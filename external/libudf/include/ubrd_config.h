...
typedef PUBRD (*UBRD_INIT_FUNCPTR)(const char* module_name, uint64_t debugConfig,
                                   int (*compareFunc)(PUBRD_EntryInfo, PUBRD_EntryInfo));
typedef int (*UBRD_BTRACE_RECORD_FUNCPTR)(PUBRD pUBRD, void* addr, size_t bytes, void* extrainfo,
                                          size_t extrainfolength);
typedef int (*UBRD_BTRACE_REMOVE_FUNCPTR)(PUBRD pUBRD, void* addr, size_t bytes, void* extrainfo,
                                          size_t extrainfolength);
