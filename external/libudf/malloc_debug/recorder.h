...
__attribute__((visibility("default"))) int get_free_chunk_backtrace(void* addr, void** MallocBT,
                                                                    void** freeBT);
__attribute__((visibility("default"))) int get_inuse_chunk_backtrace(void* addr, void** MallocBT);
