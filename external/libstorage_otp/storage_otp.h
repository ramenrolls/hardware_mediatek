...
/* common define */
enum user_id { USER_CCCI = 0, USER_UNDEFINED1, USER_UNDEFINED2, USER_UNDEFINED3, MAX_USER_NUM };
...
struct otp {
    ...
    int (*block_read)(struct otp* otp_device, char* buffer, unsigned long long start_block,
                      unsigned long long block_number);
    int (*block_write)(struct otp* otp_device, char* buffer, unsigned long long start_block,
                       unsigned long long block_number);
    int (*read)(struct otp* otp_device, char* buffer, unsigned long long start,
                unsigned long long size);
    unsigned int (*write)(struct otp* otp_device, char* buffer, unsigned long long start,
                          unsigned long long size);
