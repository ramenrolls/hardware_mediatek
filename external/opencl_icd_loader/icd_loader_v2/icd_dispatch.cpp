...
#ifdef CL_TRACE
    CL_TRACE_CALL(clGetPlatformIDs, 3, "cl_uint", num_entries, "cl_platform_id*", platforms,
                  "cl_uint*", num_platforms)
#endif
...
clGetPlatformInfo(cl_platform_id platform, cl_platform_info param_name, size_t param_value_size,
...
#ifdef CL_TRACE
    CL_TRACE_CALL(clGetPlatformInfo, 5, "cl_platform_id", platform, "cl_platform_info", param_name,
    ...
    return platform->dispatch->clGetPlatformInfo(platform, param_name, param_value_size,
...
#ifdef CL_TRACE
    CL_TRACE_CALL(clGetDeviceIDs, 5, "cl_platform_id", platform, "cl_device_type", device_type,
...
clGetDeviceInfo(cl_device_id device, cl_device_info param_name, size_t param_value_size,
                void* param_value, size_t* param_value_size_ret) CL_API_SUFFIX__VERSION_1_0 {
#ifdef CL_TRACE
    CL_TRACE_CALL(clGetDeviceInfo, 5, "cl_device_id", device, "cl_device_info", param_name,
                  "size_t", param_value_size, "void*", param_value, "size_t*", param_value_size_ret)
#endif
...
#ifdef CL_TRACE
    CL_TRACE_CALL(clCreateSubDevices, 5, "cl_device_id", in_device,
                  "const cl_device_partition_property*", properties, "cl_uint", num_entries,
...
#ifdef CL_TRACE
    CL_TRACE_CALL(clCreateContext, 6, "const cl_context_properties*", properties, "cl_uint",
                  num_devices, "const cl_device_id*", devices, "CL_CALLBACK", pfn_notify, "void*",
...
clCreateContextFromType(const cl_context_properties* properties, cl_device_type device_type,
...
#ifdef CL_TRACE
    CL_TRACE_CALL(clCreateContextFromType, 5, "const cl_context_properties*", properties,
                  "cl_device_type", device_type, "CL_CALLBACK", pfn_notify, "void*", user_data,
                  "cl_int*", errcode_ret)
#endif
    ...
    return platform->dispatch->clCreateContextFromType(properties, device_type, pfn_notify,
                                                       user_data, errcode_ret);
}
...
clGetContextInfo(cl_context context, cl_context_info param_name, size_t param_value_size,
                 void* param_value, size_t* param_value_size_ret) CL_API_SUFFIX__VERSION_1_0 {
#ifdef CL_TRACE
    CL_TRACE_CALL(clGetContextInfo, 5, "cl_context", context, "cl_context_info", param_name,
                  "size_t", param_value_size, "void*", param_value, "size_t*", param_value_size_ret)
#endif
...
CL_API_ENTRY cl_command_queue CL_API_CALL clCreateCommandQueue(
        ...
        cl_int* errcode_ret) CL_API_SUFFIX__VERSION_1_0 {
#ifdef CL_TRACE
    CL_TRACE_CALL(clCreateCommandQueue, 4, "cl_context", context, "cl_device_id", device,
...
CL_API_ENTRY cl_int CL_API_CALL clGetCommandQueueInfo(
        ...
        void* param_value, size_t* param_value_size_ret) CL_API_SUFFIX__VERSION_1_0 {
#ifdef CL_TRACE
    CL_TRACE_CALL(clGetCommandQueueInfo, 5, "cl_command_queue", command_queue,
                  "cl_command_queue_info", param_name, "size_t", param_value_size, "void*",
...
CL_API_ENTRY cl_mem CL_API_CALL clCreateBuffer(cl_context context, cl_mem_flags flags, size_t size,
                                               ...
                                               cl_int* errcode_ret) CL_API_SUFFIX__VERSION_1_0 {
#ifdef CL_TRACE
    CL_TRACE_CALL(clCreateBuffer, 5, "cl_context", context, "cl_mem_flags", flags, "size_t", size,
...
#ifdef CL_TRACE
    CL_TRACE_CALL(clCreateImage, 6, "cl_context", context, "cl_mem_flags", flags,
...
#ifdef CL_TRACE
    CL_TRACE_CALL(clGetSupportedImageFormats, 6, "cl_context", context, "cl_mem_flags", flags,
                  "cl_mem_object_type", image_type, "cl_uint", num_entries, "cl_image_format*",
...
clGetMemObjectInfo(cl_mem memobj, cl_mem_info param_name, size_t param_value_size,
                   void* param_value, size_t* param_value_size_ret) CL_API_SUFFIX__VERSION_1_0 {
#ifdef CL_TRACE
    CL_TRACE_CALL(clGetMemObjectInfo, 5, "cl_mem", memobj, "cl_mem_info", param_name, "size_t",
...
#ifdef CL_TRACE
    CL_TRACE_CALL(clGetImageInfo, 5, "cl_mem", image, "cl_image_info", param_name, "size_t",
                  param_value_size, "void*", param_value, "size_t*", param_value_size_ret)
#endif
...
#ifdef CL_TRACE
    CL_TRACE_CALL(clCreateSampler, 5, "cl_context", context, "cl_bool", normalized_coords,
                  "cl_addressing_mode", addressing_mode, "cl_filter_mode", filter_mode, "cl_int*",
                  errcode_ret)
#endif
...
clGetSamplerInfo(cl_sampler sampler, cl_sampler_info param_name, size_t param_value_size,
                 void* param_value, size_t* param_value_size_ret) CL_API_SUFFIX__VERSION_1_0 {
#ifdef CL_TRACE
    CL_TRACE_CALL(clGetSamplerInfo, 5, "cl_sampler", sampler, "cl_sampler_info", param_name,
                  "size_t", param_value_size, "void*", param_value, "size_t*", param_value_size_ret)
#endif
...
#ifdef CL_TRACE
    CL_TRACE_CALL(clCreateProgramWithSource, 5, "cl_context", context, "cl_uint", count,
...
#ifdef CL_TRACE
    CL_TRACE_CALL(clCreateProgramWithBinary, 7, "cl_context", context, "cl_uint", num_devices,
...
#ifdef CL_TRACE
    CL_TRACE_CALL(clCreateProgramWithBuiltInKernels, 5, "cl_context", context, "cl_uint",
                  num_devices, "const cl_device_id*", device_list, "const char*", kernel_names,
                  "cl_int*", errcode_ret)
#endif
...
#ifdef CL_TRACE
    CL_TRACE_CALL(clBuildProgram, 6, "cl_program", program, "cl_uint", num_devices,
                  "const cl_device_id*", device_list, "const char*", options, "CL_CALLBACK",
...
#ifdef CL_TRACE
    CL_TRACE_CALL(clCompileProgram, 9, "cl_program", program, "cl_uint", num_devices,
                  "const cl_device_id*", device_list, "const char*", options, "cl_uint",
                  num_input_headers, "const cl_program*", input_headers, "const char**",
                  header_include_names, "CL_CALLBACK", pfn_notify, "void*", user_data)
#endif
...
clLinkProgram(cl_context context, cl_uint num_devices, const cl_device_id* device_list,
              ...
              cl_int* errcode_ret) CL_API_SUFFIX__VERSION_1_2 {
#ifdef CL_TRACE
    CL_TRACE_CALL(clLinkProgram, 9, "cl_context", context, "cl_uint", num_devices,
                  "const cl_device_id*", device_list, "const char*", options, "cl_uint",
                  num_input_programs, "const cl_program*", input_programs, "CL_CALLBACK",
                  pfn_notify, "void*", user_data, "cl_int*", errcode_ret)
#endif
...
#ifdef CL_TRACE
    CL_TRACE_CALL(clSetProgramSpecializationConstant, 4, "cl_program", program, "cl_uint", spec_id,
...
#ifdef CL_TRACE
    CL_TRACE_CALL(clSetProgramReleaseCallback, 3, "cl_program", program, "CL_CALLBACK", pfn_notify,
                  "void*", user_data)
#endif
...
clGetProgramInfo(cl_program program, cl_program_info param_name, size_t param_value_size,
                 void* param_value, size_t* param_value_size_ret) CL_API_SUFFIX__VERSION_1_0 {
#ifdef CL_TRACE
    CL_TRACE_CALL(clGetProgramInfo, 5, "cl_program", program, "cl_program_info", param_name,
                  "size_t", param_value_size, "void*", param_value, "size_t*", param_value_size_ret)
#endif
...
clGetProgramBuildInfo(cl_program program, cl_device_id device, cl_program_build_info param_name,
                      ...
                      size_t* param_value_size_ret) CL_API_SUFFIX__VERSION_1_0 {
#ifdef CL_TRACE
    CL_TRACE_CALL(clGetProgramBuildInfo, 6, "cl_program", program, "cl_device_id", device,
                  "cl_program_build_info", param_name, "size_t", param_value_size, "void*",
                  param_value, "size_t*", param_value_size_ret)
#endif
...
CL_API_ENTRY cl_kernel CL_API_CALL clCreateKernel(cl_program program, const char* kernel_name,
                                                  cl_int* errcode_ret) CL_API_SUFFIX__VERSION_1_0 {
#ifdef CL_TRACE
    CL_TRACE_CALL(clCreateKernel, 3, "cl_program", program, "const char*", kernel_name, "cl_int*",
                  errcode_ret)
#endif
...
#ifdef CL_TRACE
    CL_TRACE_CALL(clCreateKernelsInProgram, 4, "cl_program", program, "cl_uint", num_kernels,
...
#ifdef CL_TRACE
    CL_TRACE_CALL(clSetKernelArg, 4, "cl_kernel", kernel, "cl_uint", arg_index, "size_t", arg_size,
...
clGetKernelInfo(cl_kernel kernel, cl_kernel_info param_name, size_t param_value_size,
                void* param_value, size_t* param_value_size_ret) CL_API_SUFFIX__VERSION_1_0 {
#ifdef CL_TRACE
    CL_TRACE_CALL(clGetKernelInfo, 5, "cl_kernel", kernel, "cl_kernel_info", param_name, "size_t",
                  param_value_size, "void*", param_value, "size_t*", param_value_size_ret)
#endif
...
#ifdef CL_TRACE
    CL_TRACE_CALL(clGetKernelArgInfo, 6, "cl_kernel", kernel, "cl_uint", arg_indx,
                  "cl_kernel_arg_info", param_name, "size_t", param_value_size, "void*",
                  param_value, "size_t*", param_value_size_ret)
#endif
...
CL_API_ENTRY cl_int CL_API_CALL clGetKernelWorkGroupInfo(
        ...
        size_t* param_value_size_ret) CL_API_SUFFIX__VERSION_1_0 {
#ifdef CL_TRACE
    CL_TRACE_CALL(clGetKernelWorkGroupInfo, 6, "cl_kernel", kernel, "cl_device_id", device,
                  "cl_kernel_work_group_info", param_name, "size_t", param_value_size, "void*",
                  param_value, "size_t*", param_value_size_ret)
#endif
...
clGetEventInfo(cl_event event, cl_event_info param_name, size_t param_value_size, void* param_value,
               size_t* param_value_size_ret) CL_API_SUFFIX__VERSION_1_0 {
#ifdef CL_TRACE
    CL_TRACE_CALL(clGetEventInfo, 5, "cl_event", event, "cl_event_info", param_name, "size_t",
                  param_value_size, "void*", param_value, "size_t*", param_value_size_ret)
#endif
...
CL_API_ENTRY cl_int CL_API_CALL clGetEventProfilingInfo(
        ...
        size_t* param_value_size_ret) CL_API_SUFFIX__VERSION_1_0 {
#ifdef CL_TRACE
    CL_TRACE_CALL(clGetEventProfilingInfo, 5, "cl_event", event, "cl_profiling_info", param_name,
                  "size_t", param_value_size, "void*", param_value, "size_t*", param_value_size_ret)
#endif

    KHR_ICD_VALIDATE_HANDLE_RETURN_ERROR(event, CL_INVALID_EVENT);
    return event->dispatch->clGetEventProfilingInfo(event, param_name, param_value_size,
                                                    param_value, param_value_size_ret);
}
...
#ifdef CL_TRACE
    CL_TRACE_CALL(clEnqueueReadBuffer, 9, "cl_command_queue", command_queue, "cl_mem", buffer,
                  "cl_bool", blocking_read, "size_t", offset, "size_t", cb, "void*", ptr, "cl_uint",
                  num_events_in_wait_list, "const cl_event*", event_wait_list, "cl_event*", event)
#endif

    KHR_ICD_VALIDATE_HANDLE_RETURN_ERROR(command_queue, CL_INVALID_COMMAND_QUEUE);
    return command_queue->dispatch->clEnqueueReadBuffer(command_queue, buffer, blocking_read,
...
#ifdef CL_TRACE
    CL_TRACE_CALL(clEnqueueReadBufferRect, 14, "cl_command_queue", command_queue, "cl_mem", buffer,
                  "cl_bool", blocking_read, "const size_t*", buffer_origin, "const size_t*",
                  host_origin, "const size_t*", region, "size_t", buffer_row_pitch, "size_t",
                  buffer_slice_pitch, "size_t", host_row_pitch, "size_t", host_slice_pitch, "void*",
                  ptr, "cl_uint", num_events_in_wait_list, "const cl_event*", event_wait_list,
                  "cl_event*", event)
#endif
...
CL_API_ENTRY cl_int CL_API_CALL clEnqueueWriteBuffer(cl_command_queue command_queue, cl_mem buffer,
                                                     ...
                                                     cl_event* event) CL_API_SUFFIX__VERSION_1_0 {
#ifdef CL_TRACE
    CL_TRACE_CALL(clEnqueueWriteBuffer, 9, "cl_command_queue", command_queue, "cl_mem", buffer,
...
CL_API_ENTRY cl_int CL_API_CALL clEnqueueWriteBufferRect(
        ...
        const cl_event* event_wait_list, cl_event* event) CL_API_SUFFIX__VERSION_1_1 {
#ifdef CL_TRACE
    CL_TRACE_CALL(clEnqueueWriteBufferRect, 14, "cl_command_queue", command_queue, "cl_mem", buffer,
                  "cl_bool", blocking_read, "const size_t*", buffer_origin, "const size_t*",
                  host_origin, "const size_t*", region, "size_t", buffer_row_pitch, "size_t",
                  buffer_slice_pitch, "size_t", host_row_pitch, "size_t", host_slice_pitch,
...
CL_API_ENTRY cl_int CL_API_CALL clEnqueueFillBuffer(cl_command_queue command_queue, cl_mem buffer,
...
#ifdef CL_TRACE
    CL_TRACE_CALL(clEnqueueFillBuffer, 9, "cl_command_queue", command_queue, "cl_mem", buffer,
                  "const void*", pattern, "size_t", pattern_size, "size_t", offset, "size_t", cb,
                  "cl_uint", num_events_in_wait_list, "const cl_event*", event_wait_list,
                  "cl_event*", event)
#endif
    ...
    return command_queue->dispatch->clEnqueueFillBuffer(
            command_queue, buffer, pattern, pattern_size, offset, cb, num_events_in_wait_list,
            event_wait_list, event);
}
...
CL_API_ENTRY cl_int CL_API_CALL clEnqueueCopyBuffer(cl_command_queue command_queue,
                                                    ...
                                                    cl_event* event) CL_API_SUFFIX__VERSION_1_0 {
#ifdef CL_TRACE
    CL_TRACE_CALL(clEnqueueCopyBuffer, 9, "cl_command_queue", command_queue, "cl_mem", src_buffer,
...
#ifdef CL_TRACE
    CL_TRACE_CALL(clEnqueueCopyBufferRect, 13, "cl_command_queue", command_queue, "cl_mem",
                  src_buffer, "cl_mem", dst_buffer, "const size_t*", src_origin, "const size_t*",
                  dst_origin, "const size_t*", region, "size_t", src_row_pitch, "size_t",
                  src_slice_pitch, "size_t", dst_row_pitch, "size_t", dst_slice_pitch, "cl_uint",
                  num_events_in_wait_list, "const cl_event*", event_wait_list, "cl_event*", event)
#endif
...
CL_API_ENTRY cl_int CL_API_CALL clEnqueueReadImage(cl_command_queue command_queue, cl_mem image,
                                                   ...
                                                   cl_event* event) CL_API_SUFFIX__VERSION_1_0 {
#ifdef CL_TRACE
    CL_TRACE_CALL(clEnqueueReadImage, 11, "cl_command_queue", command_queue, "cl_mem", image,
                  "cl_bool", blocking_read, "const size_t*", origin, "const size_t*", region,
                  "size_t", row_pitch, "size_t", slice_pitch, "void*", ptr, "cl_uint",
                  num_events_in_wait_list, "const cl_event*", event_wait_list, "cl_event*", event)
#endif
...
CL_API_ENTRY cl_int CL_API_CALL clEnqueueWriteImage(cl_command_queue command_queue, cl_mem image,
                                                    ...
                                                    cl_event* event) CL_API_SUFFIX__VERSION_1_0 {
#ifdef CL_TRACE
    CL_TRACE_CALL(clEnqueueWriteImage, 11, "cl_command_queue", command_queue, "cl_mem", image,
...
CL_API_ENTRY cl_int CL_API_CALL clEnqueueFillImage(cl_command_queue command_queue, cl_mem image,
                                                   ...
                                                   cl_event* event) CL_API_SUFFIX__VERSION_1_2 {
#ifdef CL_TRACE
    CL_TRACE_CALL(clEnqueueFillImage, 8, "cl_command_queue", command_queue, "cl_mem", image,
...
CL_API_ENTRY cl_int CL_API_CALL clEnqueueCopyImage(cl_command_queue command_queue, cl_mem src_image,
                                                   ...
                                                   cl_event* event) CL_API_SUFFIX__VERSION_1_0 {
#ifdef CL_TRACE
    CL_TRACE_CALL(clEnqueueCopyImage, 9, "cl_command_queue", command_queue, "cl_mem", src_image,
                  "cl_mem", dst_image, "const size_t*", src_origin, "const size_t*", dst_origin,
                  "const size_t*", region, "cl_uint", num_events_in_wait_list, "const cl_event*",
                  event_wait_list, "cl_event*", event)
#endif
...
clEnqueueCopyImageToBuffer(cl_command_queue command_queue, cl_mem src_image, cl_mem dst_buffer,
                           ...
                           cl_event* event) CL_API_SUFFIX__VERSION_1_0 {
#ifdef CL_TRACE
    CL_TRACE_CALL(clEnqueueCopyImageToBuffer, 9, "cl_command_queue", command_queue, "cl_mem",
                  src_image, "cl_mem", dst_buffer, "const size_t*", src_origin, "const size_t*",
                  region, "size_t", dst_offset, "cl_uint", num_events_in_wait_list,
...
#ifdef CL_TRACE
    CL_TRACE_CALL(clEnqueueCopyBufferToImage, 9, "cl_command_queue", command_queue, "cl_mem",
                  src_buffer, "cl_mem", dst_image, "size_t", src_offset, "const size_t*",
                  dst_origin, "const size_t*", region, "cl_uint", num_events_in_wait_list,
                  "const cl_event*", event_wait_list, "cl_event*", event)
#endif
...
CL_API_ENTRY void* CL_API_CALL clEnqueueMapBuffer(cl_command_queue command_queue, cl_mem buffer,
                                                  ...
                                                  cl_int* errcode_ret) CL_API_SUFFIX__VERSION_1_0 {
#ifdef CL_TRACE
    CL_TRACE_CALL(clEnqueueMapBuffer, 10, "cl_command_queue", command_queue, "cl_mem", buffer,
                  "cl_bool", blocking_map, "cl_map_flags", map_flags, "size_t", offset, "size_t",
                  cb, "cl_uint", num_events_in_wait_list, "const cl_event*", event_wait_list,
    ...
    return command_queue->dispatch->clEnqueueMapBuffer(
            command_queue, buffer, blocking_map, map_flags, offset, cb, num_events_in_wait_list,
...
CL_API_ENTRY void* CL_API_CALL clEnqueueMapImage(cl_command_queue command_queue, cl_mem image,
                                                 ...
                                                 cl_int* errcode_ret) CL_API_SUFFIX__VERSION_1_0 {
#ifdef CL_TRACE
    CL_TRACE_CALL(clEnqueueMapImage, 12, "cl_command_queue", command_queue, "cl_mem", image,
                  "cl_bool", blocking_map, "cl_map_flags", map_flags, "const size_t*", origin,
                  "const size_t*", region, "size_t*", image_row_pitch, "size_t*", image_slice_pitch,
                  "cl_uint", num_events_in_wait_list, "const cl_event*", event_wait_list,
                  "cl_event*", event, "cl_int*", errcode_ret)
#endif
...
clEnqueueUnmapMemObject(cl_command_queue command_queue, cl_mem memobj, void* mapped_ptr,
                        ...
                        cl_event* event) CL_API_SUFFIX__VERSION_1_0 {
#ifdef CL_TRACE
    CL_TRACE_CALL(clEnqueueUnmapMemObject, 6, "cl_command_queue", command_queue, "cl_mem", memobj,
                  "void*", mapped_ptr, "cl_uint", num_events_in_wait_list, "const cl_event*",
                  event_wait_list, "cl_event*", event)
#endif
...
CL_API_ENTRY cl_int CL_API_CALL clEnqueueMigrateMemObjects(
...
#ifdef CL_TRACE
    CL_TRACE_CALL(clEnqueueMigrateMemObjects, 7, "cl_command_queue", command_queue, "cl_uint",
                  num_mem_objects, "const cl_mem*", mem_objects, "cl_mem_migration_flags", flags,
                  "cl_uint", num_events_in_wait_list, "const cl_event*", event_wait_list,
                  "cl_event*", event)
#endif
    ...
    return command_queue->dispatch->clEnqueueMigrateMemObjects(
            command_queue, num_mem_objects, mem_objects, flags, num_events_in_wait_list,
            event_wait_list, event);
}
...
CL_API_ENTRY cl_int CL_API_CALL clEnqueueNDRangeKernel(
        ...
        const cl_event* event_wait_list, cl_event* event) CL_API_SUFFIX__VERSION_1_0 {
#ifdef CL_TRACE
    CL_TRACE_CALL(clEnqueueNDRangeKernel, 9, "cl_command_queue", command_queue, "cl_kernel", kernel,
                  "cl_uint", work_dim, "const size_t*", global_work_offset, "const size_t*",
...
CL_API_ENTRY cl_int CL_API_CALL clEnqueueTask(cl_command_queue command_queue, cl_kernel kernel,
                                              ...
                                              cl_event* event) CL_API_SUFFIX__VERSION_1_0 {
#ifdef CL_TRACE
    CL_TRACE_CALL(clEnqueueTask, 5, "cl_command_queue", command_queue, "cl_kernel", kernel,
                  "cl_uint", num_events_in_wait_list, "const cl_event*", event_wait_list,
                  "cl_event*", event)
#endif
...
clEnqueueNativeKernel(cl_command_queue command_queue, void(CL_CALLBACK* user_func)(void*),
                      ...
                      const cl_event* event_wait_list, cl_event* event) CL_API_SUFFIX__VERSION_1_0 {
#ifdef CL_TRACE
    CL_TRACE_CALL(clEnqueueNativeKernel, 10, "cl_command_queue", command_queue, "CL_CALLBACK",
                  user_func, "void*", args, "size_t", cb_args, "cl_uint", num_mem_objects,
                  "const cl_mem*", mem_list, "const void**", args_mem_loc, "cl_uint",
                  num_events_in_wait_list, "const cl_event*", event_wait_list, "cl_event*", event)
#endif
...
CL_API_ENTRY cl_int CL_API_CALL clEnqueueMarkerWithWaitList(
        ...
        const cl_event* event_wait_list, cl_event* event) CL_API_SUFFIX__VERSION_1_2 {
#ifdef CL_TRACE
    CL_TRACE_CALL(clEnqueueMarkerWithWaitList, 4, "cl_command_queue", command_queue, "cl_uint",
                  num_events_in_wait_list, "const cl_event*", event_wait_list, "cl_event*", event)
#endif
...
CL_API_ENTRY cl_int CL_API_CALL clEnqueueBarrierWithWaitList(
        ...
        const cl_event* event_wait_list, cl_event* event) CL_API_SUFFIX__VERSION_1_2 {
#ifdef CL_TRACE
    CL_TRACE_CALL(clEnqueueBarrierWithWaitList, 4, "cl_command_queue", command_queue, "cl_uint",
                  num_events_in_wait_list, "const cl_event*", event_wait_list, "cl_event*", event)
#endif
...
#ifdef CL_TRACE
    CL_TRACE_CALL(clGetExtensionFunctionAddressForPlatform, 2, "cl_platform_id", platform,
...
#define CL_COMMON_EXTENSION_ENTRYPOINT_ADD(name) \
    ...
    // FIXME Now that we have a platform id here, we need to validate that it isn't NULL, so
    // shouldn't we have an errcode_ret KHR_ICD_VALIDATE_HANDLE_RETURN_HANDLE(platform,
    // CL_INVALID_PLATFORM);
...
#ifdef CL_TRACE
    CL_TRACE_CALL(clSetCommandQueueProperty, 4, "cl_command_queue", command_queue,
...
#ifdef CL_TRACE
    CL_TRACE_CALL(clCreateSubDevicesEXT, 5, "cl_device_id", in_device,
                  "const cl_device_partition_property_ext*", partition_properties, "cl_uint",
                  num_entries, "cl_device_id*", out_devices, "cl_uint*", num_devices)
#endif
...
#ifdef CL_TRACE
    CL_TRACE_CALL(clCreateImage2D, 8, "cl_context", context, "cl_mem_flags", flags,
                  "const cl_image_format*", image_format, "size_t", image_width, "size_t",
                  image_height, "size_t", image_row_pitch, "void*", host_ptr, "cl_int*",
                  errcode_ret)
#endif

    KHR_ICD_VALIDATE_HANDLE_RETURN_HANDLE(context, CL_INVALID_CONTEXT);
    return context->dispatch->clCreateImage2D(context, flags, image_format, image_width,
...
clCreateImage3D(cl_context context, cl_mem_flags flags, const cl_image_format* image_format,
                size_t image_width, size_t image_height, size_t image_depth, size_t image_row_pitch,
                size_t image_slice_pitch, void* host_ptr,
                cl_int* errcode_ret) CL_EXT_SUFFIX__VERSION_1_1_DEPRECATED {
#ifdef CL_TRACE
    CL_TRACE_CALL(clCreateImage3D, 10, "cl_context", context, "cl_mem_flags", flags,
                  "const cl_image_format*", image_format, "size_t", image_width, "size_t",
    ...
    KHR_ICD_VALIDATE_HANDLE_RETURN_HANDLE(context, CL_INVALID_CONTEXT);
    return context->dispatch->clCreateImage3D(context, flags, image_format, image_width,
...
#ifdef CL_TRACE
    CL_TRACE_CALL(clEnqueueWaitForEvents, 3, "cl_command_queue", command_queue, "cl_uint",
...
#ifdef CL_TRACE
    CL_TRACE_CALL(clCreateFromGLBuffer, 4, "cl_context", context, "cl_mem_flags", flags, "GLuint",
                  bufobj, "int*", errcode_ret)
#endif
...
#ifdef CL_TRACE
    CL_TRACE_CALL(clCreateFromGLTexture, 6, "cl_context", context, "cl_mem_flags", flags,
                  "cl_GLenum", target, "cl_GLint", miplevel, "cl_GLuint", texture, "cl_int*",
                  errcode_ret)
#endif
...
#ifdef CL_TRACE
    CL_TRACE_CALL(clCreateFromGLTexture2D, 6, "cl_context", context, "cl_mem_flags", flags,
...
clCreateFromGLTexture3D(cl_context context, cl_mem_flags flags, cl_GLenum target, cl_GLint miplevel,
                        cl_GLuint texture, cl_int* errcode_ret) CL_API_SUFFIX__VERSION_1_0 {
#ifdef CL_TRACE
    CL_TRACE_CALL(clCreateFromGLTexture3D, 6, "cl_context", context, "cl_mem_flags", flags,
                  "GLenum", target, "GLint", miplevel, "GLuint", texture, "cl_int*", errcode_ret)
#endif
...
clCreateFromGLRenderbuffer(cl_context context, cl_mem_flags flags, cl_GLuint renderbuffer,
                           cl_int* errcode_ret) CL_API_SUFFIX__VERSION_1_0 {
#ifdef CL_TRACE
    CL_TRACE_CALL(clCreateFromGLRenderbuffer, 4, "cl_context", context, "cl_mem_flags", flags,
...
CL_API_ENTRY cl_int CL_API_CALL clGetGLObjectInfo(cl_mem memobj, cl_gl_object_type* gl_object_type,
        ...
        CL_API_SUFFIX__VERSION_1_0 {
#ifdef CL_TRACE
    CL_TRACE_CALL(clGetGLObjectInfo, 3, "cl_mem", memobj, "cl_gl_object_type*", gl_object_type,
...
clGetGLTextureInfo(cl_mem memobj, cl_gl_texture_info param_name, size_t param_value_size,
                   void* param_value, size_t* param_value_size_ret) CL_API_SUFFIX__VERSION_1_0 {
#ifdef CL_TRACE
    CL_TRACE_CALL(clGetGLTextureInfo, 5, "cl_mem", memobj, "cl_gl_texture_info", param_name,
                  "size_t", param_value_size, "void*", param_value, "size_t*", param_value_size_ret)
#endif
...
CL_API_ENTRY cl_int CL_API_CALL clEnqueueAcquireGLObjects(
        ...
        cl_event* event) CL_API_SUFFIX__VERSION_1_0 {
#ifdef CL_TRACE
    CL_TRACE_CALL(clEnqueueAcquireGLObjects, 6, "cl_command_queue", command_queue, "cl_uint",
                  num_objects, "const cl_mem*", mem_objects, "cl_uint", num_events_in_wait_list,
                  "const cl_event*", event_wait_list, "cl_event*", event)
#endif

    KHR_ICD_VALIDATE_HANDLE_RETURN_ERROR(command_queue, CL_INVALID_COMMAND_QUEUE);
    return command_queue->dispatch->clEnqueueAcquireGLObjects(command_queue, num_objects,
...
CL_API_ENTRY cl_int CL_API_CALL clEnqueueReleaseGLObjects(
        ...
        cl_event* event) CL_API_SUFFIX__VERSION_1_0 {
#ifdef CL_TRACE
    CL_TRACE_CALL(clEnqueueReleaseGLObjects, 6, "cl_command_queue", command_queue, "cl_uint",
                  num_objects, "const cl_mem*", mem_objects, "cl_uint", num_events_in_wait_list,
                  "const cl_event*", event_wait_list, "cl_event*", event)
#endif

    KHR_ICD_VALIDATE_HANDLE_RETURN_ERROR(command_queue, CL_INVALID_COMMAND_QUEUE);
    return command_queue->dispatch->clEnqueueReleaseGLObjects(command_queue, num_objects,
                                                              mem_objects, num_events_in_wait_list,
                                                              event_wait_list, event);
}

CL_API_ENTRY cl_int CL_API_CALL
clGetGLContextInfoKHR(const cl_context_properties* properties, cl_gl_context_info param_name,
                      size_t param_value_size, void* param_value,
                      size_t* param_value_size_ret) CL_API_SUFFIX__VERSION_1_0 {
#ifdef CL_TRACE
    CL_TRACE_CALL(clGetGLContextInfoKHR, 5, "const cl_context_properties*", properties,
                  "cl_gl_context_info", param_name, "size_t", param_value_size, "void*",
                  param_value, "size_t*", param_value_size_ret)
#endif
...
#ifdef CL_TRACE
    CL_TRACE_CALL(clCreateEventFromGLsyncKHR, 3, "cl_context", context, "cl_GLsync", sync,
                  "cl_int*", errcode_ret)
#endif
...
clGetDeviceIDsFromD3D10KHR(cl_platform_id platform, cl_d3d10_device_source_khr d3d_device_source,
                           ...
                           cl_uint num_entries, cl_device_id* devices, cl_uint* num_devices) {
#ifdef CL_TRACE
    CL_TRACE_CALL(clGetDeviceIDsFromD3D10KHR, 7, "cl_platform_id", platform,
                  "cl_d3d10_device_source_khr", d3d_device_source, "void*", d3d_object,
                  "cl_d3d10_device_set_khr", d3d_device_set, "cl_uint", num_entries,
                  "cl_device_id*", devices, "cl_uint*", num_device)
#endif

    KHR_ICD_VALIDATE_HANDLE_RETURN_ERROR(platform, CL_INVALID_PLATFORM);
    return platform->dispatch->clGetDeviceIDsFromD3D10KHR(platform, d3d_device_source, d3d_object,
                                                          d3d_device_set, num_entries, devices,
                                                          num_devices);
}
...
CL_API_ENTRY cl_mem CL_API_CALL clCreateFromD3D10BufferKHR(cl_context context, cl_mem_flags flags,
                                                           ...
                                                           cl_int* errcode_ret) {
#ifdef CL_TRACE
    CL_TRACE_CALL(clCreateFromD3D10BufferKHR, 4, "cl_context", context, "cl_mem_flags", flags,
...
CL_API_ENTRY cl_mem CL_API_CALL clCreateFromD3D10Texture2DKHR(cl_context context,
                                                              ...
                                                              cl_int* errcode_ret) {
#ifdef CL_TRACE
    CL_TRACE_CALL(clCreateFromD3D10Texture2DKHR, 5, "cl_context", context, "cl_mem_flags", flags,
                  "ID3D10Texture2D*", resource, "UINT", subresource, "cl_int*", errcode_ret)
#endif
...
CL_API_ENTRY cl_mem CL_API_CALL clCreateFromD3D10Texture3DKHR(cl_context context,
                                                              ...
                                                              cl_int* errcode_ret) {
#ifdef CL_TRACE
    CL_TRACE_CALL(clCreateFromD3D10Texture3DKHR, 5, "cl_context", context, "cl_mem_flags", flags,
                  "ID3D10Texture3D*", resource, "UINT", subresource, "cl_int*", errcode_ret)
#endif
...
CL_API_ENTRY cl_int CL_API_CALL clEnqueueAcquireD3D10ObjectsKHR(
...
#ifdef CL_TRACE
    CL_TRACE_CALL(clEnqueueAcquireD3D10ObjectsKHR, 6, "cl_command_queue", command_queue, "cl_uint",
                  num_objects, "const cl_mem*", mem_objects, "cl_uint", num_events_in_wait_list,
                  "const cl_event*", event_wait_list, "cl_event*", event)
#endif
    ...
    return command_queue->dispatch->clEnqueueAcquireD3D10ObjectsKHR(
            command_queue, num_objects, mem_objects, num_events_in_wait_list, event_wait_list,
            event);
}
...
CL_API_ENTRY cl_int CL_API_CALL clEnqueueReleaseD3D10ObjectsKHR(
        ...
        cl_uint num_events_in_wait_list, const cl_event* event_wait_list, cl_event* event) {
#ifdef CL_TRACE
    CL_TRACE_CALL(clEnqueueReleaseD3D10ObjectsKHR, 6, "cl_command_queue", command_queue, "cl_uint",
                  num_objects, "const cl_mem*", mem_objects, "cl_uint", num_events_in_wait_list,
                  "const cl_event*", event_wait_list, "cl_event*", event)
#endif
...
clGetDeviceIDsFromD3D11KHR(cl_platform_id platform, cl_d3d11_device_source_khr d3d_device_source,
                           ...
                           cl_uint num_entries, cl_device_id* devices, cl_uint* num_devices) {
#ifdef CL_TRACE
    CL_TRACE_CALL(clGetDeviceIDsFromD3D11KHR, 7, "cl_platform_id", platform,
                  "cl_d3d11_device_source_khr", d3d_device_source, "void*", d3d_object,
                  "cl_d3d11_device_set_khr", d3d_device_set, "cl_uint", num_entries,
                  "cl_device_id*", devices, "cl_uint*", num_device)
#endif

    KHR_ICD_VALIDATE_HANDLE_RETURN_ERROR(platform, CL_INVALID_PLATFORM);
    return platform->dispatch->clGetDeviceIDsFromD3D11KHR(platform, d3d_device_source, d3d_object,
                                                          d3d_device_set, num_entries, devices,
                                                          num_devices);
}
...
CL_API_ENTRY cl_mem CL_API_CALL clCreateFromD3D11BufferKHR(cl_context context, cl_mem_flags flags,
                                                           ...
                                                           cl_int* errcode_ret) {
#ifdef CL_TRACE
    CL_TRACE_CALL(clCreateFromD3D11BufferKHR, 4, "cl_context", context, "cl_mem_flags", flags,
...
CL_API_ENTRY cl_mem CL_API_CALL clCreateFromD3D11Texture2DKHR(cl_context context,
                                                              ...
                                                              cl_int* errcode_ret) {
#ifdef CL_TRACE
    CL_TRACE_CALL(clCreateFromD3D11Texture2DKHR, 5, "cl_context", context, "cl_mem_flags", flags,
                  "ID3D11Texture2D*", resource, "UINT", subresource, "cl_int*", errcode_ret)
#endif
...
CL_API_ENTRY cl_mem CL_API_CALL clCreateFromD3D11Texture3DKHR(cl_context context,
                                                              ...
                                                              cl_int* errcode_ret) {
#ifdef CL_TRACE
    CL_TRACE_CALL(clCreateFromD3D11Texture3DKHR, 5, "cl_context", context, "cl_mem_flags", flags,
                  "ID3D11Texture3D*", resource, "UINT", subresource, "cl_int*", errcode_ret)
#endif
...
CL_API_ENTRY cl_int CL_API_CALL clEnqueueAcquireD3D11ObjectsKHR(
        ...
        cl_uint num_events_in_wait_list, const cl_event* event_wait_list, cl_event* event) {
#ifdef CL_TRACE
    CL_TRACE_CALL(clEnqueueAcquireD3D11ObjectsKHR, 6, "cl_command_queue", command_queue, "cl_uint",
                  num_objects, "const cl_mem*", mem_objects, "cl_uint", num_events_in_wait_list,
                  "const cl_event*", event_wait_list, "cl_event*", event)
#endif
...
CL_API_ENTRY cl_int CL_API_CALL clEnqueueReleaseD3D11ObjectsKHR(
        ...
        cl_uint num_events_in_wait_list, const cl_event* event_wait_list, cl_event* event) {
#ifdef CL_TRACE
    CL_TRACE_CALL(clEnqueueReleaseD3D11ObjectsKHR, 6, "cl_command_queue", command_queue, "cl_uint",
                  num_objects, "const cl_mem*", mem_objects, "cl_uint", num_events_in_wait_list,
                  "const cl_event*", event_wait_list, "cl_event*", event)
#endif
...
CL_API_ENTRY cl_int CL_API_CALL clGetDeviceIDsFromDX9MediaAdapterKHR(
        ...
        cl_uint* num_devices) {
#ifdef CL_TRACE
    CL_TRACE_CALL(clGetDeviceIDsFromDX9MediaAdapterKHR, 8, "cl_platform_id", platform, "cl_uint",
                  num_media_adapters, "cl_dx9_media_adapter_type_khr*", media_adapters_type,
                  "void*", media_adapters, "cl_dx9_media_adapter_set_khr", media_adapter_set,
                  "cl_uint", num_entries, "cl_device_id*", devices, "cl_uint*", num_device)
#endif
...
#ifdef CL_TRACE
    CL_TRACE_CALL(clCreateFromDX9MediaSurfaceKHR, 6, "cl_context", context, "cl_mem_flags", flags,
                  "cl_dx9_media_adapter_type_khr", adapter_type, "void*", surface_info, "cl_uint",
                  plane, "cl_int*", errcode_ret)
#endif
...
CL_API_ENTRY cl_int CL_API_CALL clEnqueueAcquireDX9MediaSurfacesKHR(
        ...
        cl_uint num_events_in_wait_list, const cl_event* event_wait_list, cl_event* event) {
#ifdef CL_TRACE
    CL_TRACE_CALL(clEnqueueAcquireDX9MediaSurfacesKHR, 6, "cl_command_queue", command_queue,
...
CL_API_ENTRY cl_int CL_API_CALL clEnqueueReleaseDX9MediaSurfacesKHR(
        ...
        cl_uint num_events_in_wait_list, const cl_event* event_wait_list, cl_event* event) {
#ifdef CL_TRACE
    CL_TRACE_CALL(clEnqueueReleaseDX9MediaSurfacesKHR, 6, "cl_command_queue", command_queue,
                  "cl_uint", num_objects, "const cl_mem*", mem_objects, "cl_uint",
                  num_events_in_wait_list, "const cl_event*", event_wait_list, "cl_event*", event)
#endif
...
#ifdef CL_TRACE
    CL_TRACE_CALL(clSetEventCallback, 4, "cl_event", event, "cl_int", command_exec_callback_type,
                  "CL_CALLBACK", pfn_notify, "void*", user_data)
#endif
...
CL_API_ENTRY cl_mem CL_API_CALL clCreateSubBuffer(cl_mem buffer, cl_mem_flags flags,
...
#ifdef CL_TRACE
    CL_TRACE_CALL(clCreateSubBuffer, 5, "cl_mem", buffer, "cl_mem_flags", flags,
    ...
    return buffer->dispatch->clCreateSubBuffer(buffer, flags, buffer_create_type,
...
clSetMemObjectDestructorCallback(cl_mem memobj, void(CL_CALLBACK* pfn_notify)(cl_mem, void*),
                                 void* user_data) CL_API_SUFFIX__VERSION_1_1 {
#ifdef CL_TRACE
    CL_TRACE_CALL(clSetMemObjectDestructorCallback, 3, "cl_mem", memobj, "CL_CALLBACK", pfn_notify,
                  "void*", user_data)
#endif
...
#ifdef CL_TRACE
    CL_TRACE_CALL(clCreateFromEGLImageKHR, 6, "cl_context", context, "CLeglDisplayKHR", display,
...
CL_API_ENTRY cl_int CL_API_CALL clEnqueueAcquireEGLObjectsKHR(
        ...
        cl_uint num_events_in_wait_list, const cl_event* event_wait_list, cl_event* event) {
#ifdef CL_TRACE
    CL_TRACE_CALL(clEnqueueAcquireEGLObjectsKHR, 6, "cl_command_queue", command_queue, "cl_uint",
                  num_objects, "const cl_mem*", mem_objects, "cl_uint", num_events_in_wait_list,
                  "const cl_event*", event_wait_list, "cl_event*", event)
#endif
...
CL_API_ENTRY cl_int CL_API_CALL clEnqueueReleaseEGLObjectsKHR(
        ...
        cl_uint num_events_in_wait_list, const cl_event* event_wait_list, cl_event* event) {
#ifdef CL_TRACE
    CL_TRACE_CALL(clEnqueueReleaseEGLObjectsKHR, 6, "cl_command_queue", command_queue, "cl_uint",
                  num_objects, "const cl_mem*", mem_objects, "cl_uint", num_events_in_wait_list,
                  "const cl_event*", event_wait_list, "cl_event*", event)
#endif
...
CL_API_ENTRY cl_event CL_API_CALL clCreateEventFromEGLSyncKHR(cl_context context, CLeglSyncKHR sync,
                                                              ...
                                                              cl_int* errcode_ret) {
#ifdef CL_TRACE
    CL_TRACE_CALL(clCreateEventFromEGLSyncKHR, 4, "cl_context", context, "CLeglSyncKHR", sync,
...
#ifdef CL_TRACE
    CL_TRACE_CALL(clCreateCommandQueueWithProperties, 4, "cl_context", context, "cl_device_id",
...
CL_API_ENTRY cl_mem CL_API_CALL clCreatePipe(cl_context context, cl_mem_flags flags,
                                             ...
                                             cl_int* errcode_ret) CL_API_SUFFIX__VERSION_2_0 {
#ifdef CL_TRACE
    CL_TRACE_CALL(clCreatePipe, 6, "cl_context", context, "cl_mem_flags", flags, "cl_uint",
                  pipe_packet_size, "cl_uint", pipe_max_packets, "const cl_pipe_properties*",
...
#ifdef CL_TRACE
    CL_TRACE_CALL(clGetPipeInfo, 5, "cl_mem", pipe, "cl_pipe_info", param_name, "size_t",
                  param_value_size, "void*", param_value, "size_t*", param_value_size_ret)
#endif
...
#ifdef CL_TRACE
    CL_TRACE_CALL(clSVMAlloc, 4, "cl_context", context, "cl_svm_mem_flags", flags, "size_t", size,
                  "cl_uint", alignment)
#endif
...
#ifdef CL_TRACE
    CL_TRACE_CALL(clEnqueueSVMFree, 8, "cl_command_queue", command_queue, "cl_uint",
                  num_svm_pointers, "void**", svm_pointers, "CL_CALLBACK", pfn_free_func, "void*",
                  user_data, "cl_uint", num_events_in_wait_list, "const cl_event*", event_wait_list,
                  "cl_event*", event)
#endif
...
CL_API_ENTRY cl_int CL_API_CALL clEnqueueSVMMemcpy(cl_command_queue command_queue,
                                                   ...
                                                   cl_event* event) CL_API_SUFFIX__VERSION_2_0 {
#ifdef CL_TRACE
    CL_TRACE_CALL(clEnqueueSVMMemcpy, 8, "cl_command_queue", command_queue, "cl_bool",
                  blocking_copy, "void*", dst_ptr, "const void*", src_ptr, "size_t", size,
                  "cl_uint", num_events_in_wait_list, "const cl_event*", event_wait_list,
                  "cl_event*", event)
#endif

    KHR_ICD_VALIDATE_HANDLE_RETURN_ERROR(command_queue, CL_INVALID_COMMAND_QUEUE);
    return command_queue->dispatch->clEnqueueSVMMemcpy(command_queue, blocking_copy, dst_ptr,
...
CL_API_ENTRY cl_int CL_API_CALL clEnqueueSVMMemFill(cl_command_queue command_queue, void* svm_ptr,
                                                    ...
                                                    cl_event* event) CL_API_SUFFIX__VERSION_2_0 {
#ifdef CL_TRACE
    CL_TRACE_CALL(clEnqueueSVMMemFill, 8, "cl_command_queue", command_queue, "void*", svm_ptr,
                  "const void*", pattern, "size_t", pattern_size, "size_t", size, "cl_uint",
                  num_events_in_wait_list, "const cl_event*", event_wait_list, "cl_event*", event)
#endif

    KHR_ICD_VALIDATE_HANDLE_RETURN_ERROR(command_queue, CL_INVALID_COMMAND_QUEUE);
    return command_queue->dispatch->clEnqueueSVMMemFill(command_queue, svm_ptr, pattern,
...
CL_API_ENTRY cl_int CL_API_CALL clEnqueueSVMMap(cl_command_queue command_queue,
                                                ...
                                                cl_event* event) CL_API_SUFFIX__VERSION_2_0 {
#ifdef CL_TRACE
    CL_TRACE_CALL(clEnqueueSVMMap, 8, "cl_command_queue", command_queue, "cl_bool", blocking_map,
                  "cl_map_flags", flags, "void*", svm_ptr, "size_t", size, "cl_uint",
                  num_events_in_wait_list, "const cl_event*", event_wait_list, "cl_event*", event)
#endif

    KHR_ICD_VALIDATE_HANDLE_RETURN_ERROR(command_queue, CL_INVALID_COMMAND_QUEUE);
    return command_queue->dispatch->clEnqueueSVMMap(command_queue, blocking_map, flags, svm_ptr,
...
CL_API_ENTRY cl_int CL_API_CALL clEnqueueSVMUnmap(cl_command_queue command_queue, void* svm_ptr,
                                                  ...
                                                  cl_event* event) CL_API_SUFFIX__VERSION_2_0 {
#ifdef CL_TRACE
    CL_TRACE_CALL(clEnqueueSVMUnmap, 5, "cl_command_queue", command_queue, "void*", svm_ptr,
                  "cl_uint", num_events_in_wait_list, "const cl_event*", event_wait_list,
                  "cl_event*", event)
#endif
...
clCreateSamplerWithProperties(cl_context context, const cl_sampler_properties* sampler_properties,
                              cl_int* errcode_ret) CL_API_SUFFIX__VERSION_2_0 {
#ifdef CL_TRACE
    CL_TRACE_CALL(clCreateSamplerWithProperties, 3, "cl_context", context,
                  "const cl_sampler_properties*", sampler_properties, "cl_int*", errcode_ret)
#endif

    KHR_ICD_VALIDATE_HANDLE_RETURN_HANDLE(context, CL_INVALID_CONTEXT);
    return context->dispatch->clCreateSamplerWithProperties(context, sampler_properties,
                                                            errcode_ret);
}
...
#ifdef CL_TRACE
    CL_TRACE_CALL(clSetKernelArgSVMPointer, 3, "cl_kernel", kernel, "cl_uint", arg_index,
                  "const void*", arg_value)
#endif
...
#ifdef CL_TRACE
    CL_TRACE_CALL(clSetKernelExecInfo, 4, "cl_kernel", kernel, "cl_kernel_exec_info", param_name,
...
#ifdef CL_TRACE
    CL_TRACE_CALL(clGetKernelSubGroupInfoKHR, 8, "cl_kernel", in_kernel, "cl_device_id", in_device,
                  "cl_kernel_sub_group_info", param_name, "size_t", input_value_size, "const void*",
                  input_value, "size_t", param_value_size, "void*", param_value, "size_t*",
                  param_value_size_ret)
#endif
...
#ifdef CL_TRACE
    CL_TRACE_CALL(clSetDefaultDeviceCommandQueue, 3, "cl_context", context, "cl_device_id", device,
...
#ifdef CL_TRACE
    CL_TRACE_CALL(clCreateProgramWithIL, 4, "cl_context", context, "const void*", il, "size_t",
...
#ifdef CL_TRACE
    CL_TRACE_CALL(clGetKernelSubGroupInfo, 8, "cl_kernel", kernel, "cl_device_id", device,
                  "cl_kernel_sub_group_info", param_name, "size_t", input_value_size, "const void*",
                  input_value, "size_t", param_value_size, "void*", param_value, "size_t*",
                  param_value_size_ret)
#endif
...
#ifdef CL_TRACE
    CL_TRACE_CALL(clEnqueueSVMMigrateMem, 8, "cl_command_queue", command_queue, "cl_uint",
                  num_svm_pointers, "const void**", svm_pointers, "const size_t*", sizes,
                  "cl_mem_migration_flags", flags, "cl_uint", num_events_in_wait_list,
                  "const cl_event*", event_wait_list, "cl_event*", event)
#endif
...
#ifdef CL_TRACE
    CL_TRACE_CALL(clGetDeviceAndHostTimer, 3, "cl_device_id", device, "cl_ulong*", device_timestamp,
