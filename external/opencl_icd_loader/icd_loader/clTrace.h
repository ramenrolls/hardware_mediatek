...
#define CL_TRACE_CALL(_funcName, ...)                    \
    if (sCLTraceLevel) TraceCL(#_funcName, __VA_ARGS__); \
...
class CL_Systrace_Object : public RefBase {
  ...
  public:
    CL_Systrace_Object(const char* funcName, cl_bool sCLSystraceEnabled) {
        ...
        if (l_sCLSystraceEnabled) ATRACE_BEGIN(funcName);
    };

    ~CL_Systrace_Object() {
        if (l_sCLSystraceEnabled) ATRACE_END();
    };
};
...
void TraceCL(const char* name, int numArgs, ...) {
    ...
    for (int i = 0; i < numArgs; i++) {
        ...
        bool isPtr = false;
        if ((type[strlen(type) - 1] == '*') || (strcmp(type, "cl_platform_id") == 0) ||
            (strcmp(type, "cl_device_id") == 0) || (strcmp(type, "cl_context") == 0) ||
            (strcmp(type, "cl_command_queue") == 0) || (strcmp(type, "cl_program") == 0) ||
            (strcmp(type, "cl_mem") == 0) || (strcmp(type, "cl_kernel") == 0) ||
            (strcmp(type, "cl_event") == 0) || (strcmp(type, "cl_sampler") == 0) ||
        ...
        if (isPtr) {
            ...
            builder.append("(%s) 0x%08x", type, (size_t)arg);
        } else if ((strcmp(type, "cl_uint") == 0) || (strcmp(type, "cl_bool") == 0) ||
                   ...
                   (strcmp(type, "cl_mem_info") == 0) || (strcmp(type, "cl_image_info") == 0) ||
                   ...
                   (strcmp(type, "cl_event_info") == 0) || (strcmp(type, "cl_command_type") == 0) ||
                   (strcmp(type, "cl_profiling_info") == 0)) {
            uint32_t arg = va_arg(argp, uint32_t);
            builder.append("(%s) %" PRIu32, type, arg);
        } else if ((strcmp(type, "cl_ulong") == 0) || (strcmp(type, "cl_bitfield") == 0) ||
        ...
        } else if ((strcmp(type, "cl_int")) == 0 || (strcmp(type, "cl_build_status")) == 0) {
