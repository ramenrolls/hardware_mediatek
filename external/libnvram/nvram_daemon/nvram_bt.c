...
void* NVRAM_BT(void* arg) {
    ...
    NVRAM_LOG("FD %d rec_size %d rec_num %d\n", bt_nvram_fd.iFileDesc, rec_size, rec_num);
    ...
    if (rec_size != sizeof(ap_nvram_btradio_struct)) {
        NVRAM_LOG("Unexpected record size %d ap_nvram_btradio_struct %d", rec_size,
                  sizeof(ap_nvram_btradio_struct));
        NVM_CloseFileDesc(bt_nvram_fd);
        return NULL;
    }
    ...
    NVRAM_LOG(
            "Read NVRAM: [BDAddr %02x-%02x-%02x-%02x-%02x-%02x][Voice %02x %02x][Codec %02x %02x %02x %02x] \
            ...
            bt_nvram.addr[4], bt_nvram.addr[5], bt_nvram.Voice[0], bt_nvram.Voice[1],
            ...
            bt_nvram.Radio[4], bt_nvram.Radio[5], bt_nvram.Sleep[0], bt_nvram.Sleep[1],
            bt_nvram.Sleep[2], bt_nvram.Sleep[3], bt_nvram.Sleep[4], bt_nvram.Sleep[5],
            bt_nvram.Sleep[6], bt_nvram.BtFTR[0], bt_nvram.BtFTR[1], bt_nvram.TxPWOffset[0],
            bt_nvram.TxPWOffset[1], bt_nvram.TxPWOffset[2], bt_nvram.CoexAdjust[0],
            bt_nvram.CoexAdjust[1], bt_nvram.CoexAdjust[2], bt_nvram.CoexAdjust[3],
            bt_nvram.CoexAdjust[4], bt_nvram.CoexAdjust[5]);
