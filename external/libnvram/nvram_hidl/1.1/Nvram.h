...
struct Nvram : public INvram {
    ...
    Return<void> writeFileBylid(int32_t lid, uint16_t para, const hidl_vec<uint8_t>& data,
                                writeFileBylid_cb _hidl_cb) override;
    ...
    Return<bool> BackupData_Special(const hidl_vec<uint8_t>& data, uint32_t count,
