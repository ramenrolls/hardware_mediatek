...
const TCFG_FILE g_akCFG_File[] = {
        ...
        {"/mnt/vendor/nvdata/APCFG/APRDEB/BT_Addr", VER(AP_CFG_RDEB_FILE_BT_ADDR_LID),
         CFG_FILE_BT_ADDR_REC_SIZE, CFG_FILE_BT_ADDR_REC_TOTAL, DEFAULT_ZERO, 0, DataConvert,
         BT_ConvertFunc},
...
#endif
        {"/mnt/vendor/nvdata/APCFG/APRDCL/AUXADC", VER(AP_CFG_RDCL_FILE_AUXADC_LID),
         CFG_FILE_AUXADC_REC_SIZE, CFG_FILE_AUXADC_REC_TOTAL, SIGNLE_DEFUALT_REC,
         (char*)&stADCDefualt, DataReset, NULL},

        {"/mnt/vendor/nvdata/media/CAMERA_Para", VER(AP_CFG_RDCL_CAMERA_PARA_LID),
         CFG_FILE_CAMERA_PARA_REC_SIZE, CFG_FILE_CAMERA_PARA_REC_TOTAL, DEFAULT_ZERO, 0, DataReset,
         NULL},

        {"/mnt/vendor/nvdata/media/CAMERA_3A", VER(AP_CFG_RDCL_CAMERA_3A_LID),
         CFG_FILE_CAMERA_3A_REC_SIZE, CFG_FILE_CAMERA_3A_REC_TOTAL, DEFAULT_ZERO, 0, DataReset,
         NULL},

        {"/mnt/vendor/nvdata/media/CAMERA_SHADING", VER(AP_CFG_RDCL_CAMERA_SHADING_LID),
         CFG_FILE_CAMERA_SHADING_REC_SIZE, CFG_FILE_CAMERA_SHADING_REC_TOTAL, DEFAULT_ZERO, 0,
         DataReset, NULL},

        {"/mnt/vendor/nvdata/media/CAMERA_DEFECT", VER(AP_CFG_RDCL_CAMERA_DEFECT_LID),
         CFG_FILE_CAMERA_DEFECT_REC_SIZE, CFG_FILE_CAMERA_DEFECT_REC_TOTAL, DEFAULT_ZERO, 0,
         DataReset, NULL},

        {"/mnt/vendor/nvdata/media/CAMERA_SENSOR", VER(AP_CFG_RDCL_CAMERA_SENSOR_LID),
         CFG_FILE_CAMERA_SENSOR_REC_SIZE, CFG_FILE_CAMERA_SENSOR_REC_TOTAL, DEFAULT_ZERO, 0,
         DataReset, NULL},

        {"/mnt/vendor/nvdata/media/CAMERA_LENS", VER(AP_CFG_RDCL_CAMERA_LENS_LID),
         CFG_FILE_CAMERA_LENS_REC_SIZE, CFG_FILE_CAMERA_LENS_REC_TOTAL, DEFAULT_ZERO, 0, DataReset,
         NULL},

        {"/mnt/vendor/nvdata/APCFG/APRDCL/UART", VER(AP_CFG_RDCL_UART_LID),
         CFG_FILE_UART_CONFIG_SIZE, CFG_FILE_UART_CONFIG_TOTAL, SIGNLE_DEFUALT_REC,
         (char*)&stUARTConfigDefault, DataReset, NULL},

        {"/mnt/vendor/nvdata/APCFG/APRDCL/FACTORY", VER(AP_CFG_RDCL_FACTORY_LID),
         CFG_FILE_FACTORY_REC_SIZE, CFG_FILE_FACTORY_REC_TOTAL, DEFAULT_ZERO, 0, DataReset, NULL},

        {"/mnt/vendor/nvdata/APCFG/APRDCL/BWCS", VER(AP_CFG_RDCL_BWCS_LID),
         CFG_FILE_BWCS_CONFIG_SIZE, CFG_FILE_BWCS_CONFIG_TOTAL, SIGNLE_DEFUALT_REC,
         (char*)&stBWCSConfigDefault, DataReset, NULL},

        {"/mnt/vendor/nvdata/APCFG/APRDCL/HWMON_ACC", VER(AP_CFG_RDCL_HWMON_ACC_LID),
         CFG_FILE_HWMON_ACC_REC_SIZE, CFG_FILE_HWMON_ACC_REC_TOTAL, DEFAULT_ZERO, 0, DataReset,
         NULL},
        {"/mnt/vendor/nvdata/APCFG/APRDCL/HWMON_GYRO", VER(AP_CFG_RDCL_HWMON_GYRO_LID),
         CFG_FILE_HWMON_GYRO_REC_SIZE, CFG_FILE_HWMON_GYRO_REC_TOTAL, DEFAULT_ZERO, 0, DataReset,
         NULL},
#if 0
	{
...
#endif
        {"/mnt/vendor/nvdata/APCFG/APRDEB/OMADM_USB", VER(AP_CFG_RDEB_OMADM_USB_LID),
         CFG_FILE_OMADMUSB_REC_SIZE, CFG_FILE_OMADMUSB_REC_TOTAL, SIGNLE_DEFUALT_REC,
         (char*)&stOMADMUSBDefualt, DataReset, NULL},
        // { "/nvram/APCFG/APRDCL/ADDED",	VER(AP_CFG_RDCL_ADDED_LID),	CFG_FILE_added_CONFIG_SIZE,
        //	CFG_FILE_added_CONFIG_TOTAL,		    SIGNLE_DEFUALT_REC,				    (char
        //*)&stAddedDefault},
        {"/mnt/vendor/nvdata/media/Voice_Recognize_Param",
         VER(AP_CFG_RDCL_FILE_VOICE_RECOGNIZE_PARAM_LID), CFG_FILE_VOICE_RECOGNIZE_PAR_SIZE,
         CFG_FILE_VOICE_RECOGNIZE_PAR_TOTAL, SIGNLE_DEFUALT_REC,
         (char*)&Voice_Recognize_Par_default, DataReset, NULL},
        // Reserved ten item
        {"/mnt/vendor/nvdata/media/Audio_AudEnh_Control_Opt",
         VER(AP_CFG_RDCL_FILE_AUDIO_AUDENH_CONTROL_OPTION_PAR_LID),
         CFG_FILE_AUDIO_AUDENH_CONTROL_OPTION_PAR_SIZE,
         CFG_FILE_AUDIO_AUDENH_CONTROL_OPTION_PAR_TOTAL, SIGNLE_DEFUALT_REC,
         (char*)&AUDENH_Control_Option_Par_default, DataReset, NULL},
        {"/mnt/vendor/nvdata/media/Audio_VOIP_Param", VER(AP_CFG_RDCL_FILE_AUDIO_VOIP_PAR_LID),
         CFG_FILE_AUDIO_VOIP_PAR_SIZE, CFG_FILE_AUDIO_VOIP_PAR_TOTAL, SIGNLE_DEFUALT_REC,
         (char*)&Audio_VOIP_Par_default, DataReset, NULL},
        /*yucong add for PS calibration*/
        {"/mnt/vendor/nvdata/APCFG/APRDCL/HWMON_PS", VER(AP_CFG_RDCL_HWMON_PS_LID),
         CFG_FILE_HWMON_PS_REC_SIZE, CFG_FILE_HWMON_PS_REC_TOTAL, DEFAULT_ZERO, 0, DataReset, NULL},
        {"/mnt/vendor/nvdata/APCFG/APRDCL/MD_Type", VER(AP_CFG_FILE_MDTYPE_LID),
         CFG_FILE_MDTYPE_CONFIG_SIZE, CFG_FILE_MDTYPE_CONFIG_TOTAL, SIGNLE_DEFUALT_REC,
         (char*)&stMDTypeDefault, DataReset, NULL},
        {"/mnt/vendor/nvdata/APCFG/APRDCL/EXT_MD_Type", VER(AP_CFG_FILE_EXT_MDTYPE_LID),
         CFG_FILE_EXT_MDTYPE_CONFIG_SIZE, CFG_FILE_EXT_MDTYPE_CONFIG_TOTAL, SIGNLE_DEFUALT_REC,
         (char*)&stEXTMDTypeDefault, DataReset, NULL},
        {"/mnt/vendor/nvdata/APCFG/APRDCL/SDIO", VER(AP_CFG_RDCL_FILE_SDIO_LID),
         CFG_FILE_SDIO_CONFIG_SIZE, CFG_FILE_SDIO_CONFIG_TOTAL, SIGNLE_DEFUALT_REC,
         (char*)&stSDIOConfigDefault, DataReset, NULL},
        {"/mnt/vendor/nvdata/media/CAMERA_VERSION", VER(AP_CFG_RDCL_CAMERA_VERSION_LID),
         CFG_FILE_CAMERA_VERSION_REC_SIZE, CFG_FILE_CAMERA_VERSION_REC_TOTAL, DEFAULT_ZERO, 0,
         DataReset, NULL},

        {"/mnt/vendor/nvdata/media/CAMERA_FEATURE", VER(AP_CFG_RDCL_CAMERA_FEATURE_LID),
         CFG_FILE_CAMERA_FEATURE_REC_SIZE, CFG_FILE_CAMERA_FEATURE_REC_TOTAL, DEFAULT_ZERO, 0,
         DataReset, NULL},

        {"/mnt/vendor/nvdata/media/CAMERA_GEOMETRY", VER(AP_CFG_RDCL_CAMERA_GEOMETRY_LID),
         CFG_FILE_CAMERA_GEOMETRY_REC_SIZE, CFG_FILE_CAMERA_GEOMETRY_REC_TOTAL, DEFAULT_ZERO, 0,
         DataReset, NULL},

        {"/mnt/vendor/nvdata/APCFG/APRDCL/MD_SBP", VER(AP_CFG_RDCL_FILE_MD_SBP_LID),
         CFG_FILE_MD_SBP_CONFIG_SIZE, CFG_FILE_MD_SBP_CONFIG_TOTAL, SIGNLE_DEFUALT_REC,
         (char*)&stMDSBPConfigDefault, DataReset, NULL},

        // Reserved

        {"/mnt/vendor/nvdata/media/CAMERA_SHADING2", VER(AP_CFG_RDCL_CAMERA_SHADING_LID),
         CFG_FILE_CAMERA_SHADING_REC_SIZE, CFG_FILE_CAMERA_SHADING_REC_TOTAL, DEFAULT_ZERO, 0,
         DataReset, NULL},

        {"/mnt/vendor/nvdata/media/CAMERA_SHADING3", VER(AP_CFG_RDCL_CAMERA_SHADING_LID),
         CFG_FILE_CAMERA_SHADING_REC_SIZE, CFG_FILE_CAMERA_SHADING_REC_TOTAL, DEFAULT_ZERO, 0,
         DataReset, NULL},

        {"/mnt/vendor/nvdata/media/CAMERA_SHADING4", VER(AP_CFG_RDCL_CAMERA_SHADING_LID),
         CFG_FILE_CAMERA_SHADING_REC_SIZE, CFG_FILE_CAMERA_SHADING_REC_TOTAL, DEFAULT_ZERO, 0,
         DataReset, NULL},

        {"/mnt/vendor/nvdata/media/CAMERA_SHADING5", VER(AP_CFG_RDCL_CAMERA_SHADING_LID),
         CFG_FILE_CAMERA_SHADING_REC_SIZE, CFG_FILE_CAMERA_SHADING_REC_TOTAL, DEFAULT_ZERO, 0,
         DataReset, NULL},

        {"/mnt/vendor/nvdata/media/CAMERA_SHADING6", VER(AP_CFG_RDCL_CAMERA_SHADING_LID),
         CFG_FILE_CAMERA_SHADING_REC_SIZE, CFG_FILE_CAMERA_SHADING_REC_TOTAL, DEFAULT_ZERO, 0,
         DataReset, NULL},

        {"/mnt/vendor/nvdata/media/CAMERA_SHADING7", VER(AP_CFG_RDCL_CAMERA_SHADING_LID),
         CFG_FILE_CAMERA_SHADING_REC_SIZE, CFG_FILE_CAMERA_SHADING_REC_TOTAL, DEFAULT_ZERO, 0,
         DataReset, NULL},

        {"/mnt/vendor/nvdata/media/CAMERA_SHADING8", VER(AP_CFG_RDCL_CAMERA_SHADING_LID),
         CFG_FILE_CAMERA_SHADING_REC_SIZE, CFG_FILE_CAMERA_SHADING_REC_TOTAL, DEFAULT_ZERO, 0,
         DataReset, NULL},

        {"/mnt/vendor/nvdata/media/CAMERA_SHADING9", VER(AP_CFG_RDCL_CAMERA_SHADING_LID),
         CFG_FILE_CAMERA_SHADING_REC_SIZE, CFG_FILE_CAMERA_SHADING_REC_TOTAL, DEFAULT_ZERO, 0,
         DataReset, NULL},

        {"/mnt/vendor/nvdata/media/CAMERA_SHADING10", VER(AP_CFG_RDCL_CAMERA_SHADING_LID),
         CFG_FILE_CAMERA_SHADING_REC_SIZE, CFG_FILE_CAMERA_SHADING_REC_TOTAL, DEFAULT_ZERO, 0,
         DataReset, NULL},

        {"/mnt/vendor/nvdata/media/CAMERA_SHADING11", VER(AP_CFG_RDCL_CAMERA_SHADING_LID),
         CFG_FILE_CAMERA_SHADING_REC_SIZE, CFG_FILE_CAMERA_SHADING_REC_TOTAL, DEFAULT_ZERO, 0,
         DataReset, NULL},

        {"/mnt/vendor/nvdata/media/CAMERA_SHADING12", VER(AP_CFG_RDCL_CAMERA_SHADING_LID),
         CFG_FILE_CAMERA_SHADING_REC_SIZE, CFG_FILE_CAMERA_SHADING_REC_TOTAL, DEFAULT_ZERO, 0,
         DataReset, NULL},

        {"/mnt/vendor/nvdata/media/CAMERA_PLINE", VER(AP_CFG_RDCL_CAMERA_PLINE_LID),
         CFG_FILE_CAMERA_PLINE_REC_SIZE, CFG_FILE_CAMERA_PLINE_REC_TOTAL, DEFAULT_ZERO, 0,
         DataReset, NULL},

        {"/mnt/vendor/nvdata/media/CAMERA_PLINE2", VER(AP_CFG_RDCL_CAMERA_PLINE_LID),
         CFG_FILE_CAMERA_PLINE_REC_SIZE, CFG_FILE_CAMERA_PLINE_REC_TOTAL, DEFAULT_ZERO, 0,
         DataReset, NULL},

        {"/mnt/vendor/nvdata/media/CAMERA_PLINE3", VER(AP_CFG_RDCL_CAMERA_PLINE_LID),
         CFG_FILE_CAMERA_PLINE_REC_SIZE, CFG_FILE_CAMERA_PLINE_REC_TOTAL, DEFAULT_ZERO, 0,
         DataReset, NULL},

        {"/mnt/vendor/nvdata/media/CAMERA_PLINE4", VER(AP_CFG_RDCL_CAMERA_PLINE_LID),
         CFG_FILE_CAMERA_PLINE_REC_SIZE, CFG_FILE_CAMERA_PLINE_REC_TOTAL, DEFAULT_ZERO, 0,
         DataReset, NULL},

        {"/mnt/vendor/nvdata/media/CAMERA_PLINE5", VER(AP_CFG_RDCL_CAMERA_PLINE_LID),
         CFG_FILE_CAMERA_PLINE_REC_SIZE, CFG_FILE_CAMERA_PLINE_REC_TOTAL, DEFAULT_ZERO, 0,
         DataReset, NULL},

        {"/mnt/vendor/nvdata/media/CAMERA_PLINE6", VER(AP_CFG_RDCL_CAMERA_PLINE_LID),
         CFG_FILE_CAMERA_PLINE_REC_SIZE, CFG_FILE_CAMERA_PLINE_REC_TOTAL, DEFAULT_ZERO, 0,
         DataReset, NULL},

        {"/mnt/vendor/nvdata/media/CAMERA_PLINE7", VER(AP_CFG_RDCL_CAMERA_PLINE_LID),
         CFG_FILE_CAMERA_PLINE_REC_SIZE, CFG_FILE_CAMERA_PLINE_REC_TOTAL, DEFAULT_ZERO, 0,
         DataReset, NULL},

        {"/mnt/vendor/nvdata/media/CAMERA_PLINE8", VER(AP_CFG_RDCL_CAMERA_PLINE_LID),
         CFG_FILE_CAMERA_PLINE_REC_SIZE, CFG_FILE_CAMERA_PLINE_REC_TOTAL, DEFAULT_ZERO, 0,
         DataReset, NULL},

        {"/mnt/vendor/nvdata/media/CAMERA_PLINE9", VER(AP_CFG_RDCL_CAMERA_PLINE_LID),
         CFG_FILE_CAMERA_PLINE_REC_SIZE, CFG_FILE_CAMERA_PLINE_REC_TOTAL, DEFAULT_ZERO, 0,
         DataReset, NULL},

        {"/mnt/vendor/nvdata/media/CAMERA_PLINE10", VER(AP_CFG_RDCL_CAMERA_PLINE_LID),
         CFG_FILE_CAMERA_PLINE_REC_SIZE, CFG_FILE_CAMERA_PLINE_REC_TOTAL, DEFAULT_ZERO, 0,
         DataReset, NULL},

        {"/mnt/vendor/nvdata/media/CAMERA_PLINE11", VER(AP_CFG_RDCL_CAMERA_PLINE_LID),
         CFG_FILE_CAMERA_PLINE_REC_SIZE, CFG_FILE_CAMERA_PLINE_REC_TOTAL, DEFAULT_ZERO, 0,
         DataReset, NULL},

        {"/mnt/vendor/nvdata/media/CAMERA_PLINE12", VER(AP_CFG_RDCL_CAMERA_PLINE_LID),
         CFG_FILE_CAMERA_PLINE_REC_SIZE, CFG_FILE_CAMERA_PLINE_REC_TOTAL, DEFAULT_ZERO, 0,
         DataReset, NULL},

        {"/mnt/vendor/nvdata/media/CAMERA_AF", VER(AP_CFG_RDCL_CAMERA_AF_LID),
         CFG_FILE_CAMERA_AF_REC_SIZE, CFG_FILE_CAMERA_AF_REC_TOTAL, DEFAULT_ZERO, 0, DataReset,
         NULL},

        {"/mnt/vendor/nvdata/media/CAMERA_FLASH_CALIBRATION",
         VER(AP_CFG_RDCL_CAMERA_FLASH_CALIBRATION_LID), CFG_FILE_CAMERA_FLASH_CALIBRATION_REC_SIZE,
...
const unsigned int g_i4CFG_File_Protect_Count =
        sizeof(g_akCFG_File_Protect) / (sizeof(TCFG_FILE_PROTECT));
...
extern bool nvram_new_partition_support() { return true; }
...
#else
extern bool nvram_new_partition_support() { return false; }
...
extern bool nvram_emmc_support() { return true; }
#else
extern bool nvram_emmc_support() { return false; }
#endif

#ifdef MTK_UFS_SUPPORT
extern bool nvram_ufs_support() { return true; }
#else
extern bool nvram_ufs_support() { return false; }
#endif
...
extern bool nvram_md1_support() {
    ...
    if (property_get("ro.vendor.mtk_md1_support", prop_value, NULL)) {
        ...
        if (md1_support) is_support_md1 = true;
    } else {
...
extern bool nvram_md5_support() {
    ...
    if (property_get("ro.boot.opt_md5_support", prop_value, NULL)) {
        ...
        if (md5_support) is_support_md5 = true;
    } else {
...
extern bool nvram_evdo_support() {
    ...
    if (property_get("ro.vendor.mtk_md3_support", c2k_state_value, NULL)) {
        ...
        if (c2k_support) is_support_c2k = true;
...
extern bool nvram_ecci_c2k_support() {
    ...
    if (property_get("ro.vendor.mtk_eccci_c2k", prop_value, NULL)) {
        ...
        if (ecci_c2k_support) is_support_ecci_c2k = true;
    } else {
