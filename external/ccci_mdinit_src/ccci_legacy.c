...
static md_img_t md1_img_list[] = {
        {"modem_1_2g_n.img", modem_2g},   {"modem_1_3g_n.img", modem_3g},
        {"modem_1_wg_n.img", modem_wg},   {"modem_1_tg_n.img", modem_tg},
        {"modem_1_lwg_n.img", modem_lwg}, {"modem_1_ltg_n.img", modem_ltg},
};

static md_img_t md2_img_list[] = {
        {"modem_2_2g_n.img", modem_2g},   {"modem_2_3g_n.img", modem_3g},
        {"modem_2_wg_n.img", modem_wg},   {"modem_2_tg_n.img", modem_tg},
        {"modem_2_lwg_n.img", modem_lwg}, {"modem_2_ltg_n.img", modem_ltg},
};
...
int md_image_exist_check(int fd, int md_id) {
    ...
    while (md_img_index < scan_cnt) {
        ...
        snprintf(md_img_path, sizeof(md_img_path), "%s%s", md_img_folder,
                 md_img_list[md_img_index].file_name);
        snprintf(md_img_cip_path, sizeof(md_img_cip_path), "%s%s", md_img_cip_folder,
                 md_img_list[md_img_index].file_name);
    ...
    CCCI_LOGI("md_img_exist %d %d %d %d\n", md_img_exist[0], md_img_exist[1], md_img_exist[2],
              md_img_exist[3]);
