...
static int _gsensor_cali(int to_clear, int to_cali, int to_write, const char* period,
                         const char* count, const char* tolerance) {
    int fd = -1;
    int err = 0;
...
static int _gyroscope_cali(int to_clear, int to_cali, int to_write, const char* period,
                           const char* count, const char* tolerance, const char* trace) {
    int fd = -1;
    int err = 0;
    int i_period = (int)atoi(period);
    int i_count = (int)atoi(count);
...
int main(int argc, char** argv) {
    ...
    if (argc < 3 || argc > 8 || ((strcmp(argv[1], "-gs") != 0) && (strcmp(argv[1], "-gy") != 0))) {
    ...
    if ((argc == 8) && (0 == strcmp(argv[2], "-c")) && (0 == strcmp(argv[3], "-w"))) {
        if (0 == strcmp(argv[1], "-gs")) {
