...
static inline int mtk_wpas_hidl_register_interface(struct wpa_supplicant* wpa_s) { return 0; }
static inline int mtk_wpas_hidl_unregister_interface(struct wpa_supplicant* wpa_s) { return 0; }
static inline int mtk_wpas_hidl_register_network(struct wpa_supplicant* wpa_s,
                                                 struct wpa_ssid* ssid) {
    return 0;
}
static inline int mtk_wpas_hidl_unregister_network(struct wpa_supplicant* wpa_s,
                                                   struct wpa_ssid* ssid) {
    return 0;
}
...
static inline void mtk_wpas_hidl_notify_data_stall_reason(struct wpa_supplicant* wpa_s,
                                                          uint32_t reason) {}
