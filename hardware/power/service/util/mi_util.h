...
/*** MACROS ******************************************************************/
#define MI_NODEENTRY(ptr, type, member) ((type*)((U8*)(ptr) - (U8*)(&((type*)0)->member)))
...
U32 MI_DlInsert(tMI_DLIST*, tMI_DLNODE*, const void* (*)(const tMI_DLNODE*),
                S32 (*)(const void*, const void*));
void MI_DlWalk(const tMI_DLIST*, void (*)(tMI_DLNODE*, void*), void*);
tMI_DLNODE* MI_DlFind(const tMI_DLIST*, const void*, const void* (*)(const tMI_DLNODE*),
                      S32 (*)(const void*, const void*));
...
/** Hash Tables *************************************************************/
void MI_HInit(tMI_HASH*, U32, U32 (*)(const void*), S32 (*)(const void*, const void*),
              const void* (*)(const tMI_HNODE*), tMI_HNODE**);
