...
///
///////////////////////////////////////////////////////////////////////////////
U32 MI_DlInsert(tMI_DLIST* L, tMI_DLNODE* N, const void* (*keyof)(const tMI_DLNODE*),
...
///
///////////////////////////////////////////////////////////////////////////////
void MI_DlSort(tMI_DLIST* L, const void* (*keyof)(const tMI_DLNODE*),
               S32 (*compare)(const void*, const void*)) {
    if (L && keyof && compare) {
...
///
///////////////////////////////////////////////////////////////////////////////
void MI_HInit(tMI_HASH* pH, U32 nbuckets, U32 (*hash)(const void*),
              S32 (*compare)(const void*, const void*), const void* (*keyof)(const tMI_HNODE*),
              tMI_HNODE** table) {
    U32 i;
