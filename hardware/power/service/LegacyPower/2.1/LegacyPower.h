...
struct Power : public IPower {
    ...
    Return<void> mtkPowerHint(::vendor::mediatek::hardware::power::V2_0::MtkPowerHint hint,
                              int32_t data) override;
    ...
    Return<void> notifyAppState(const hidl_string& packName, const hidl_string& actName,
                                int32_t pid, MtkActState state) override;
    Return<void> notifyAppState_2_1(const hidl_string& packName, const hidl_string& actName,
                                    int32_t pid,
                                    ::vendor::mediatek::hardware::power::V2_0::MtkActState state,
                                    int32_t uid) override;
    Return<int32_t> querySysInfo(::vendor::mediatek::hardware::power::V2_0::MtkQueryCmd cmd,
                                 int32_t param) override;
    Return<int32_t> scnReg() override;
    Return<void> scnConfig(int32_t hdl, MtkPowerCmd_2_0 cmd, int32_t param1, int32_t param2,
                           int32_t param3, int32_t param4) override;
    Return<void> scnConfig_2_1(int32_t hdl, MtkPowerCmd_2_1 cmd, int32_t param1, int32_t param2,
                               int32_t param3, int32_t param4) override;
    ...
    Return<void> scnUltraCfg(int32_t hdl, int32_t ultracmd, int32_t param1, int32_t param2,
                             int32_t param3, int32_t param4) override;
