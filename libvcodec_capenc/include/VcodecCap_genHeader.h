...
typedef enum __VENC_DRV_H264_VIDEO_PROFILE_T {
    ...
    VENC_DRV_H264_VIDEO_PROFILE_HIGH444_PREDICTIVE =
            (1 << 12), /* /< High 444 Predictive (Amendment 2) */
    VENC_DRV_H264_VIDEO_PROFILE_SCALABLE_BASELINE =
            (1 << 13),                                     /* /< Scalable Baseline (Amendment 3) */
    VENC_DRV_H264_VIDEO_PROFILE_SCALABLE_HIGH = (1 << 14), /* /< Scalable High (Amendment 3) */
    VENC_DRV_H264_VIDEO_PROFILE_SCALABLE_HIGH_INTRA =
            (1 << 15), /* /< Scalable High Intra (Amendment 3) */
    VENC_DRV_H264_VIDEO_PROFILE_MULTIVIEW_HIGH =
...
typedef enum __VENC_DRV_HEVC_VIDEO_PROFILE_T {
    ...
    VENC_DRV_HEVC_VIDEO_PROFILE_HIGH444_PREDICTIVE =
            (1 << 12), /* /< High 444 Predictive (Amendment 2) */
    VENC_DRV_HEVC_VIDEO_PROFILE_SCALABLE_BASELINE =
            (1 << 13),                                     /* /< Scalable Baseline (Amendment 3) */
    VENC_DRV_HEVC_VIDEO_PROFILE_SCALABLE_HIGH = (1 << 14), /* /< Scalable High (Amendment 3) */
    VENC_DRV_HEVC_VIDEO_PROFILE_SCALABLE_HIGH_INTRA =
            (1 << 15), /* /< Scalable High Intra (Amendment 3) */
    VENC_DRV_HEVC_VIDEO_PROFILE_MULTIVIEW_HIGH =
            (1 << 16),                           /* /< Multiview High (Corrigendum 1 (2009)) */
 ...
 * @par Description
 *   This is timestamp information and used as items for VENC_DRV_PARAM_FRM_BUF_T and
...
VAL_VOID_T enc_putbits(VAL_UINT8_T* in, VAL_INT32_T* bitcnt, VAL_INT32_T data,
                       VAL_INT32_T data_length);
...
VAL_UINT32_T H264_GetVencDpbSize(VAL_UINT32_T u4H264Level, VAL_UINT32_T u4ImageWidthInPels,
                                 VAL_UINT32_T u4ImageHeightInPels);
VAL_BOOL_T H264_EncodeSPS_SW(VENC_DRV_H264_VIDEO_PROFILE_T eProfile, VENC_DRV_VIDEO_LEVEL_T eLevel,
                             VAL_UINT32_T width, VAL_UINT32_T height, VAL_UINT32_T prefer_WH_ratio,
                             VENC_DRV_PARAM_BS_BUF_T* headerBitStreamBuf, int32_t* headerSize);
VAL_BOOL_T H264_EncodePPS_SW(VENC_DRV_H264_VIDEO_PROFILE_T eProfile,
                             VENC_DRV_PARAM_BS_BUF_T* headerBitStreamBuf, int32_t* headerSize);
VAL_BOOL_T H264_EncodeSPS_SW_VUI(VAL_UINT32_T width, VAL_UINT32_T height,
                                 VAL_UINT32_T prefer_WH_ratio, VAL_UINT8_T* pucBSAddrVA,
                                 VAL_INT32_T* pBitcnt);
VAL_BOOL_T H264_EncodeSPS_SW_Crop(VAL_UINT32_T width, VAL_UINT32_T height,
                                  VAL_UINT32_T prefer_WH_ratio, VAL_UINT8_T* pucBSAddrVA,
                                  VAL_INT32_T* pBitcnt);

VAL_UINT32_T HEVC_GetGeneralLevel_idc(VAL_UINT32_T u4Level);
VAL_BOOL_T HEVC_EncodeSPS_SW(VENC_DRV_VIDEO_LEVEL_T eLevel, VAL_UINT32_T width, VAL_UINT32_T height,
                             VAL_UINT32_T prefer_WH_ratio,
                             VENC_DRV_PARAM_BS_BUF_T* headerBitStreamBuf, int32_t* headerSize);
VAL_BOOL_T HEVC_EncodePPS_SW(VENC_DRV_PARAM_BS_BUF_T* headerBitStreamBuf, int32_t* headerSize);
VAL_BOOL_T HEVC_EncodeVPS_SW(VENC_DRV_VIDEO_LEVEL_T eLevel,
                             VENC_DRV_PARAM_BS_BUF_T* headerBitStreamBuf, int32_t* headerSize);
