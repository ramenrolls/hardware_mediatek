        ...
        case kWhatSinkNotify: {
            ...
            switch (reason) {
                ...
                case Sink::kWhatResolutionNotify: {
                    ...
                    VT_LOGD("[ID=%d]kWhatResolutionNotify direct to VTS %d/%d/%d", mMultiInstanceID,
                            width, height, degree);
...
status_t ImsMediaReceiver::SetSinkConfig(video_codec_fmtp_t* video_codec_param) {
    ...
    if (video_codec_param->format == VIDEO_H264) {
        ...
        memcpy((char*)sprop_parameter_sets, (char*)(h264_decoder_param->sprop_parameter_sets),
        ...
        sp<ABuffer> csdEnc = MakeAVCCodecSpecificData(sprop_parameter_sets, &profile, &level,
        ...
        int32_t offset = 0;
        memcpy((char*)(sprop_vps_sps_pps + offset), (char*)(hevc_decoder_param->sprop_vps),
               sprop_vps_size);
        offset += sprop_vps_size;
        sprop_vps_sps_pps[offset] = ',';
        offset += 1;

        memcpy((char*)(sprop_vps_sps_pps + offset), (char*)(hevc_decoder_param->sprop_sps),
               sprop_sps_size);
        offset += sprop_sps_size;
        sprop_vps_sps_pps[offset] = ',';
        offset += 1;

        memcpy((char*)(sprop_vps_sps_pps + offset), (char*)(hevc_decoder_param->sprop_pps),
               sprop_pps_size);
