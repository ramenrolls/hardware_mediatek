...
typedef enum vt_srv_imcb_session_modify_result_e {
    ...
    VT_SRV_IMCB_SESSION_MODIFY_LocalRel, /*local release:Ex.SRVCC,Hungup,call refresh timer
                                            timeout,no rpt packets*/
...
enum vt_srv_imcb_session_modify_cancel_result_e {
    ...
    VT_SRV_IMCB_SESSION_MODIFY_CANCEL_fail_remote_reject, /*remote reject the upgrade while local
                                                             cancel*/
...
typedef struct rtcp_fb_param_type_s {
    ...
    imcf_int8 rtcp_fb_sub_param[VT_MAX_SUB_SDP_PARAMETER_SET_LENGTH];  // such as smaxpr=120 of
                                                                       // tmmbr
...
typedef struct vt_srv_imcb_msg_vt_cap_setting_s {
     ...
     */
} vt_srv_imcb_msg_get_cap_rsp_struct, imsvt_imcb_get_cap_rsp_struct, vt_srv_vt_cap_setting_t;
...
typedef struct vt_srv_imcb_msg_config_s {
    ...
    imcf_uint32 max_dpb;             ///< reserved. VT service provides default value
    imcf_uint32 max_br;              ///< reserved. VT service provides default value
    imcf_uint32 max_rcmd_nalu_size;  ///< reserved. VT service provides default value, 0: SDP will
                                     ///< not present the value

    imcf_uint8 sar_understood;  ///< 0~255, reserved. VT service provides default value, 0: SDP will
                                ///< not present the value
    imcf_uint8 sar_supported;   ///< 0~255, reserved. VT service provides default value, 0: SDP will
                                ///< not present the value
...
*/
vt_srv_imcb_msg_session_modify_req_struct,
        imsvt_imcb_modify_session_req_struct, vt_srv_imcb_msg_session_modify_ind_struct,
        imsvt_imcb_modify_session_ind_struct, vt_srv_imcb_msg_session_modify_rsp_struct,
        imsvt_imcb_modify_session_rsp_struct, vt_srv_imcb_msg_session_modify_cnf_struct,
        imsvt_imcb_modify_session_cnf_struct;
...
typedef struct vt_srv_imcb_msg_session_modify_cancel_s {
    ...
    imcf_uint8 pad[2];
        ...
        vt_srv_imcb_msg_session_modify_local_bw_ready_ind_struct,
        imsvt_imcb_modify_session_local_bw_ready_ind_struct;
