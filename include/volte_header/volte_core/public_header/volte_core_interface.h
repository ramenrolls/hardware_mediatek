...
#define VOLTE_MAX_SDP_PARAMETER_SET_LENGTH \
    (256)  // H.264, Spros parameter sets, must align with LTE_VT_SRV_UA_PARAMETER_SIZE_MAX.
#define VOLTE_MAX_RTP_ADDRESS_LENGTH (64)  // shall be align to SDP c attribute
#define VOLTE_MAX_SDP_FMTP_SUB_VALUE_LENGTH \
    (16)  // The maximum length of a fmtp specific parameter value
#define VOLTE_MAX_SDP_FMTP_SUB_VALUE_LENGTH_IN \
    (32)  // The maximum length of a fmtp specific parameter value internal
#define VOLTE_MAX_SDP_FMTP_TOT_VALUE_LENGTH \
    (32)  // The maximum length of total fmtp specific parameter key and value, must align with
          // LTE_VT_SRV_UA_FMTP_SIZE_MAX.
...
enum VoLTE_Event_e {
    ...
    // VOLTE_REQ_GET_ACCOUNT_INFO              = VOLTE_EVENT_FROM_UAS_START_CODE + 1, /*
    // VoLTE_Event_Account_Item_t */

    /* ------------------------------------------------ */
    /*  VoLTE UAs <-- VoLTE Service                     */
    /* ------------------------------------------------ */
    VOLTE_EVENT_TO_UAS_START_CODE = 40000,
    // VOLTE_RSP_GET_ACCOUNT_INFO              = VOLTE_EVENT_TO_UAS_START_CODE + 1, /*
    // VoLTE_Event_Account_Info_t */
    ...
    VOLTE_REQ_TIMER_CREATE_FAILED =
            VOLTE_EVENT_SERVICE_INTERNAL_TIMER + 1,                   /* VoLTE_Event_Timer_t */
    ...
    VOLTE_REQ_SIPTX_CONNECT =
            VOLTE_EVENT_TO_SIPTX_START_CODE + 3, /* VoLTE_Stack_Connection_Info_t */
    ...
    VOLTE_REQ_SIPTX_AUTO_TESTING_ID_UPDATE =
            VOLTE_EVENT_TO_SIPTX_START_CODE + 8, /* VoLTE_AutoTesting_Info_t */
    VOLTE_REQ_SIPTX_ABORT_SIPMSG = VOLTE_EVENT_TO_SIPTX_START_CODE + 9, /* VoLTE_Stack_Sip_Info_t */
    VOLTE_REQ_SIPTX_RESET_TCP =
            VOLTE_EVENT_TO_SIPTX_START_CODE + 10, /* VoLTE_Stack_Channel_Info_t */
    VOLTE_REQ_SIPTX_START_KEEP_ALIVE =
            VOLTE_EVENT_TO_SIPTX_START_CODE + 11, /* VoLTE_Stack_Channel_Info_t */
    VOLTE_REQ_SIPTX_STOP_KEEP_ALIVE =
            VOLTE_EVENT_TO_SIPTX_START_CODE + 12, /* VoLTE_Stack_Channel_Info_t */
    VOLTE_IND_SIPTX_CALL_SESSION_TERMINATED =
            VOLTE_EVENT_TO_SIPTX_START_CODE + 13,                    /* VoLTE_Stack_Sip_Info_t */
    ...
    VOLTE_REQ_SIPTX_REG_REREG =
            VOLTE_EVENT_TO_SIPTX_REG_START_CODE + 2, /* VoLTE_Event_Reg_Item_t */
    VOLTE_REQ_SIPTX_REG_DEREG =
            VOLTE_EVENT_TO_SIPTX_REG_START_CODE + 3, /* VoLTE_Event_Reg_Item_t */
    VOLTE_REQ_SIPTX_REG_NETWORK_CHANGE =
            VOLTE_EVENT_TO_SIPTX_REG_START_CODE + 11, /* VoLTE_Event_Network_Change_t */
    VOLTE_REQ_SIPTX_REG_UPDATE_SETTING =
            VOLTE_EVENT_TO_SIPTX_REG_START_CODE + 12, /* VoLTE_Event_Setting_t */
    VOLTE_REQ_SIPTX_REG_ADD_BIND =
            VOLTE_EVENT_TO_SIPTX_REG_START_CODE + 13, /* VoLTE_Event_Reg_Item_t */
    VOLTE_REQ_SIPTX_REG_DEL_BIND =
            VOLTE_EVENT_TO_SIPTX_REG_START_CODE + 14, /* VoLTE_Event_Reg_Item_t */
    VOLTE_REQ_SIPTX_REG_CLEAR_BIND = VOLTE_EVENT_TO_SIPTX_REG_START_CODE + 15, /* N/A */
    VOLTE_REQ_SIPTX_REG_ADD_CAPABILITY =
            VOLTE_EVENT_TO_SIPTX_REG_START_CODE + 16, /* VoLTE_Event_Reg_Capability_t */
    VOLTE_REQ_SIPTX_REG_DEL_CAPABILITY =
            VOLTE_EVENT_TO_SIPTX_REG_START_CODE + 17, /* VoLTE_Event_Reg_Capability_t */
    VOLTE_REQ_SIPTX_REG_GET_STATE =
            VOLTE_EVENT_TO_SIPTX_REG_START_CODE + 18, /* VoLTE_Event_Reg_Item_t */
    VOLTE_REQ_SIPTX_REG_RESET =
            VOLTE_EVENT_TO_SIPTX_REG_START_CODE + 19, /* VoLTE_Event_Reg_Item_t */
    VOLTE_CNF_SIPTX_REG_AUTH_REQ =
            VOLTE_EVENT_TO_SIPTX_REG_START_CODE + 20, /* VoLTE_Event_Reg_Auth_Resp_t */
    VOLTE_CNF_SIPTX_REG_TIMER_EXPIRY =
            VOLTE_EVENT_TO_SIPTX_REG_START_CODE + 21, /* VoLTE_Event_Timer_t */
    VOLTE_REQ_SIPTX_REG_RAT_CHANGE =
            VOLTE_EVENT_TO_SIPTX_REG_START_CODE + 22, /* VoLTE_Event_Rat_Change_t */
    VOLTE_REQ_SIPTX_REG_RESTORE =
            VOLTE_EVENT_TO_SIPTX_REG_START_CODE + 23, /* VoLTE_Event_Reg_Item_t */
    VOLTE_REQ_SIPTX_REG_3GPP_RAT_CHANGE =
            VOLTE_EVENT_TO_SIPTX_REG_START_CODE + 24, /* VoLTE_Event_3gpp_Rat_Change_t */
    VOLTE_CNF_SIPTX_REG_QUERY_CALL_STATE =
            VOLTE_EVENT_TO_SIPTX_REG_START_CODE + 25, /* VoLTE_Event_List_Current_Call_t */
    VOLTE_REQ_SIPTX_REG_MD_LOWER_LAYER_ERR =
            VOLTE_EVENT_TO_SIPTX_REG_START_CODE + 26, /* VoLTE_Event_MD_Lower_Layer_Err_t */
    VOLTE_REQ_SIPTX_REG_SEND_SUBSRIBE =
            VOLTE_EVENT_TO_SIPTX_REG_START_CODE + 27, /* VoLTE_Event_Reg_Item_t */
    VOLTE_REQ_SIPTX_REG_IP_CHANGE_NOTIFY =
            VOLTE_EVENT_TO_SIPTX_REG_START_CODE + 28, /* VoLTE_Event_IP_Change_Notify_t */
    VOLTE_REQ_SIPTX_REG_QUERY_IF_EM_TS_EXIST = VOLTE_EVENT_TO_SIPTX_REG_START_CODE + 29,
    VOLTE_CNF_SIPTX_GEOLOCATION_REQ =
            VOLTE_EVENT_TO_SIPTX_REG_START_CODE + 30, /* VoLTE_Event_Geolocation_Info_t */
    VOLTE_REQ_SIPTX_REG_NOTIFY_IMSVOPS =
            VOLTE_EVENT_TO_SIPTX_REG_START_CODE + 31, /* VoLTE_Event_Notify_t  */
    VOLTE_REQ_SIPTX_REG_NOTIFY_SIP_BLOCK =
            VOLTE_EVENT_TO_SIPTX_REG_START_CODE + 32, /* VoLTE_Event_Notify_t  */
    VOLTE_CNF_SIPTX_PRESENCE_UNPUBLISH =
            VOLTE_EVENT_TO_SIPTX_REG_START_CODE + 33, /* VoLTE_Event_Notify_t  */
    ...
    VOLTE_REQ_SIPTX_IPSEC_SETUP =
            VOLTE_EVENT_TO_SIPTX_IPSEC_START_CODE + 1, /* VoLTE_Stack_IPSec_Info_t */
    VOLTE_REQ_SIPTX_IPSEC_CONNECT =
            VOLTE_EVENT_TO_SIPTX_IPSEC_START_CODE + 2, /* VoLTE_Stack_IPSec_Info_t */
    VOLTE_REQ_SIPTX_IPSEC_DELETE =
            VOLTE_EVENT_TO_SIPTX_IPSEC_START_CODE + 3, /* VoLTE_Stack_IPSec_Info_t */
    VOLTE_REQ_SIPTX_IPSEC_CLEAR =
            VOLTE_EVENT_TO_SIPTX_IPSEC_START_CODE + 4, /* VoLTE_Stack_IPSec_Info_t */
    VOLTE_REQ_SIPTX_IPSEC_CHANGE_TO_REGULAR = VOLTE_EVENT_TO_SIPTX_IPSEC_START_CODE + 5,
    VOLTE_REQ_SIPTX_IPSEC_REFRESH =
            VOLTE_EVENT_TO_SIPTX_IPSEC_START_CODE + 6, /* VoLTE_Stack_IPSec_Info_t */
    ...
    VOLTE_RSP_SIPTX_START_KEEP_ALIVE =
            VOLTE_EVENT_FROM_SIPTX_START_CODE + 9, /* VoLTE_Stack_Channel_Info_t */
    VOLTE_RSP_SIPTX_STOP_KEEP_ALIVE =
            VOLTE_EVENT_FROM_SIPTX_START_CODE + 10, /* VoLTE_Stack_Channel_Info_t */
    ...
    VOLTE_IND_SIPTX_REG_STATE =
            VOLTE_EVENT_FROM_SIPTX_REG_START_CODE + 1, /* VoLTE_Event_Reg_State_t */
    VOLTE_IND_SIPTX_REG_AUTH_REQ =
            VOLTE_EVENT_FROM_SIPTX_REG_START_CODE + 2, /* VoLTE_Event_Reg_Auth_Req_t */
    VOLTE_IND_SIPTX_USE_PROXY =
            VOLTE_EVENT_FROM_SIPTX_REG_START_CODE + 3, /* VoLTE_Event_Reg_Item_t */
    VOLTE_IND_SIPTX_REG_QUERY_STATE =
            VOLTE_EVENT_FROM_SIPTX_REG_START_CODE + 4, /* VoLTE_Event_Query_State_t */
    VOLTE_IND_SIPTX_REG_TIMER_START =
            VOLTE_EVENT_FROM_SIPTX_REG_START_CODE + 5, /* VoLTE_Event_Timer_t */
    VOLTE_IND_SIPTX_REG_TIMER_CANCEL =
            VOLTE_EVENT_FROM_SIPTX_REG_START_CODE + 6, /* VoLTE_Event_Timer_t */
    VOLTE_IND_SIPTX_EMS_MODE =
            VOLTE_EVENT_FROM_SIPTX_REG_START_CODE + 7, /* VoLTE_Event_Reg_Ems_Mode_t */
    VOLTE_IND_SIPTX_REG_NOTIFY_DONE =
            VOLTE_EVENT_FROM_SIPTX_REG_START_CODE + 8, /* VoLTE_Event_Reg_Notify_Done_t */
    VOLTE_IND_SIPTX_GEOLOCATION_REQ =
            VOLTE_EVENT_FROM_SIPTX_REG_START_CODE + 9, /* VoLTE_Event_Geolocation_Info_t */
    VOLTE_IND_SIPTX_REG_CANCEL_SIP_BLOCK =
            VOLTE_EVENT_FROM_SIPTX_REG_START_CODE + 10, /* VoLTE_Event_Notify_t */
    ...
    VOLTE_RSP_SIPTX_IPSEC_SETUP =
            VOLTE_EVENT_FROM_SIPTX_IPSEC_START_CODE + 1, /* VoLTE_Stack_Result_t */
    VOLTE_RSP_SIPTX_IPSEC_CONNECT =
            VOLTE_EVENT_FROM_SIPTX_IPSEC_START_CODE + 2, /* VoLTE_Stack_Result_t */
    VOLTE_RSP_SIPTX_IPSEC_DELETE =
            VOLTE_EVENT_FROM_SIPTX_IPSEC_START_CODE + 3, /* VoLTE_Stack_Result_t */
    VOLTE_RSP_SIPTX_IPSEC_CLEAR =
            VOLTE_EVENT_FROM_SIPTX_IPSEC_START_CODE + 4, /* VoLTE_Stack_Result_t */
    VOLTE_RSP_SIPTX_IPSEC_CHANGE_TO_REGULAR = VOLTE_EVENT_FROM_SIPTX_IPSEC_START_CODE + 5,
    VOLTE_RSP_SIPTX_IPSEC_REFRESH =
            VOLTE_EVENT_FROM_SIPTX_IPSEC_START_CODE + 6, /* VoLTE_Stack_Result_t */
    ...
    VOLTE_IND_IPSEC_POLICY_ADD =
            VOLTE_EVENT_IPSEC_POLICY_START_CODE + 2, /* VoLTE_Event_IPSec_Policy_Add_Ind_t */
    VOLTE_IND_IPSEC_POLICY_DELETE =
            VOLTE_EVENT_IPSEC_POLICY_START_CODE + 3, /* VoLTE_Event_IPSec_Policy_Delete_Ind_t */
    /* ------------------------------------------------ */
    /*  VoLTE IMC (External)                            */
    /* ------------------------------------------------ */
...
typedef struct _VoLTE_Event_Reg_State_ {
    ...
    INT8 reg_timestamp[VOLTE_MAX_TIMESTAMP_LENGTH];         ///< TMO P-Last-Access-Network-Info
                                                            ///< "REGISTRATION TIMESTAMP"
    INT8 security_verify[VOLTE_MAX_SECURIT_VERIFY_LENGTH];  ///< security verify header in All the
    ...
    UINT8 em_reg_timestamp[VOLTE_MAX_TIME_STAMP_LENGTH];  ///< last registered timestamp in
                                                          ///< milliseconds
    ...
    */
    ...
    INT8 pani[VOLTE_MAX_P_ACCESS_NETWORK_INFO_LENGTH];  ///< P-Acess-Network-Info header for RCS
                                                        ///< usage
    INT8 digit_pidentifier[VOLTE_MAX_DIGIT_PIDENTIFIER_LENGTH];  // 3.6.8.1 Also include following:
                                                                 // (Mandatory) ID:
                                                                 // GID-MTRREQ-302326
...
extern void* (*_volte_sip_stack_create)(VoLTE_Stack_Channel_Info_t*, VoLTE_Stack_Ua_Capability_t*,
                                        VoLTE_Stack_Callback_t*, char*, int);
