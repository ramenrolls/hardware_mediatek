...
#ifdef MTK_USE_HIDL
{RIL_UNSOL_RESPONSE_PS_NETWORK_STATE_CHANGED, mtkRadioEx::responsePsNetworkStateChangeInd,
 WAKE_PARTIAL},
        /// M: eMBMS feature
        ...
        /// M: eMBMS end
        {RIL_UNSOL_RESPONSE_CS_NETWORK_STATE_CHANGED, mtkRadioEx::responseCsNetworkStateChangeInd,
         WAKE_PARTIAL},
        ...
        {RIL_UNSOL_RESPONSE_REGISTRATION_SUSPENDED, mtkRadioEx::registrationSuspendedIndication,
         WAKE_PARTIAL},
        ...
        {RIL_UNSOL_SIGNAL_STRENGTH_WITH_WCDMA_ECIO,
         mtkRadioEx::currentSignalStrengthWithWcdmaEcioInd, DONT_WAKE},
        // / M: BIP {
        ...
        {RIL_UNSOL_LTE_ACCESS_STRATUM_STATE_CHANGE, mtkRadioEx::onLteAccessStratumStateChanged,
         WAKE_PARTIAL},
        // M: [LTE][Low Power][UL traffic shaping] @}
        ...
        {RIL_UNSOL_SIP_CALL_PROGRESS_INDICATOR, mtkRadioEx::sipCallProgressIndicatorInd,
         WAKE_PARTIAL},
        {RIL_UNSOL_CALLMOD_CHANGE_INDICATOR, mtkRadioEx::callmodChangeIndicatorInd, WAKE_PARTIAL},
        {RIL_UNSOL_VIDEO_CAPABILITY_INDICATOR, mtkRadioEx::videoCapabilityIndicatorInd,
         WAKE_PARTIAL},
        ...
        {RIL_UNSOL_IMS_EVENT_PACKAGE_INDICATION, mtkRadioEx::imsEventPackageIndicationInd,
         WAKE_PARTIAL},
        ...
        {RIL_UNSOL_IMS_CONFIG_DYNAMIC_IMS_SWITCH_COMPLETE,
         mtkRadioEx::imsCfgDynamicImsSwitchCompleteInd, WAKE_PARTIAL},
        ...
        /// Ims Data Framework
        {RIL_UNSOL_DEDICATE_BEARER_ACTIVATED, mtkRadioEx::dedicatedBearerActivationInd,
         WAKE_PARTIAL},
        {RIL_UNSOL_DEDICATE_BEARER_MODIFIED, mtkRadioEx::dedicatedBearerModificationInd,
         WAKE_PARTIAL},
        {RIL_UNSOL_DEDICATE_BEARER_DEACTIVATED, mtkRadioEx::dedicatedBearerDeactivationInd,
         WAKE_PARTIAL},
        /// @}
        ...
        {RIL_UNSOL_WIFI_RSSI_MONITORING_CONFIG, mtkRadioEx::onWifiMonitoringThreshouldChanged,
         WAKE_PARTIAL},
        ...
        {RIL_UNSOL_REDIAL_EMERGENCY_INDICATION, mtkRadioEx::redialEmergencyIndication,
         WAKE_PARTIAL},
        {RIL_UNSOL_EMERGENCY_BEARER_SUPPORT_NOTIFY, mtkRadioEx::emergencyBearerInfoInd,
         WAKE_PARTIAL},
        ...
        {RIL_UNSOL_PHYSICAL_CHANNEL_CONFIGS_MTK, radio::currentPhysicalChannelConfigs,
         WAKE_PARTIAL},
        {RIL_UNSOL_LINK_CAPACITY_ESTIMATE, radio::currentLinkCapacityEstimate, WAKE_PARTIAL},

        {RIL_UNSOL_IMS_CONFERENCE_INFO_INDICATION, mtkRadioEx::onImsConferenceInfoIndication,
         WAKE_PARTIAL},
        {RIL_UNSOL_LTE_MESSAGE_WAITING_INDICATION, mtkRadioEx::onLteMessageWaitingIndication,
         WAKE_PARTIAL},
        ...
        {RIL_UNSOL_RESPONSE_NEW_SMS_STATUS_REPORT_EX, mtkRadioEx::newSmsStatusReportIndEx,
         WAKE_PARTIAL},
        ...
        {RIL_UNSOL_SIM_SLOT_LOCK_POLICY_NOTIFY, mtkRadioEx::smlSlotLockInfoChangedInd,
         WAKE_PARTIAL},
        // MTK-END
        ...
        {RIL_UNSOL_NO_EMERGENCY_CALLBACK_MODE, mtkRadioEx::noEmergencyCallbackModeInd,
         WAKE_PARTIAL},
        ...
        {RIL_UNSOL_RTT_MODIFY_REQUEST_RECEIVE, mtkRadioEx::rttModifyRequestReceiveInd,
         WAKE_PARTIAL},
        ...
        {RIL_UNSOL_QUALIFIED_NETWORK_TYPES_CHANGED, mtkRadioEx::qualifiedNetworkTypesChangedInd,
         WAKE_PARTIAL},
        {RIL_UNSOL_EIREG_INFO_IND, mtkRadioEx::eiregDataInd, WAKE_PARTIAL},
        // MUSE WFC requirement start
        {RIL_UNSOL_IWLAN_CELLULAR_QUALITY_CHANGED_IND, mtkRadioEx::onCellularQualityChangedInd,
         WAKE_PARTIAL},
