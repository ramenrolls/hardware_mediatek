...
{RIL_REQUEST_SIM_GET_ATR, mtkRadioEx::getATRResponse},
        ...
        {RIL_REQUEST_SET_NETWORK_SELECTION_MANUAL_WITH_ACT,
         mtkRadioEx::setNetworkSelectionModeManualWithActResponse},
        {RIL_REQUEST_QUERY_AVAILABLE_NETWORKS_WITH_ACT,
         mtkRadioEx::getAvailableNetworksWithActResponse},
        ...
        {RIL_REQUEST_SIGNAL_STRENGTH_WITH_WCDMA_ECIO,
         mtkRadioEx::getSignalStrengthWithWcdmaEcioResponse},
        // ATCI
        ...
        {RIL_REQUEST_HANGUP_ALL,
         mtkRadioEx::hangupAllResponse},  /// M: CC: Proprietary call control hangup all ([IMS]
                                          /// common flow)
        ...
        {RIL_REQUEST_ECC_PREFERRED_RAT,
         mtkRadioEx::eccPreferredRatResponse},  /// M: CC: CtVolte/Vzw E911
        ...
        {RIL_REQUEST_STK_HANDLE_CALL_SETUP_REQUESTED_FROM_SIM_WITH_RESULT_CODE,
         mtkRadioEx::handleStkCallSetupRequestFromSimWithResCodeResponse},
        // SS
        ...
        {RIL_REQUEST_QUERY_CALL_FORWARD_IN_TIME_SLOT,
         mtkRadioEx::queryCallForwardInTimeSlotStatusResponse},
        ...
        {RIL_REQUEST_QUERY_FEMTOCELL_SYSTEM_SELECTION_MODE,
         mtkRadioEx::queryFemtoCellSystemSelectionModeResponse},
        {RIL_REQUEST_SET_FEMTOCELL_SYSTEM_SELECTION_MODE,
         mtkRadioEx::setFemtoCellSystemSelectionModeResponse},
        // Data
        ...
        {RIL_REQUEST_SET_REMOVE_RESTRICT_EUTRAN_MODE,
         mtkRadioEx::setRemoveRestrictEutranModeResponse},
        ...
        {RIL_REQUEST_ADD_IMS_CONFERENCE_CALL_MEMBER,
         mtkRadioEx::controlImsConferenceCallMemberResponse},
        ...
        /// M: SIM SLOT LOCK @{
        {RIL_REQUEST_ENTER_DEVICE_NETWORK_DEPERSONALIZATION,
         mtkRadioEx::supplyDeviceNetworkDepersonalizationResponse},
        ...
        {RIL_REQUEST_SET_GWSD_IGNORE_CALL_INTERVAL,
         mtkRadioEx::setIgnoreSameNumberIntervalResponse},
        ...
        {RIL_REQUEST_GET_CURRENT_UICC_CARD_PROVISIONING_STATUS,
         mtkRadioEx::getCurrentUiccCardProvisioningStatusRsp},
        {RIL_REQUEST_IWLAN_REGISTER_CELLULAR_QUALITY_REPORT,
         mtkRadioEx::registerCellQltyReportResponse},
...
{RIL_REQUEST_RESUME_REGISTRATION, dispatchInts, responseVoid, RIL_CMD_PROXY_2,
 RIL_CHANNEL_3},  // [C2K][IR] Support SVLTE IR feature
        ...
        // MTK-END
        // MTK-START: SIM GBA
        {RIL_REQUEST_GENERAL_SIM_AUTH, dispatchSimAuth, responseSIM_IO, RIL_CMD_PROXY_1,
         RIL_CHANNEL_1},
        // MTK-END
        ...
        {RIL_REQUEST_SET_NETWORK_SELECTION_MANUAL_WITH_ACT, dispatchStrings, responseVoid,
         RIL_CMD_PROXY_3, RIL_CHANNEL_3},
        {RIL_REQUEST_QUERY_AVAILABLE_NETWORKS_WITH_ACT, dispatchVoid, responseStrings,
         RIL_CMD_PROXY_3, RIL_CHANNEL_3},
        {RIL_REQUEST_ABORT_QUERY_AVAILABLE_NETWORKS, dispatchVoid, responseVoid, RIL_CMD_PROXY_1,
         RIL_CHANNEL_1},  // for PLMN List abort

        // ATCI
        {RIL_REQUEST_OEM_HOOK_ATCI_INTERNAL, dispatchRaw, responseRaw, RIL_CMD_PROXY_6,
         RIL_CHANNEL_6},
        // M: To set language configuration for GSM cell broadcast
        {RIL_REQUEST_GSM_SET_BROADCAST_LANGUAGE, dispatchString, responseVoid, RIL_CMD_PROXY_1,
         RIL_CHANNEL_5},
        // M: To get language configuration for GSM cell broadcast
        {RIL_REQUEST_GSM_GET_BROADCAST_LANGUAGE, dispatchVoid, responseString, RIL_CMD_PROXY_1,
         RIL_CHANNEL_5},
        {RIL_REQUEST_GET_SMS_SIM_MEM_STATUS, dispatchVoid, responseGetSmsSimMemStatusCnf,
         RIL_CMD_PROXY_1, RIL_CHANNEL_5},
        {RIL_REQUEST_GET_SMS_PARAMS, dispatchVoid, responseSmsParams, RIL_CMD_PROXY_1,
         RIL_CHANNEL_1},
        {RIL_REQUEST_SET_SMS_PARAMS, dispatchSmsParams, responseVoid, RIL_CMD_PROXY_1,
         RIL_CHANNEL_1},
        ...
        {RIL_REQUEST_HANGUP_WITH_REASON, dispatchInts, responseVoid, RIL_CMD_PROXY_4,
         RIL_CHANNEL_2},
        // Verizon E911
        ...
        {RIL_REQUEST_SET_PS_REGISTRATION, dispatchInts, responseVoid, RIL_CMD_PROXY_5,
         RIL_CHANNEL_1},
        {RIL_REQUEST_SET_PSEUDO_CELL_MODE, dispatchInts, responseVoid, RIL_CMD_PROXY_3,
         RIL_CHANNEL_3},
        {RIL_REQUEST_GET_PSEUDO_CELL_INFO, dispatchVoid, responseInts, RIL_CMD_PROXY_3,
         RIL_CHANNEL_3},
        {RIL_REQUEST_SWITCH_MODE_FOR_ECC, dispatchInts, responseVoid, RIL_CMD_PROXY_1,
         RIL_CHANNEL_1},
        ...
        // STK
        {RIL_REQUEST_STK_HANDLE_CALL_SETUP_REQUESTED_FROM_SIM_WITH_RESULT_CODE, dispatchInts,
         responseVoid, RIL_CMD_PROXY_1, RIL_CHANNEL_3},
        // SS
        ...
        {RIL_REQUEST_SETUP_XCAP_USER_AGENT_STRING, dispatchStrings, responseVoid, RIL_CMD_PROXY_2,
         RIL_CHANNEL_1},
        {RIL_REQUEST_SET_SS_PROPERTY, dispatchStrings, responseVoid, RIL_CMD_PROXY_2,
         RIL_CHANNEL_1},
        ...
        {RIL_REQUEST_GET_PHB_STRING_LENGTH, dispatchVoid, responseInts, RIL_CMD_PROXY_1,
         RIL_CHANNEL_1},
        {RIL_REQUEST_GET_PHB_MEM_STORAGE, dispatchVoid, responseGetPhbMemStorage, RIL_CMD_PROXY_1,
         RIL_CHANNEL_1},
        {RIL_REQUEST_SET_PHB_MEM_STORAGE, dispatchStrings, responseVoid, RIL_CMD_PROXY_1,
         RIL_CHANNEL_1},
        {RIL_REQUEST_READ_PHB_ENTRY_EXT, dispatchInts, responseReadPhbEntryExt, RIL_CMD_PROXY_1,
         RIL_CHANNEL_1},
        {RIL_REQUEST_WRITE_PHB_ENTRY_EXT, dispatchWritePhbEntryExt, responseVoid, RIL_CMD_PROXY_1,
         RIL_CHANNEL_1},
        {RIL_REQUEST_QUERY_UPB_AVAILABLE, dispatchInts, responseInts, RIL_CMD_PROXY_1,
         RIL_CHANNEL_1},
        {RIL_REQUEST_READ_EMAIL_ENTRY, dispatchInts, responseString, RIL_CMD_PROXY_1,
         RIL_CHANNEL_1},
        {RIL_REQUEST_READ_SNE_ENTRY, dispatchInts, responseString, RIL_CMD_PROXY_1, RIL_CHANNEL_1},
        {RIL_REQUEST_READ_ANR_ENTRY, dispatchInts, responsePhbEntries, RIL_CMD_PROXY_1,
         RIL_CHANNEL_1},
        {RIL_REQUEST_READ_UPB_AAS_LIST, dispatchInts, responseStrings, RIL_CMD_PROXY_1,
         RIL_CHANNEL_1},
        {RIL_REQUEST_SET_PHONEBOOK_READY, dispatchInts, responseVoid, RIL_CMD_PROXY_1,
         RIL_CHANNEL_1},
        // PHB END
        // Femtocell (CSG) feature
        {RIL_REQUEST_GET_FEMTOCELL_LIST, dispatchVoid, responseStrings, RIL_CMD_PROXY_3,
         RIL_CHANNEL_1},
        // Femtocell (CSG) : abort command shall be sent in differenent channel
        {RIL_REQUEST_ABORT_FEMTOCELL_LIST, dispatchVoid, responseVoid, RIL_CMD_PROXY_1,
         RIL_CHANNEL_1},
        {RIL_REQUEST_SELECT_FEMTOCELL, dispatchStrings, responseVoid, RIL_CMD_PROXY_3,
         RIL_CHANNEL_1},
        {RIL_REQUEST_QUERY_FEMTOCELL_SYSTEM_SELECTION_MODE, dispatchVoid, responseInts,
         RIL_CMD_PROXY_3, RIL_CHANNEL_1},
        {RIL_REQUEST_SET_FEMTOCELL_SYSTEM_SELECTION_MODE, dispatchInts, responseVoid,
         RIL_CMD_PROXY_3, RIL_CHANNEL_1},
        // Data
        {RIL_REQUEST_SYNC_DATA_SETTINGS_TO_MD, dispatchInts, responseVoid, RIL_CMD_PROXY_5,
         RIL_CHANNEL_4},
        {RIL_REQUEST_RESET_MD_DATA_RETRY_COUNT, dispatchStrings, responseVoid, RIL_CMD_PROXY_5,
         RIL_CHANNEL_4},
        // M: Data Framework - CC 33
        ...
        {RIL_REQUEST_QUERY_SIM_NETWORK_LOCK, dispatchInts, responseInts, RIL_CMD_PROXY_1,
         RIL_CHANNEL_1},
        {RIL_REQUEST_SET_SIM_NETWORK_LOCK, dispatchStrings, responseVoid, RIL_CMD_PROXY_1,
         RIL_CHANNEL_1},
        {RIL_REQUEST_ENTER_DEPERSONALIZATION, dispatchStrings, responseInts, RIL_CMD_PROXY_1,
         RIL_CHANNEL_1},
        // MTK-END
        ...
        {RIL_REQUEST_ECC_REDIAL_APPROVE, dispatchInts, responseVoid, RIL_CMD_PROXY_2,
         RIL_CHANNEL_1},
        {RIL_REQUEST_SET_IMSCFG, dispatchInts, responseVoid, RIL_CMD_PROXY_1, RIL_CHANNEL_1},
        {RIL_REQUEST_SET_MD_IMSCFG, dispatchStrings, responseString, RIL_CMD_PROXY_1,
         RIL_CHANNEL_1},
        {RIL_REQUEST_GET_PROVISION_VALUE, dispatchString, responseStrings, RIL_CMD_PROXY_1,
         RIL_CHANNEL_1},
        {RIL_REQUEST_SET_PROVISION_VALUE, dispatchStrings, responseVoid, RIL_CMD_PROXY_1,
         RIL_CHANNEL_1},
        {RIL_REQUEST_IMS_CONFIG_SET_FEATURE, dispatchInts, responseVoid, RIL_CMD_PROXY_1,
         RIL_CHANNEL_1},
        {RIL_REQUEST_IMS_CONFIG_GET_FEATURE, dispatchInts, responseInts, RIL_CMD_PROXY_1,
         RIL_CHANNEL_1},
        {RIL_REQUEST_IMS_CONFIG_SET_PROVISION, dispatchStrings, responseVoid, RIL_CMD_PROXY_1,
         RIL_CHANNEL_1},
        {RIL_REQUEST_IMS_CONFIG_GET_PROVISION, dispatchInts, responseString, RIL_CMD_PROXY_1,
         RIL_CHANNEL_1},
        {RIL_REQUEST_IMS_CONFIG_GET_RESOURCE_CAP, dispatchInts, responseInts, RIL_CMD_PROXY_1,
         RIL_CHANNEL_1},
        {RIL_REQUEST_IMS_BEARER_STATE_CONFIRM, dispatchInts, responseVoid, RIL_CMD_PROXY_1,
         RIL_CHANNEL_1},
        {RIL_REQUEST_SET_IMS_BEARER_NOTIFICATION, dispatchInts, responseVoid, RIL_CMD_PROXY_1,
         RIL_CHANNEL_1},
        {RIL_REQUEST_IMS_DEREG_NOTIFICATION, dispatchInts, responseVoid, RIL_CMD_PROXY_1,
         RIL_CHANNEL_1},
        ...
        {RIL_REQUEST_DIAL_WITH_SIP_URI, dispatchString, responseVoid, RIL_CMD_PROXY_2,
         RIL_CHANNEL_1},
        {RIL_REQUEST_FORCE_RELEASE_CALL, dispatchInts, responseVoid, RIL_CMD_PROXY_1,
         RIL_CHANNEL_1},
        {RIL_REQUEST_SET_IMS_RTP_REPORT, dispatchInts, responseVoid, RIL_CMD_PROXY_1,
         RIL_CHANNEL_1},
        {RIL_REQUEST_CONFERENCE_DIAL, dispatchStrings, responseVoid, RIL_CMD_PROXY_2,
         RIL_CHANNEL_1},
        {RIL_REQUEST_ADD_IMS_CONFERENCE_CALL_MEMBER, dispatchStrings, responseVoid, RIL_CMD_PROXY_2,
         RIL_CHANNEL_1},
        {RIL_REQUEST_REMOVE_IMS_CONFERENCE_CALL_MEMBER, dispatchStrings, responseVoid,
         RIL_CMD_PROXY_2, RIL_CHANNEL_1},
        {RIL_REQUEST_VT_DIAL_WITH_SIP_URI, dispatchString, responseVoid, RIL_CMD_PROXY_2,
         RIL_CHANNEL_1},
        ...
        {RIL_REQUEST_SET_IMS_REGISTRATION_REPORT, dispatchVoid, responseVoid, RIL_CMD_PROXY_1,
         RIL_CHANNEL_1},
        ...
        {RIL_REQUEST_IMS_EMERGENCY_DIAL, dispatchEmergencyDial, responseVoid, RIL_CMD_PROXY_2,
         RIL_CHANNEL_2},
        // MTK_TC1_FEATURE for Antenna Testing start
        {RIL_REQUEST_VSS_ANTENNA_CONF, dispatchInts, responseInts, RIL_CMD_PROXY_3,
         RIL_CHANNEL_1},  // Antenna Testing
        {RIL_REQUEST_VSS_ANTENNA_INFO, dispatchInts, responseInts, RIL_CMD_PROXY_3,
         RIL_CHANNEL_1},  // Antenna Testing
        ...
        /// M: [Network][C2K] Sprint roaming control @{
        {RIL_REQUEST_SET_ROAMING_ENABLE, dispatchInts, responseVoid, RIL_CMD_PROXY_3,
         RIL_CHANNEL_3},
        {RIL_REQUEST_GET_ROAMING_ENABLE, dispatchInts, responseInts, RIL_CMD_PROXY_3,
         RIL_CHANNEL_3},
        /// @}
        // External SIM [START]
        {RIL_REQUEST_VSIM_NOTIFICATION, dispatchVsimEvent, responseInts, MTK_RIL_CHANNEL_VSIM,
         RIL_CHANNEL_1},
        {RIL_REQUEST_VSIM_OPERATION, dispatchVsimOperationEvent, responseInts, MTK_RIL_CHANNEL_VSIM,
         RIL_CHANNEL_1},
        // External SIM [END]
        {RIL_REQUEST_GET_GSM_SMS_BROADCAST_ACTIVATION, dispatchVoid, responseInts, RIL_CMD_PROXY_1,
         RIL_CHANNEL_5},
        {RIL_REQUEST_SET_VOICE_DOMAIN_PREFERENCE, dispatchInts, responseVoid, RIL_CMD_PROXY_2,
         RIL_CHANNEL_1},
        {RIL_REQUEST_GET_VOICE_DOMAIN_PREFERENCE, dispatchVoid, responseInts, RIL_CMD_PROXY_2,
         RIL_CHANNEL_1},
        {RIL_REQUEST_SET_E911_STATE, dispatchInts, responseVoid, RIL_CMD_PROXY_2, RIL_CHANNEL_1},
        /// M: MwiService @{
        {RIL_REQUEST_SET_WIFI_ENABLED, dispatchStrings, responseVoid, RIL_CMD_PROXY_1,
         RIL_CHANNEL_1},
        {RIL_REQUEST_SET_WIFI_ASSOCIATED, dispatchStrings, responseVoid, RIL_CMD_PROXY_1,
         RIL_CHANNEL_1},
        {RIL_REQUEST_SET_WFC_CONFIG, dispatchStrings, responseVoid, RIL_CMD_PROXY_1, RIL_CHANNEL_1},
        {RIL_REQUEST_SET_WIFI_SIGNAL_LEVEL, dispatchStrings, responseVoid, RIL_CMD_PROXY_1,
         RIL_CHANNEL_1},
        {RIL_REQUEST_SET_WIFI_IP_ADDRESS, dispatchStrings, responseVoid, RIL_CMD_PROXY_1,
         RIL_CHANNEL_1},
        {RIL_REQUEST_SET_GEO_LOCATION, dispatchStrings, responseVoid, RIL_CMD_PROXY_1,
         RIL_CHANNEL_1},
        {RIL_REQUEST_SET_EMERGENCY_ADDRESS_ID, dispatchStrings, responseVoid, RIL_CMD_PROXY_1,
         RIL_CHANNEL_1},
        {RIL_REQUEST_SET_NATT_KEEP_ALIVE_STATUS, dispatchStrings, responseVoid, RIL_CMD_PROXY_1,
         RIL_CHANNEL_1},
        {RIL_REQUEST_SET_WIFI_PING_RESULT, dispatchInts, responseVoid, RIL_CMD_PROXY_1,
         RIL_CHANNEL_1},
        {RIL_REQUEST_NOTIFY_EPDG_SCREEN_STATE, dispatchInts, responseVoid, RIL_CMD_PROXY_1,
         RIL_CHANNEL_1},
        ...
        /// M: Subsidylock @{
        {RIL_REQUEST_UPDATE_SUBLOCK_SETTINGS, dispatchRaw, responseRaw, RIL_CMD_PROXY_3,
         RIL_CHANNEL_1},
        {RIL_REQUEST_GET_SUBLOCK_MODEM_STATUS, dispatchRaw, responseRaw, RIL_CMD_PROXY_3,
         RIL_CHANNEL_1},
        ///@}
        {RIL_REQUEST_IMS_SEND_SMS_EX, dispatchImsSms, responseSMS, RIL_CHANNEL_GSM_SEND_SMS,
         RIL_CHANNEL_5},
        {RIL_REQUEST_SMS_ACKNOWLEDGE_EX, dispatchInts, responseVoid, RIL_CMD_PROXY_2,
         RIL_CHANNEL_5},
        /// M: SIM SLOT LOCK @{
        {RIL_REQUEST_ENTER_DEVICE_NETWORK_DEPERSONALIZATION, dispatchStrings, responseInts,
         RIL_CMD_PROXY_1, RIL_CHANNEL_1},
        ///@}
        {RIL_REQUEST_CDMA_SMS_ACKNOWLEDGE_EX, dispatchCdmaSmsAck, responseVoid, RIL_CMD_PROXY_1,
         RIL_CHANNEL_5},
        ...
        {RIL_REQUEST_SIP_HEADER_REPORT, dispatchStrings, responseVoid, RIL_CMD_PROXY_2,
         RIL_CHANNEL_1},
        {RIL_REQUEST_SET_IMS_CALL_MODE, dispatchInts, responseVoid, RIL_CMD_PROXY_2, RIL_CHANNEL_1},
        {RIL_REQUEST_ACTIVATE_UICC_CARD, dispatchVoid, responseInts, RIL_CMD_PROXY_1,
         RIL_CHANNEL_1},
        {RIL_REQUEST_DEACTIVATE_UICC_CARD, dispatchVoid, responseInts, RIL_CMD_PROXY_1,
         RIL_CHANNEL_1},
        {RIL_REQUEST_GET_CURRENT_UICC_CARD_PROVISIONING_STATUS, dispatchVoid, responseInts,
         RIL_CMD_PROXY_1, RIL_CHANNEL_1},
        {RIL_REQUEST_IWLAN_REGISTER_CELLULAR_QUALITY_REPORT, dispatchStrings, responseVoid,
         RIL_CMD_PROXY_1, RIL_CHANNEL_1},
        {RIL_REQUEST_SET_CALL_ADDITIONAL_INFO, dispatchStrings, responseVoid, RIL_CMD_PROXY_2,
         RIL_CHANNEL_1},
#endif  // MTK_USE_HIDL
