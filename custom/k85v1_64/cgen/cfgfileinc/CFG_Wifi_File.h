...
typedef struct _WIFI_NVRAM_5G_WF0_PATH_T {
    ...
    WIFI_NVRAM_5G_TX_POWER_OFFSET_T rTxTssiChannelOffset[8];
    /*Group 1 ~ Group 8*/ /*Efuse format ,Bit[7]:Vaild bit, Bit[6] sign bit*/
...
} WIFI_SOC1_0_NVRAM_PARAM_STRUCT_T, *P_WIFI_SOC1_0_NVRAM_PARAM_STRUCT_T, WIFI_CFG_PARAM_STRUCT,
