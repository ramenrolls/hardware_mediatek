...
AudioCustomization::AudioCustomization() { LOGD("AudioCustomization contructor"); }

AudioCustomization::~AudioCustomization() { LOGD("AudioCustomization destructor"); }

void AudioCustomization::EXT_DAC_Init() { LOGD("AudioCustomization EXT_DAC_Init"); }
