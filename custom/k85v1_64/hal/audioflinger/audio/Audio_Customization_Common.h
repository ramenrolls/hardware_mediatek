...
/****************************************************
 * Define this  , Audio Policy will apply ro.camera.sound.forced setting in
 *mediatek/config/project_name/system.prop (Add this optionn because JB2 load is invalid
 *****************************************************/
