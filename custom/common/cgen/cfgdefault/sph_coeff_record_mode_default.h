...
#define DEFAULT_HD_RECORD_MODE_INPUT_SRC_MAPPING \
    5, 2, 3, 5, 2, 3, 5, 2, 3, 5, 2, 3, 5, 2, 3, 5, 2, 3, 5, 2, 3, 5, 2, 3, 5, 2, 3, 5, 2, 3

#define DEFAULT_STEREO_FLAG 1, 0
#define DEFAULT_MONO_FLAG 0, 0

#define DEFAULT_HD_RECORD_MODE_STEREO_FLAGS                                                 \
    DEFAULT_MONO_FLAG, DEFAULT_STEREO_FLAG, DEFAULT_STEREO_FLAG, DEFAULT_STEREO_FLAG,       \
            DEFAULT_STEREO_FLAG, DEFAULT_MONO_FLAG, DEFAULT_STEREO_FLAG, DEFAULT_MONO_FLAG, \
            DEFAULT_MONO_FLAG, DEFAULT_MONO_FLAG, DEFAULT_MONO_FLAG, DEFAULT_MONO_FLAG,     \
            DEFAULT_MONO_FLAG, DEFAULT_MONO_FLAG, DEFAULT_MONO_FLAG
...
#define DEFAULT_HD_RECORD_SCENE_TABLE                                                   \
    {0, 1, 0xFF}, {2, 3, 29}, {4, 5, 0xFF}, {6, 7, 0xFF}, {8, 9, 0xFF}, {10, 11, 0xFF}, \
            {12, 13, 0xFF}, {14, 15, 0xFF}, {16, 17, 0xFF}, {                           \
        18, 19, 0xFF                                                                    \
    }

#define DEFAULT_HD_RECORD_SCENE_NAME                                                    \
    "VR", "Normal", "Meeting", "Lecture", "Normal", "Meeting", "VoiceUnLk", "Reserve1", \
            "Reserve2", "Reserve3"
